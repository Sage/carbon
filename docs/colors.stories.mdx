...
Some components such as <LinkTo kind='Design System/Typography'>Typography</LinkTo> have a `color`, `bg`/`backgroundColor` and `opacity` props, this functionality is provided by <a href="https://styled-system.com/api/#color">`styled-system/color`</a>.
