...
## Installation
The [TextEditor](https://carbon.sage.com/?path=/docs/design-system-text-editor--default-story) and 
[Note](https://carbon.sage.com/?path=/docs/design-system-note--default-story) components utilise the `Draft.js` framework to 
