  ...
  _createClass(Toast, [{
    ...
    get: function get() {
      return this.props.open ? _react2['default'].createElement(
        ...
        _react2['default'].createElement(_icon2['default'], { className: 'ui-toast__type', type: this.props.as }),
        _react2['default'].createElement(
          'div',
          { className: 'ui-toast__content' },
          this.props.children
        ),
        _react2['default'].createElement(_icon2['default'], { className: 'ui-toast__close', type: 'close', onClick: this.props.onDismiss })
      ) : null;
    }
  }], [{
    key: 'propTypes',
