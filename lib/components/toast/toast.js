...
var Toast = function (_React$Component) {
  ...
  _createClass(Toast, [{
     ...
     */
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-toast', this.props.className, 'carbon-toast--' + this.props.as)
      );
    }
    ...
    key: 'dismissIcon',
    get: function get() {
      return this.props.onDismiss ? /*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/_icon2.default, /*istanbul ignore next*/{ className: 'carbon-toast__close', type: 'close', onClick: this.props.onDismiss }) : null;
    }
    ...
    get: function get() {
      return this.props.open ? /*istanbul ignore next*/_react2.default.createElement(
        ...
        /*istanbul ignore next*/_react2.default.createElement(
          /*istanbul ignore next*/'div',
          /*istanbul ignore next*/{ className: 'carbon-toast__type' },
          /*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/_icon2.default, /*istanbul ignore next*/{ className: 'carbon-toast__type-icon', type: this.props.as })
        ),
        /*istanbul ignore next*/_react2.default.createElement(
          /*istanbul ignore next*/'div',
          /*istanbul ignore next*/{ className: 'carbon-toast__content' },
          this.props.children
        ),
        this.dismissIcon
      ) : null;
