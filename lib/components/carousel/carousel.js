...
var Carousel = function (_React$Component) {
  ...
  _createClass(Carousel, [{
    ...
    value: function render() {
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-carousel__content' },
            /*istanbul ignore next*/_react2.default.createElement(
              /*istanbul ignore next*/'div',
              ...
              /*istanbul ignore next*/_react2.default.createElement(
                ...
                /*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/_icon2.default, /*istanbul ignore next*/{ className: 'carbon-carousel__previous-arrow', type: 'dropdown' })
              )
            ),
            /*istanbul ignore next*/_react2.default.createElement(
            ...
            /*istanbul ignore next*/_react2.default.createElement(
              ...
              /*istanbul ignore next*/_react2.default.createElement(
                ...
                /*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/_icon2.default, /*istanbul ignore next*/{ className: 'carbon-carousel__next-arrow', type: 'dropdown' })
              )
            )
          ),
          /*istanbul ignore next*/_react2.default.createElement(
     ...
     */
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-carousel', this.props.className)
      );
    }
    ...
    key: 'nextClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-carousel__navigation', 'carbon-carousel__next')
      );
    }
    ...
    key: 'previousClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-carousel__navigation', 'carbon-carousel__previous')
      );
    }
    ...
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-carousel__buttons', 'carbon-carousel__previous-button')
      );
    }
    ...
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-carousel__buttons', 'carbon-carousel__next-button')
      );
    }
    ...
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-carousel__selector')
      );
    }
    ...
    get: function get() {
      ...
      var additionalProps = {
        className: /*istanbul ignore next*/(0, _classnames2.default)('carbon-slide carbon-slide--active', visibleSlide.props.className),
        key: /*istanbul ignore next*/'carbon-slide-' + index
      };
    ...
    get: function get() {
      ...
      for (var i = 0; i < this.numOfSlides; i++) {
        buttons.push( /*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/{ className: 'carbon-carousel__selector-inputs', key: i },
