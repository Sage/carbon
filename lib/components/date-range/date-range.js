...
var DateRange = _wrapComponent('DateRange')((_temp2 = _class = function (_React$Component) {
  ...
  _createClass(DateRange, [{
    ...
    value: function render() {
      return _react3.default.createElement(
        'div',
        null,
        _react3.default.createElement(_date2.default, this.startDateProps()),
        _react3.default.createElement(_date2.default, this.endDateProps())
      );
    }
  }, {
    key: 'startDate',
   ...
   * @type {Array}
   */
  value: _react2.PropTypes.array.isRequired,
   ...
   * @type {String}
   */
  startLabel: _react2.PropTypes.string,
   ...
   * @type {String}
   */
  endLabel: _react2.PropTypes.string,
   ...
   * @type {String}
   */
  startMessage: _react2.PropTypes.string,
   ...
   * @type {String}
   */
  endMessage: _react2.PropTypes.string,
   ...
   * @type {Boolean}
   */
  labelsInline: _react2.PropTypes.bool,
   ...
   * @type {Object}
   */
  startDateProps: _react2.PropTypes.object,
   ...
   * @type {Object}
   */
  endDateProps: _react2.PropTypes.object
}, _temp2));
