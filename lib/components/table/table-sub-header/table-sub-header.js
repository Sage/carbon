...
var TableSubHeader = function (_TableHeader) {
  ...
  _createClass(TableSubHeader, [{
    ...
    value: function tableHeaderClasses() {
      return (0, _classnames2.default)('carbon-table-sub-header', _get(TableSubHeader.prototype.__proto__ || Object.getPrototypeOf(TableSubHeader.prototype), 'tableHeaderClasses', this).call(this));
    }
  }]);
