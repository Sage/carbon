...
var Table = function (_React$Component) {
  ...
  _createClass(Table, [{
    ...
    key: 'actionToolbar',
    get: function get() {
      if (!this.props.selectable || !(this.props.actions || this.props.actionExtras)) {
        return null;
      }

      return _react2.default.createElement(_actionToolbar2.default, {
...
Table.propTypes = {
   ...
   * @type {Node}
   */
  actionExtras: _propTypes2.default.node,
