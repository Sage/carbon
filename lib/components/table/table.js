...
var Table = function (_React$Component) {
  ...
  _createClass(Table, [{
    ...
    key: 'mainClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-table', this.props.className)
      );
    }
    ...
    key: 'wrapperClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-table__wrapper', this.props.className, /*istanbul ignore next*/_defineProperty({}, 'carbon-table--pager', this.props.paginate))
      );
    }
    ...
    get: function get() {
      if (this.props.thead) {
        return (/*istanbul ignore next*/_react2.default.createElement(
            ...
            /*istanbul ignore next*/{ className: 'carbon-table__header' },
            this.props.thead
          )
        );
      }
