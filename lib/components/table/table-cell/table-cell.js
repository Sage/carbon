...
var TableCell = function (_React$Component) {
  ...
  _createClass(TableCell, [{
     ...
     */
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)("carbon-table-cell", this.props.className, /*istanbul ignore next*/_defineProperty({}, 'carbon-table-cell--align-' + this.props.align, this.props.align), /*istanbul ignore next*/_defineProperty({}, 'carbon-table-cell--action', this.props.action))
      );
    }
