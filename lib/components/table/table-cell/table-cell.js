...
var TableCell = (function (_React$Component) {
  ...
  _createClass(TableCell, [{
    ...
    value: function render() {
      var className = (0, _classnames2['default'])("ui-table-cell", this.props.className, _defineProperty({}, 'ui-table-cell--align-' + this.props.align, this.props.align), _defineProperty({}, 'ui-table-cell--action', this.props.action));
