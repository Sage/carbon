...
var TableHeader = function (_React$Component) {
  ...
  _createClass(TableHeader, [{
    ...
    get: function get() {
      ...
      return (0, _classnames2.default)("carbon-table-header", this.props.className, (_classNames2 = {}, _defineProperty(_classNames2, 'carbon-table-header--align-' + this.props.align, this.props.align), _defineProperty(_classNames2, 'carbon-table-header--sortable', this.props.sortable), _classNames2));
    }
