...
var TableHeader = _wrapComponent('TableHeader')((_temp2 = _class = function (_React$Component) {
   ...
   * @type {Boolean}
   */
  sortable: _react3.default.PropTypes.bool
}, _class.contextTypes = {
  onSort: _react3.default.PropTypes.func,
  sortedColumn: _react3.default.PropTypes.string,
  sortOrder: _react3.default.PropTypes.string
}, _temp2));
