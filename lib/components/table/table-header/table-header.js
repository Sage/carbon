...
var TableHeader = (function (_React$Component) {
  ...
  function TableHeader() {
    ...
    this.emitSortEvent = function () {
      ...
      _this.clicked ? null : _this.clicked = true;
    };
  }
  ...
  _createClass(TableHeader, [{
    ...
    value: function render() {
      var className = (0, _classnames2['default'])("ui-table-header", this.props.className, _defineProperty({}, 'ui-table-header--align-' + this.props.align, this.props.align), this.props.sortable ? 'ui-table-header--sortable' : '');
    ...
    get: function get() {
      if (this.clicked && this.props.sortable) {
        if (this.props.sortOrder === 'desc') {
          return _react2['default'].createElement(_icon2['default'], { type: 'sort-up', className: 'ui-table-header__icon' });
        } else {
          return _react2['default'].createElement(_icon2['default'], { type: 'sort-down', className: 'ui-table-header__icon' });
        }
      }
    }
  }], [{
