  ...
  _createClass(TableHeader, [{
    ...
    get: function get() {
      if (this.sorted) {
        ...
        return (/*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/_icon2.default, /*istanbul ignore next*/{ type: type, className: 'carbon-table-header__icon' })
        );
      }
    }
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/(0, _classnames2.default)("carbon-table-header", this.props.className, /*istanbul ignore next*/(_classNames = {}, _defineProperty(_classNames, 'carbon-table-header--align-' + this.props.align, this.props.align), _defineProperty(_classNames, 'carbon-table-header--sortable', this.props.sortable), _classNames))
      );
    }
