...
var DropdownFilterAjax = function (_DropdownFilter) {
  ...
  function DropdownFilterAjax() {
    ...
    _this.getData = function () {
      ...
      _this.pendingRequest = _superagent2.default.get(_this.props.path).query(_this.getParams(query, page)).query(_this.props.additionalRequestParams).set(_this.getHeaders());
    ...
    _this.getHeaders = function () {
      return _this.props.getCustomHeaders ? _this.props.getCustomHeaders() : { Accept: _this.props.acceptHeader };
    };
