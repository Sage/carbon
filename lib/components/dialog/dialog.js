...
var Dialog = function (_Modal) {
  ...
  _createClass(Dialog, [{
    ...
    key: 'mainClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-dialog', this.props.className)
      );
    }
    ...
    key: 'dialogClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-dialog__dialog', /*istanbul ignore next*/_defineProperty({}, 'carbon-dialog__dialog--' + this.props.size, typeof this.props.size !== 'undefined'))
      );
    }
  }, {
    key: 'closeIcon',
    get: function get() {
      if (this.props.showCloseIcon) {
        return (/*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/_icon2.default, /*istanbul ignore next*/{ className: 'carbon-dialog__close', type: 'close', onClick: this.props.onCancel })
        );
      }
    }
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-dialog__content' },
            this.props.children
          )
        )
      );
