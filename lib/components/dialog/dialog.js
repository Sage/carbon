...
var Dialog = (function (_React$Component) {
  ...
  function Dialog() {
    ...
    this.componentDidUpdate = function () {
      if (_this.props.open && !_this.listening) {
        _this.centerDialog();
        _this.listening = true;
        window.addEventListener('resize', _this.centerDialog);
        window.addEventListener('keyup', _this.closeDialog);
      } else if (!_this.props.open) {
        _this.listening = false;
        window.removeEventListener('resize', _this.centerDialog);
        window.removeEventListener('keyup', _this.closeDialog);
      }
    };
  ...
  _createClass(Dialog, [{
    ...
    get: function get() {
      ...
      return _react2['default'].createElement(
        ...
        this.dialogTitle,
        _react2['default'].createElement(_icon2['default'], { className: 'ui-dialog__close', type: 'close', onClick: this.props.cancelHandler }),
        _react2['default'].createElement(
          'div',
    ...
    value: {
       ...
       * @type {Function}
       */
      cancelHandler: _react2['default'].PropTypes.func.isRequired,
