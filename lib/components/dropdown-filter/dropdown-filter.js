...
var DropdownFilter = (function (_Dropdown) {
    ...
    this.handleBlur = function () {
      if (!_this.blockBlur) {
        (function () {
          ...
          if (highlighted && highlighted !== String(_this.props.value)) {
  ...
  _createClass(DropdownFilter, [{
    ...
    key: 'mainClasses',
    get: function get() {
      return (0, _classnames2['default'])(_get(Object.getPrototypeOf(DropdownFilter.prototype), 'mainClasses', this), 'ui-dropdown-filter');
    }
    ...
    key: 'inputClasses',
    get: function get() {
      return (0, _classnames2['default'])(_get(Object.getPrototypeOf(DropdownFilter.prototype), 'inputClasses', this), {
