...
var DropdownFilter = function (_Dropdown) {
  ...
  _createClass(DropdownFilter, [{
    ...
    value: function results(options) {
      ...
      if (!items.length) {
        items = /*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/{ className: 'carbon-dropdown__list-item carbon-dropdown__list-item--no-results' },
    ...
    get: function get() {
      ...
      if (this.state.open && this.props.create) {
        ...
        html.push( /*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/{ key: 'dropdown-action', className: 'carbon-dropdown__action', onClick: this.handleCreate },
          text
        ));
      }
    ...
    key: 'mainClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)( /*istanbul ignore next*/_get(Object.getPrototypeOf(DropdownFilter.prototype), 'mainClasses', this), 'carbon-dropdown-filter')
      );
    }
