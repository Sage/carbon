...
var Portrait = (function (_React$Component) {
  ...
  function Portrait() {
    ...
    this.applyBackground = function (context, size) {
    ...
    this.applyText = function (context, size) {
  ...
  _createClass(Portrait, [{
    ...
    get: function get() {
      ...
      return _ref = {}, _defineProperty(_ref, "extra-small", '25'), _defineProperty(_ref, 'small', '30'), _defineProperty(_ref, "medium-small", '50'), _defineProperty(_ref, 'medium', '60'), _defineProperty(_ref, "medium-large", '70'), _defineProperty(_ref, 'large', '100'), _defineProperty(_ref, "extra-large", '120'), _ref;
    }
