...
var Portrait = _wrapComponent('Portrait')((_temp2 = _class = function (_React$Component) {
   ...
   * @type {String}
   */
  gravatar: _react3.default.PropTypes.string,
   ...
   * @type {String}
   */
  alt: _react3.default.PropTypes.string,
   ...
   * @type {String}
   */
  shape: _react3.default.PropTypes.string,
   ...
   * @default false
   */
  darkBackground: _react3.default.PropTypes.bool
}, _class.defaultProps = {
  size: 'medium',
  shape: 'standard'
}, _temp2));
