...
var Portrait = function (_React$Component) {
  ...
  _createClass(Portrait, [{
    ...
    key: 'mainClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-portrait', 'carbon-portrait--image', /*istanbul ignore next*/'carbon-portrait--' + this.props.size, /*istanbul ignore next*/'carbon-portrait--' + this.props.shape, this.props.className)
      );
    }
