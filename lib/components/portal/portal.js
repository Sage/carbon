  ...
  _createClass(Portal, [{
    ...
    value: function componentDidMount() {
      if (this.props.onReposition) {
        ...
        /* eslint-disable */
        this.scrollParent = this.searchForScrollableParent(_reactDom2.default.findDOMNode(this));
        /* eslint-enable */
    ...
    key: 'searchForScrollableParent',
    value: function searchForScrollableParent(element) {
      if (!element) {
        return null;
      }
