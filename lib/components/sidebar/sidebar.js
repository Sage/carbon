...
var Sidebar = function (_Modal) {
  ...
  _createClass(Sidebar, [{
     ...
     */
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-sidebar', this.props.className)
      );
    }
    ...
    key: 'sidebarClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-sidebar__sidebar', /*istanbul ignore next*/'carbon-sidebar__sidebar--' + this.props.position)
      );
    }
    ...
    get: function get() {
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/_react2.default.createElement(
            ...
            /*istanbul ignore next*/{ className: 'carbon-sidebar__close' },
            /*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/_icon2.default, /*istanbul ignore next*/{ className: 'carbon-sidebar__close-icon', type: 'close', onClick: this.props.onCancel })
          ),
          this.props.children
        )
      );
