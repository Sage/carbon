...
var Fieldset = function (_React$Component) {
  ...
  _createClass(Fieldset, [{
    ...
    value: function render() {
      ...
      var /*istanbul ignore next*/props = _objectWithoutProperties(_props, ['className']);
      var /*istanbul ignore next*/classes = /*istanbul ignore next*/(0, _classnames2.default)("carbon-fieldset", className);

      return (/*istanbul ignore next*/_react2.default.createElement(
          /*istanbul ignore next*/'fieldset',
          /*istanbul ignore next*/_extends({ className: classes }, props),
          this.legend,
          this.props.children
        )
      );
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/_react2.default.createElement(
          /*istanbul ignore next*/'legend',
          /*istanbul ignore next*/{ className: 'carbon-fieldset__legend common-input__label' },
          this.props.legend
        )
      );
    }
...
/*istanbul ignore next*/Fieldset.PropTypes = {
  /**
   ...
   * @type {String}
   */
  legend: /*istanbul ignore next*/_react2.default.PropTypes.string
};
/*istanbul ignore next*/exports.default = Fieldset;