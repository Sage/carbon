...
var ButtonToggle = /*istanbul ignore next*/(0, _input2.default)( /*istanbul ignore next*/(0, _inputLabel2.default)( /*istanbul ignore next*/(_temp = _class = function (_React$Component) {
  ...
  _createClass(ButtonToggle, [{
    ...
    key: 'inputClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-button-toggle__input', /*istanbul ignore next*/_css2.default.hidden)
      );
    }
    ...
    get: function get() {
      ...
      var classes = /*istanbul ignore next*/(0, _classnames2.default)("carbon-button-toggle__icon", /*istanbul ignore next*/_defineProperty({}, "carbon-button-toggle__icon--large", this.props.iconSize === "large"));
    ...
    get: function get() {
      var classes = /*istanbul ignore next*/(0, _classnames2.default)("carbon-button-toggle__label", /*istanbul ignore next*/_defineProperty({}, "carbon-button-toggle__label--disabled", this.props.disabled));
