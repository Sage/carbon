...
var definition = new _definition2.default('button-toggle', _2.default, {
  ...
  propOptions: {
    ...
    size: _optionsHelper2.default.sizesBinary
  },
  propValues: {
    name: "option",
    children: "Option",
  ...
  propDescriptions: {
    ...
    size: "Define what size the button should be. This will default to large if not set. Possible values include: " + _optionsHelper2.default.sizesBinary.join(", "),
