...
var Dropdown = (0, _utilsDecoratorsInput2['default'])((0, _utilsDecoratorsInputIcon2['default'])((0, _utilsDecoratorsInputLabel2['default'])((0, _utilsDecoratorsInputValidation2['default'])((function (_React$Component) {
  ...
  function Dropdown() {
    ...
    this.handleKeyDown = function (ev) {
      if (!_this.refs.list) {
        ...
        if (_utilsHelpersEvents2['default'].isUpKey(ev) || _utilsHelpersEvents2['default'].isDownKey(ev) || _utilsHelpersEvents2['default'].isSpaceKey(ev)) {
          _this.setState({ open: true });
        }
  ...
  _createClass(Dropdown, [{
    ...
    key: 'mainClasses',
    get: function get() {
      return (0, _classnames2['default'])('ui-dropdown', { 'ui-dropdown--open': this.state.open });
    }
