...
var Dropdown = (0, _input2.default)((0, _inputIcon2.default)((0, _inputLabel2.default)((0, _inputValidation2.default)(_wrapComponent('Dropdown')((_temp = _class = function (_React$Component) {
  ...
  _createClass(Dropdown, [{
    ...
    get: function get() {
      ...
      var props = (_props = {}, _defineProperty(_props, 'data-element', 'hidden-input'), _defineProperty(_props, 'ref', 'hidden'), _defineProperty(_props, 'type', "hidden"), _defineProperty(_props, 'readOnly', true), _defineProperty(_props, 'name', this.props.name), _defineProperty(_props, 'value', this.props.value || ''), _props);
