...
var Pod = function (_React$Component) {
  ...
  _createClass(Pod, [{
    ...
    get: function get() {
      ...
      return _react2.default.createElement(
        'div',
        _extends({ className: 'carbon-pod__edit-button-container' }, this.editProps),
        _react2.default.createElement(_link2.default, { icon: 'edit', className: this.editActionClasses })
      );
    }
...
Pod.propTypes = {
   ...
   * @type {Boolean}
   */
  displayEditButtonOnHover: _react2.default.PropTypes.bool,
   ...
   * @type {Boolean}
   */
  legacyEditStyles: _react2.default.PropTypes.bool
};
Pod.defaultProps = {
  border: true,
  as: "primary",
