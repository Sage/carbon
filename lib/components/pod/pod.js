...
var Pod = function (_React$Component) {
  ...
  _createClass(Pod, [{
     ...
     */
    get: function get() {
      return (0, _classnames2.default)('carbon-pod', this.props.className, 'carbon-pod--' + this.props.as, {
    ...
    key: 'headerClasses',
    get: function get() {
      return (0, _classnames2.default)('carbon-pod__header', 'carbon-pod__header--' + this.props.alignTitle, _css2.default.unselectable, _defineProperty({}, 'carbon-pod__header--' + this.state.collapsed, this.state.collapsed !== undefined));
    }
    ...
    key: 'contentClasses',
    get: function get() {
      return (0, _classnames2.default)('carbon-pod__content', 'carbon-pod__content--' + this.props.as, 'carbon-pod--padding-' + this.props.padding, {
    ...
    get: function get() {
      ...
      return _react2.default.createElement(
        _link2.default,
        _extends({ icon: 'edit', className: 'carbon-pod__edit-action' }, props),
