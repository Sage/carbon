...
var Pod = _wrapComponent('Pod')((_temp2 = _class = function (_React$Component) {
  ...
  _createClass(Pod, [{
    ...
    key: 'podDescription',
    get: function get() {
      return this.props.description ? _react3.default.createElement(
        'div',
   ...
   * @default medium
   */
  padding: _react3.default.PropTypes.string,
   ...
   * @type {Boolean}
   */
  collapsed: _react3.default.PropTypes.bool,
   ...
   * @default left
   */
  alignTitle: _react3.default.PropTypes.string,
   ...
   * @type {String}
   */
  description: _react3.default.PropTypes.string,
   ...
   * @type {String}
   */
  footer: _react3.default.PropTypes.object,
   ...
   */
  onEdit: _react3.default.PropTypes.oneOfType([_react3.default.PropTypes.string, _react3.default.PropTypes.func, _react3.default.PropTypes.object]),
   ...
   * @type {Boolean}
   */
  editContentFullWidth: _react3.default.PropTypes.bool,
   ...
   * @type {Boolean}
   */
  displayEditButtonOnHover: _react3.default.PropTypes.bool,
   ...
   * @type {Boolean}
   */
  triggerEditOnContent: _react3.default.PropTypes.bool,
   ...
   * @type {Boolean}
   */
  internalEditButton: _react3.default.PropTypes.bool
}, _class.defaultProps = {
  border: true,
  as: "primary",
  padding: "medium",
