...
var Pod = function (_React$Component) {
  ...
  _createClass(Pod, [{
    ...
    key: 'mainClasses',
    get: function get() {
      return (0, _classnames2.default)("carbon-pod", _css2.default.clearfix, {
    ...
    key: 'blockClasses',
    get: function get() {
      return (0, _classnames2.default)('carbon-pod__block', this.props.className, 'carbon-pod__block--' + this.props.as, {
