...
var Pod = function (_React$Component) {
  ...
  _createClass(Pod, [{
    ...
    value: function render() {
      var /*istanbul ignore next*/content = void 0; /*istanbul ignore next*/
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/_react2.default.createElement(
            ...
            /*istanbul ignore next*/{ className: 'carbon-pod__title' },
            this.props.title
          ),
          pod
        )
    ...
    get: function get() {
      return this.props.description ? /*istanbul ignore next*/_react2.default.createElement(
        /*istanbul ignore next*/'div',
        /*istanbul ignore next*/{ className: 'carbon-pod__description' },
    ...
    get: function get() {
      return (/*istanbul ignore next*/_react2.default.createElement(
          /*istanbul ignore next*/'div',
          /*istanbul ignore next*/{ className: 'carbon-pod__collapsible-content' },
          this.podDescription,
          /*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-pod__content' },
            this.props.children
          )
        )
      );
     ...
     */
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-pod', this.props.className, /*istanbul ignore next*/'carbon-pod--' + this.props.as, {
    ...
    key: 'headerClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)( /*istanbul ignore next*/'carbon-pod__header', /*istanbul ignore next*/'carbon-pod__header--' + this.props.alignTitle, /*istanbul ignore next*/_css2.default.unselectable, /*istanbul ignore next*/_defineProperty({}, 'carbon-pod__header--' + this.state.collapsed, this.state.collapsed !== undefined))
      );
    }
    ...
    key: 'contentClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-pod__content', /*istanbul ignore next*/'carbon-pod__content--' + this.props.as, /*istanbul ignore next*/'carbon-pod--padding-' + this.props.padding, {
    ...
    key: 'footerClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-pod__footer', /*istanbul ignore next*/'carbon-pod__footer--' + this.props.as, /*istanbul ignore next*/'carbon-pod__footer--padding-' + this.props.padding, {
          'carbon-pod--no-border': !this.props.border
        })
      );
    }
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/_extends({ icon: 'edit', className: 'carbon-pod__edit-action' }, props),
...
/*istanbul ignore next*/Pod.propTypes = {
   ...
   * @default left
   */
  alignTitle: /*istanbul ignore next*/_react2.default.PropTypes.string,
