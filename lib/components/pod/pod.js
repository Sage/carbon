  ...
  _createClass(Pod, [{
    ...
    get: function get() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_link2.default, _extends({ icon: 'edit', className: this.editActionClasses }, this.linkProps()))
      );
    }
...
Pod.propTypes = {
   ...
   * @type {Boolean}
   */
  internalEditButton: _react2.default.PropTypes.bool
};
Pod.defaultProps = {
  border: true,
  as: "primary",
