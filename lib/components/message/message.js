...
var Message = function (_React$Component) {
  ...
  _createClass(Message, [{
     ...
     */
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-message', this.props.className, 'carbon-message--' + this.props.as, { 'carbon-message--transparent': this.props.transparent,
    ...
    key: 'dismissIcon',
    get: function get() {
      return this.props.onDismiss ? /*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/_icon2.default, /*istanbul ignore next*/{ className: 'carbon-message__close', type: 'close', onClick: this.props.onDismiss }) : null;
    }
    ...
    */
    ...
    get: function get() {
      return this.props.title ? /*istanbul ignore next*/_react2.default.createElement(
        ...
        /*istanbul ignore next*/{ className: 'carbon-message__title' },
        this.props.title
      ) : null;
    }
    ...
    get: function get() {
      return this.props.open ? /*istanbul ignore next*/_react2.default.createElement(
        ...
        /*istanbul ignore next*/_react2.default.createElement(
          /*istanbul ignore next*/'div',
          /*istanbul ignore next*/{ className: 'carbon-message__type' },
          /*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/_icon2.default, /*istanbul ignore next*/{ className: 'carbon-message__type-icon', type: this.props.as })
        ),
        /*istanbul ignore next*/_react2.default.createElement(
          /*istanbul ignore next*/'div',
          /*istanbul ignore next*/{ className: 'carbon-message__content' },
          this.titleHTML,
          /*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-message__body' },
            this.props.children
          )
        ),
        this.dismissIcon
