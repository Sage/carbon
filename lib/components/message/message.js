...
var Message = (function (_React$Component) {
  ...
  _createClass(Message, [{
     ...
     */
    get: function get() {
      return (0, _classnames2['default'])('ui-message', this.props.className, 'ui-message--' + this.props.as, { 'ui-message--transparent': this.props.transparent
      });
    }
    ...
    key: 'dismissIcon',
    get: function get() {
      return this.props.onDismiss ? _react2['default'].createElement(_icon2['default'], { className: 'ui-message__close', type: 'close', onClick: this.props.onDismiss }) : null;
    }
    ...
    get: function get() {
      return this.props.open ? _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'div',
          { className: 'ui-message__type' },
          _react2['default'].createElement(_icon2['default'], { className: 'ui-message__type-icon', type: this.props.as })
        ),
        _react2['default'].createElement(
          'div',
