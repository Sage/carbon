...
var Message = _wrapComponent('Message')((_temp = _class = function (_React$Component) {
  ...
  _createClass(Message, [{
    ...
    key: 'dismissIcon',
    get: function get() {
      return this.props.onDismiss ? _react3.default.createElement(_icon2.default, { className: 'carbon-message__close', type: 'close', onClick: this.props.onDismiss }) : null;
    }
   ...
   * @default false
   */
  transparent: _react3.default.PropTypes.bool,
   ...
   * @default true
   */
  open: _react3.default.PropTypes.bool,
   ...
   * @type {Function}
   */
  onDismiss: _react3.default.PropTypes.func,
   ...
   * @default true
   */
  roundedCorners: _react3.default.PropTypes.bool,
