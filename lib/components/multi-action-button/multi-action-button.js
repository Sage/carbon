...
var MultiActionButton = function (_SplitButton) {
  ...
  _createClass(MultiActionButton, [{
     ...
     */
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)( /*istanbul ignore next*/_get(Object.getPrototypeOf(MultiActionButton.prototype), 'mainClasses', this), 'carbon-multi-action-button', {
    ...
    get: function get() {
      return (/*istanbul ignore next*/_get(Object.getPrototypeOf(MultiActionButton.prototype), 'additionalButtonsClasses', this) + ' carbon-multi-action-button__additional-buttons' + ' carbon-multi-action-button__additional-buttons--' + this.props.as
      );
    }
    ...
    get: function get() {
      return (/*istanbul ignore next*/_get(Object.getPrototypeOf(MultiActionButton.prototype), 'toggleButtonClasses', this) + ' carbon-multi-action-button__toggle' + ' carbon-multi-action-button__toggle--' + this.props.as
      );
    }
