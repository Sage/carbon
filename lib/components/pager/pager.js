  ...
  function Pager() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Pager)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
      ...
      var newPage = /*istanbul ignore next*/void 0,
          newPageSize = /*istanbul ignore next*/void 0;
      switch (element) {
        case 'next':
        ...
        case 'input':
          ...
          if (Number(newPage) > /*istanbul ignore next*/_this.maxPage) {
            newPage = String( /*istanbul ignore next*/_this.maxPage);
          }
  ...
  _createClass(Pager, [{
    ...
    value: function render() {
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/{ className: 'carbon-pager' },
          /*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-pager__size' },
            this.sizeSelectionDropdown
          ),
          /*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-pager__navigation' },
            this.previousArrow,
            /*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-pager__summary' },
