...
var Pager = _wrapComponent('Pager')((_temp2 = _class = function (_React$Component) {
   ...
   * @type {String}
   */
  currentPage: _react3.default.PropTypes.string.isRequired,
   ...
   * @type {String}
   */
  totalRecords: _react3.default.PropTypes.string.isRequired,
   ...
   * @type {Function}
   */
  onPagination: _react3.default.PropTypes.func.isRequired,
