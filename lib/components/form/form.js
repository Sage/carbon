...
var Form = _wrapComponent('Form')((_temp2 = _class = function (_React$Component) {
  ...
  _createClass(Form, [{
    ...
    get: function get() {
      var errorCount = void 0,
          saveClasses = (0, _classnames2.default)("carbon-form__save", {
      ...
      if (this.state.errorCount || this.state.warningCount) {
        ...
        errorCount = _react3.default.createElement('span', {
   ...
   * @default null
   */
  activeInput: _react3.default.PropTypes.element,
   ...
   * @default true
   */
  cancel: _react3.default.PropTypes.bool,
   ...
   * @type {Function}
   */
  afterFormValidation: _react3.default.PropTypes.func,
   ...
   * @type {Function}
   */
  beforeFormValidation: _react3.default.PropTypes.func,
   ...
   * @default false
   */
  saving: _react3.default.PropTypes.bool,
   ...
   * @default false
   */
  validateOnMount: _react3.default.PropTypes.bool,
   ...
   * @type {Object}
   */
  cancelButtonProps: _react3.default.PropTypes.object,
   ...
   * @default "Save"
   */
  saveText: _react3.default.PropTypes.string,
   ...
   * @type {Object}
   */
  saveButtonProps: _react3.default.PropTypes.object,
   ...
   * @type {Boolean}
   */
  save: _react3.default.PropTypes.bool,
   ...
   * @type {String|JSX}
   */
  additionalActions: _react3.default.PropTypes.node,
   ...
   * @type {Object}
   */
  form: _react3.default.PropTypes.object
}, _class.contextTypes = {
