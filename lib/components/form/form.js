...
var Form = function (_React$Component) {
  ...
  function Form() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Form)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this._document = document, _this._window = window, _this.getChildContext = function () {
      ...
      if (valid && /*istanbul ignore next*/_this.props.onSubmit) {
        /*istanbul ignore next*/_this.props.onSubmit(ev);
      }
      ...
      /*istanbul ignore next*/var _this$props = /*istanbul ignore next*/_this.props;
      /*istanbul ignore next*/var onSubmit = _this$props.onSubmit;
      /*istanbul ignore next*/
      var props = _objectWithoutProperties(_this$props, ['onSubmit']);
  ...
  _createClass(Form, [{
     ...
     */
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-form', this.props.className)
      );
    }
  }, {
    key: 'buttonClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-form__buttons', /*istanbul ignore next*/'carbon-form__buttons--' + this.props.buttonAlign)
      );
    }
    ...
    get: function get() {
      return (/*istanbul ignore next*/_react2.default.createElement(
          /*istanbul ignore next*/'div',
          /*istanbul ignore next*/{ className: 'carbon-form__additional-actions' },
    ...
    get: function get() {
      ...
      var saveClasses = /*istanbul ignore next*/(0, _classnames2.default)("carbon-form__save", {
