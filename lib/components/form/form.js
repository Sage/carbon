...
var Form = (function (_React$Component) {
  ...
  function Form() {
    ...
    this.incrementWarningCount = function () {
      _this.setState({ warningCount: _this.state.warningCount + 1 });
    };

    this.decrementWarningCount = function () {
      _this.setState({ warningCount: _this.state.warningCount - 1 });
    };
    ...
    */
    value: function render() {
      ...
      if (this.state.errorCount || this.state.warningCount) {
        ...
        errorCount = _react2['default'].createElement('span', { className: 'ui-form__summary', dangerouslySetInnerHTML: renderMessage(this.state.errorCount, this.state.warningCount) });
