...
var Form = (function (_React$Component) {
  ...
  function Form() {
    ...
    this.cancelForm = function () {
      if (_this.context.dialog) {
        _this.context.dialog.onCancel();
      } else {
...
function saveText() {
  return _i18nJs2['default'].t('actions.save', { defaultValue: 'Save' });
}

function cancelText() {
  return _i18nJs2['default'].t('actions.cancel', { defaultValue: 'Cancel' });
}
