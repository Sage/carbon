 ...
 * In your file:
 *
 *   import Notification from 'carbon/lib/components/notification';
 *
...
var Notification = (function (_React$Component) {
  ...
  _createClass(Notification, [{
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'div',
          { className: 'ui-notification__content' },
          _react2['default'].createElement('div', { className: 'ui-notification__icon', dangerouslySetInnerHTML: this.icon }),
          _react2['default'].createElement(
            'div',
            { className: 'ui-notification__info' },
            _react2['default'].createElement(
              'div',
              { className: 'ui-notification__title' },
              this.props.title
            ),
            _react2['default'].createElement(
              'div',
              { className: 'ui-notification__message' },
              this.props.message
            )
          ),
          _react2['default'].createElement(
     ...
     */
    get: function get() {
      var className = 'ui-notification ui-notification--' + this.props.as;
