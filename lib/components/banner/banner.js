...
var Banner = function (_React$Component) {
  ...
  _createClass(Banner, [{
    ...
    value: function render() {
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-banner__content' },
            /*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/_icon2.default, /*istanbul ignore next*/{ className: 'carbon-banner__icon', type: this.props.as }),
            /*istanbul ignore next*/_react2.default.createElement(
              /*istanbul ignore next*/'div',
              /*istanbul ignore next*/{ className: 'carbon-banner__info' },
              /*istanbul ignore next*/_react2.default.createElement(
                /*istanbul ignore next*/'div',
                /*istanbul ignore next*/{ className: 'carbon-banner__title' },
                this.props.title
              ),
              /*istanbul ignore next*/_react2.default.createElement(
                /*istanbul ignore next*/'div',
                /*istanbul ignore next*/{ className: 'carbon-banner__message' },
                this.props.message
              )
            ),
            /*istanbul ignore next*/_react2.default.createElement(
     ...
     */
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-banner', /*istanbul ignore next*/'carbon-banner--' + this.props.as, this.props.className)
      );
    }
    ...
    key: 'buttonClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-banner__action', /*istanbul ignore next*/'carbon-banner__action--' + this.props.as)
      );
    }
  }]);
