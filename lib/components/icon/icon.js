...
var Icon = /*istanbul ignore next*/(0, _tooltipDecorator2.default)( /*istanbul ignore next*/function (_React$Component) {
  ...
  _createClass(Icon, [{
    ...
    get: function get() {
      return {
        __html: '<svg class="ui-icon__svg ui-icon__svg--pdf" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill="currentColor" fill-rule="evenodd" d="M15 1c0-.552-.456-1-.995-1H5L1 4v10.998C1 15.55 1.45 16 2.007 16h11.986C14.55 16 15 15.555 15 15V1zM4 8h8v1H4V8zm0-3h8v1H4V5zm0 6h8v1H4v-1z"/></svg>'
      };
    }
