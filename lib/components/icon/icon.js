  ...
  _createClass(Icon, [{
    ...
    value: function render() {
      ...
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/'span', /*istanbul ignore next*/{ className: 'carbon-icon__svg-icon', dangerouslySetInnerHTML: this.renderIcon }),
          this.tooltipHTML
        )
      );
    }
    ...
    get: function get() {
      ...
      var classes = /*istanbul ignore next*/(0, _classnames2.default)('carbon-icon', this.props.className, /*istanbul ignore next*/_defineProperty({}, 'icon-' + this.type, !icon));
      return classes;
    }
