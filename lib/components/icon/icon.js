...
var Icon = (0, _tooltipDecorator2.default)((_temp2 = _class = function (_React$Component) {
  ...
  _createClass(Icon, [{
    ...
    key: 'backgroundClasses',
    get: function get() {
      var has_shape = this.props.bgShape || this.props.bgColor;

      return (0, _classnames2.default)('carbon-icon__background', { 'carbon-icon__background--shape': has_shape }, _defineProperty({}, 'carbon-icon__background--' + this.props.bgSize, has_shape), _defineProperty({}, 'carbon-icon__background--' + this.props.bgShape, this.props.bgShape), _defineProperty({}, 'carbon-icon__background--' + this.props.bgColor, this.props.bgColor));
    }
   ...
   * @type      {String}
   */
  bgColor: _react2.default.PropTypes.oneOf(['red', 'orange', 'yellow', 'green', 'purple', 'magenta', 'white'])
}, _class.defaultProps = {
  bgSize: 'small'
}, _temp2));
