...
var DialogFullScreen = function (_Modal) {
  ...
  _createClass(DialogFullScreen, [{
    ...
    key: 'mainClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)(this.props.className, 'carbon-dialog-full-screen')
      );
    }
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-dialog-full-screen__header' },
            /*istanbul ignore next*/_react2.default.createElement(
              /*istanbul ignore next*/'h2',
              /*istanbul ignore next*/{ className: 'carbon-dialog-full-screen__title' },
              this.props.title
            ),
            /*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/_icon2.default, /*istanbul ignore next*/{ className: 'carbon-dialog-full-screen__close', type: 'close', onClick: this.props.onCancel })
          ),
          /*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-dialog-full-screen__content' },
            this.props.children
          )
        )
      );
