...
var Tooltip = function (_React$Component) {
  ...
  _createClass(Tooltip, [{
     ...
     */
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-tooltip', /*istanbul ignore next*/'carbon-tooltip--position-' + this.props.position, /*istanbul ignore next*/'carbon-tooltip--pointer-align-' + this.props.align, this.props.className)
      );
    }
    ...
    key: 'tooltipHTML',
    get: function get() {
      var contents = [this.props.children, /*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/'span', /*istanbul ignore next*/{ key: 'pointer', className: 'carbon-tooltip__pointer' })];
      ...
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-tooltip__container' },
            contents
          )
        )
      );
