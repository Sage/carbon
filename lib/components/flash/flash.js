...
var Flash = _wrapComponent('Flash')((_temp2 = _class = function (_React$Component) {
  ...
  _createClass(Flash, [{
    ...
    get: function get() {
      ...
      if (!this.props.timeout) {
        contents.push(_react3.default.createElement(_icon2.default, { className: 'carbon-flash__close', type: 'close', onClick: this.props.onDismiss, key: 'close' }));
      }
   ...
   * @type {Function}
   */
  onDismiss: _react3.default.PropTypes.func.isRequired,
   ...
   * @default false
   */
  open: _react3.default.PropTypes.bool.isRequired,
   ...
   */
  message: _react3.default.PropTypes.oneOfType([_react3.default.PropTypes.string, _react3.default.PropTypes.object, _react3.default.PropTypes.array]).isRequired,
   ...
   */
  timeout: _react3.default.PropTypes.number
}, _class.defaultProps = {
  as: 'success'
}, _temp2));
