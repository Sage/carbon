  ...
  function Textarea() {
    ...
    this.componentDidMount = function () {
      if (_this.props.expandable) {
        window.addEventListener('resize', _this.expandTextarea);
        ...
        _this.minHeight = _this.refs.textarea.clientHeight;

        _this.expandTextarea();
      }
    };

    this.componentWillUnmount = function () {
      if (_this.props.expandable) {
        window.removeEventListener('resize', _this.expandTextarea);
      }
    };
