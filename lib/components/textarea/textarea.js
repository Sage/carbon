...
var Textarea = /*istanbul ignore next*/(0, _input2.default)( /*istanbul ignore next*/(0, _inputLabel2.default)( /*istanbul ignore next*/(0, _inputValidation2.default)( /*istanbul ignore next*/(_temp2 = _class = function (_React$Component) {
  ...
  _createClass(Textarea, [{
    ...
    get: function get() {
      if (this.props.characterLimit) {
        return (/*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-textarea__character-limit' },
            /*istanbul ignore next*/_i18nJs2.default.t("textarea.limit.prefix", { defaultValue: 'You have used ' }),
            /*istanbul ignore next*/_react2.default.createElement(
              /*istanbul ignore next*/'span',
              /*istanbul ignore next*/{ className: 'carbon-textarea__limit-used' },
              /*istanbul ignore next*/_i18nJs2.default.toNumber(calculateCharacterCount(this.props.value), this.i18nNumberOpts)
            ),
            /*istanbul ignore next*/_i18nJs2.default.t("textarea.limit.middle", { defaultValue: ' of ' }),
            /*istanbul ignore next*/_react2.default.createElement(
              /*istanbul ignore next*/'span',
              /*istanbul ignore next*/{ className: 'carbon-textarea__limit-max' },
              /*istanbul ignore next*/_i18nJs2.default.toNumber(this.props.characterLimit, this.i18nNumberOpts)
            ),
            /*istanbul ignore next*/_i18nJs2.default.t("textarea.limit.suffix", { defaultValue: ' characters' })
          )
        );
      }
    }
   ...
   * @type {String}
   */
  characterLimit: /*istanbul ignore next*/_react2.default.PropTypes.string,
   ...
   * @default true
   */
  enforceCharacterLimit: /*istanbul ignore next*/_react2.default.PropTypes.bool
}, _class.defaultProps = {
  expandable: false,
