  ...
  _createClass(AnimatedMenuButton, [{
    ...
    get: function get() {
      return this.props.label ? _react2['default'].createElement(
        'span',
        { key: 'label', className: 'ui-animated-menu-button__label' },
        this.props.label
      ) : '';
    }
    ...
    key: 'mainClasses',
    get: function get() {
      return (0, _classnames2['default'])(this.props.className, 'ui-animated-menu-button', 'ui-animated-menu-button--' + this.props.size, 'ui-animated-menu-button--' + this.props.direction);
    }
