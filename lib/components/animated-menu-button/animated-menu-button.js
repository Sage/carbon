  ...
  _createClass(AnimatedMenuButton, [{
    ...
    get: function get() {
      return this.props.label ? /*istanbul ignore next*/_react2.default.createElement(
        ...
        /*istanbul ignore next*/{ key: 'label', className: 'carbon-animated-menu-button__label' },
        this.props.label
      ) : '';
    }
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/_react2.default.createElement(
          /*istanbul ignore next*/'div',
          /*istanbul ignore next*/{ className: 'carbon-animated-menu-button__content' },
          contents
        )
      );
    }
    ...
    key: 'mainClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)(this.props.className, 'carbon-animated-menu-button', /*istanbul ignore next*/'carbon-animated-menu-button--' + this.props.size, /*istanbul ignore next*/'carbon-animated-menu-button--' + this.props.direction)
      );
    }
