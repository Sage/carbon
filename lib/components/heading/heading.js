...
var Heading = function (_React$Component) {
  ...
  _createClass(Heading, [{
    ...
    value: function render() {
      ...
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'div',
            /*istanbul ignore next*/{ className: 'carbon-heading__header' },
            this.back,
            /*istanbul ignore next*/_react2.default.createElement(
              /*istanbul ignore next*/'div',
              /*istanbul ignore next*/{ className: 'carbon-heading__headers' },
              /*istanbul ignore next*/_react2.default.createElement(
                /*istanbul ignore next*/'div',
                /*istanbul ignore next*/{ className: 'carbon-heading__main-header' },
                /*istanbul ignore next*/_react2.default.createElement(
                  /*istanbul ignore next*/'h1',
                  /*istanbul ignore next*/{ className: 'carbon-heading__title' },
                  this.props.title
                ),
                this.help
              ),
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/_react2.default.createElement(
          /*istanbul ignore next*/'div',
          /*istanbul ignore next*/{ className: 'carbon-heading__subheader' },
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/(0, _classnames2.default)("carbon-heading", this.props.className, /*istanbul ignore next*/(_classNames = {}, _defineProperty(_classNames, "carbon-heading--has-subheader", this.props.subheader), _defineProperty(_classNames, "carbon-heading--has-back", this.props.backLink), _classNames))
      );
    }
  }]);
