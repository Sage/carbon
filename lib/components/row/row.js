...
var Row = function (_React$Component) {
  ...
  _createClass(Row, [{
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-row', this.props.className, /*istanbul ignore next*/'carbon-row--columns-' + columns)
      );
    }
  }]);
