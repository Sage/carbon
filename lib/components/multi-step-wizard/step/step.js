...
var Step = _wrapComponent('Step')((_temp2 = _class = function (_React$Component) {
      ...
      if (this.props.defaultButton === false) {
        ...
        if (this.isLastStep) {
          submitButton = _react3.default.createElement(
            _button2.default,
            { as: 'primary', onClick: this.handleOnSubmit, className: 'multi-step-wizard-step__button submit' },
            _i18nJs2.default.t('wizards.multi_step_wizard.buttons.submit', { defaultValue: 'Submit' })
          );
        } else {
          nextButton = _react3.default.createElement(
            _button2.default,
            { as: 'primary', onClick: this.handleOnNext, className: 'multi-step-wizard-step__button next' },
   ...
   * @type {Number}
   */
  stepNumber: _react3.default.PropTypes.number.isRequired,
   ...
   * @default true
   */
  defaultButton: _react3.default.PropTypes.bool,
   ...
   * @type {Function}
   */
  onNext: _react3.default.PropTypes.func,
   ...
   * @type {Function}
   */
  onBack: _react3.default.PropTypes.func,
   ...
   * @type {Array}
   */
  extraButtons: _react3.default.PropTypes.arrayOf(_react3.default.PropTypes.object),
   ...
   * @type {Boolean}
   */
  enabled: _react3.default.PropTypes.bool
}, _class.defaultProps = {
  defaultButton: true
}, _class.contextTypes = {
