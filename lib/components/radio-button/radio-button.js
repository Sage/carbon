...
var RadioButton = /*istanbul ignore next*/(0, _input2.default)( /*istanbul ignore next*/(0, _inputLabel2.default)( /*istanbul ignore next*/(0, _inputValidation2.default)( /*istanbul ignore next*/(_temp = _class = function (_React$Component) {
  ...
  _createClass(RadioButton, [{
     ...
     */
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-radio-button', this.props.className)
      );
    }
    ...
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-radio-button__help-text', {
    ...
    get: function get() {
      return (/*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/'div', /*istanbul ignore next*/{ className: 'carbon-radio-button__sprite', dangerouslySetInnerHTML: { __html: this.radiobuttonSprite } })
      );
    }
  }]);
