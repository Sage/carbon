...
var Decimal = (0, _utilsDecoratorsInput2['default'])((0, _utilsDecoratorsInputLabel2['default'])((0, _utilsDecoratorsInputValidation2['default'])((function (_React$Component) {
  ...
  function Decimal() {
    ...
    this.state = {
       ...
       * @type {String}
       */
      visibleValue: _utilsHelpersI18n2['default'].formatDecimal(this.value, this.props.precision)
    };
    ...
    this.handleBlur = function () {
      _this.setState({ visibleValue: _utilsHelpersI18n2['default'].formatDecimal(_this.value, _this.props.precision) });
  ...
  _createClass(Decimal, [{
    ...
    value: function componentWillReceiveProps(props) {
      if (this._document.activeElement != this._input) {
        ...
        this.setState({ visibleValue: _utilsHelpersI18n2['default'].formatDecimal(value, this.props.precision) });
      }
    }
