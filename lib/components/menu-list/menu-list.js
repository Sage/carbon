...
var MenuList = _wrapComponent('MenuList')((_temp = _class = function (_React$Component) {
  ...
  _createClass(MenuList, [{
    ...
    value: function filterHTML() {
      ...
      return _react3.default.createElement(
        ...
        { key: 'filter' },
        _react3.default.createElement(_textbox2.default, { onChange: this.onSearch, value: this.state.filter, autoFocus: true })
      );
    }
  }, {
    key: 'mainClasses',
  ...
  filter: _react2.PropTypes.bool,
  title: _react2.PropTypes.string,
  collapsible: _react2.PropTypes.bool
}, _class.defaultProps = {
  filter: false,
  collapsible: true
}, _temp));
