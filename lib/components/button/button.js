    ...
    get: function get() {
      ...
      if (as.constructor === Array) {
        as = as.map(function (klass) {
          return (/*istanbul ignore next*/'carbon-button--' + klass
          );
        });
      } else {
        as = [/*istanbul ignore next*/'carbon-button--' + as];
      }

      props.className = /*istanbul ignore next*/_classnames2.default.apply( /*istanbul ignore next*/undefined, /*istanbul ignore next*/['carbon-button'].concat(_toConsumableArray(as), [props.className, {
