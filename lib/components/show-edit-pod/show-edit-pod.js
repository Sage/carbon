...
var ShowEditPod = function (_React$Component) {
  ...
  function ShowEditPod() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ShowEditPod)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.control = 'props', _this.state = {
      /**
      ...
      if ( /*istanbul ignore next*/_this.stateControlled) {
  ...
  _createClass(ShowEditPod, [{
    ...
    key: 'mainClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-show-edit-pod', this.props.className)
      );
    }
    ...
    get: function get() {
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/{ as: 'error', className: 'carbon-show-edit-pod__delete', onClick: this.props.onDelete },
    ...
    key: 'content',
    get: function get() {
      return this[this.control].editing ? /*istanbul ignore next*/_react2.default.createElement(
        /*istanbul ignore next*/'div',
        /*istanbul ignore next*/{ key: 'edit' },
        this.editContent
      ) : /*istanbul ignore next*/_react2.default.createElement(
        /*istanbul ignore next*/'div',
        /*istanbul ignore next*/{ key: 'show' },
        this.props.children
      );
    }
...
/*istanbul ignore next*/ShowEditPod.propTypes = {
   ...
   * @type {Boolean}
   */
  editing: /*istanbul ignore next*/_react2.default.PropTypes.bool,
   ...
   * @type {Function}
   */
  onEdit: /*istanbul ignore next*/_react2.default.PropTypes.oneOfType([/*istanbul ignore next*/_react2.default.PropTypes.func, /*istanbul ignore next*/_react2.default.PropTypes.bool]),
