...
var Tabs = function (_React$Component) {
  ...
  function Tabs() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Tabs)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this._window = window, _this.state = {
      ...
      /*istanbul ignore next*/_this.updateVisibleTab(tabid);
    }, _this.tabHeaderClasses = function (tab) {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-tabs__headers__header', tab.props.headerClassName, {
          'carbon-tabs__headers__header--error': /*istanbul ignore next*/_this.state.tabValidity.get(tab.props.tabId) == false,
          'carbon-tabs__headers__header--selected': tab.props.tabId === /*istanbul ignore next*/_this.state.selectedTabId
        })
      );
  ...
  _createClass(Tabs, [{
    ...
    value: function componentWillMount() {
      var selectedTabId = /*istanbul ignore next*/void 0;
    ...
    */
    ...
    value: function updateVisibleTab(tabid) {
      this._window.location = /*istanbul ignore next*/'#' + tabid;
    ...
    key: 'mainClasses',
    get: function get() {
      return (/*istanbul ignore next*/(0, _classnames2.default)('carbon-tabs', this.props.className)
      );
    }
  }, {
    key: 'tabHeaders',
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/_react2.default.createElement(
          ...
          /*istanbul ignore next*/{ className: /*istanbul ignore next*/'carbon-tabs__headers carbon-tabs__headers--align-' + this.props.align },
          tabTitles
        )
      );
    }
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/_react2.default.cloneElement(visibleTab, { className: 'carbon-tab--selected' })
      );
    }
...
/*istanbul ignore next*/Tabs.propTypes = {
   ...
   * @default firstTab
   */
  selectedTabId: /*istanbul ignore next*/_react2.default.PropTypes.string,
   ...
   * @type {Func}
   */
  onTabChange: /*istanbul ignore next*/_react2.default.PropTypes.func
};
