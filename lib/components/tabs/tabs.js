...
var Tabs = _wrapComponent('Tabs')((_temp2 = _class = function (_React$Component) {
   ...
   * @default true
   */
  renderHiddenTabs: _react3.default.PropTypes.bool,
   ...
   * @default firstTab
   */
  selectedTabId: _react3.default.PropTypes.string,
   ...
   * @type {Object | Array}
   */
  children: _react3.default.PropTypes.oneOfType([_react3.default.PropTypes.array, _react3.default.PropTypes.object]).isRequired,
   ...
   * @type {Func}
   */
  onTabChange: _react3.default.PropTypes.func,
   ...
   * @type {String}
   */
  position: _react3.default.PropTypes.string
}, _class.defaultProps = {
   ...
   * @type {Object}
   */
  tabs: _react3.default.PropTypes.object
}, _temp2));
