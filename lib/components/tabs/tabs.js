...
var Tabs = (function (_React$Component) {
  ...
  function Tabs() {
    ...
    this.handleTabClick = function (ev) {
      _this.setState({ selectedTabId: ev.target.dataset.tabid });
    };

    this.tabHeaderClasses = function (tab) {
      var classes = 'ui-tabs__headers__header';

      if (_this.state.tabValidity.get(tab.props.tabId) == false) {
        classes += ' ui-tabs__headers__header--error';
      }

      if (tab.props.tabId === _this.state.selectedTabId) {
  ...
  _createClass(Tabs, [{
    ...
    value: function componentWillMount() {
      ...
      if (this.props.initialTabId) {
        ...
        if (Array.isArray(this.props.children)) {
          initialSelectedTabId = (0, _lodash.compact)(this.props.children)[0].props.tabId;
        } else {
    ...
    get: function get() {
      ...
      var tabTitles = _react2['default'].Children.map((0, _lodash.compact)(this.props.children), function (child) {
    ...
    get: function get() {
      ...
      _react2['default'].Children.forEach((0, _lodash.compact)(this.props.children), function (child) {
    ...
    get: function get() {
      ...
      var tabs = _react2['default'].Children.map((0, _lodash.compact)(this.props.children), function (child) {
