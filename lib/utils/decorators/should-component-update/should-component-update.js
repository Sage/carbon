...
var /*istanbul ignore next*/_shouldComponentUpdate = require('./../../helpers/should-component-update');
 ...
 */
var ShouldComponentUpdate = function ShouldComponentUpdate(ComposedComponent) /*istanbul ignore next*/{
  return function (_ComposedComponent) {
    ...
    _createClass(Component, [{
      ...
      value: function shouldComponentUpdate(nextProps, nextState) {
        return (/*istanbul ignore next*/(0, _shouldComponentUpdate2.default)(this, nextProps, nextState)
        );
      }
    }]);
...
/*istanbul ignore next*/exports.default = ShouldComponentUpdate;