...
var _helpersImmutable = require('./../../helpers/immutable');

var _helpersImmutable2 = _interopRequireDefault(_helpersImmutable);
    ...
    _createClass(Component, [{
      ...
      get: function get() {
        if (this._guid) {
          ...
          return this._guid = _helpersImmutable2['default'].guid();
        }
      }
