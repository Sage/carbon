...
var /*istanbul ignore next*/_help = require('./../../../components/help');
 ...
 */
var InputLabel = function InputLabel(ComposedComponent) /*istanbul ignore next*/{
  var _class, _temp;
  ...
  return _temp = _class = function (_ComposedComponent) {
    ...
    function /*istanbul ignore next*/Component() {
      ...
      /*istanbul ignore next*/return _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Component)).call.apply(_Object$getPrototypeO, [this].concat(args)));
    }
    ...
    _createClass(Component, [{
       ...
       */
      get: function get() {
        return (/*istanbul ignore next*/(0, _classnames2.default)( /*istanbul ignore next*/_get(Object.getPrototypeOf(Component.prototype), 'mainClasses', this), { 'common-input--label-inline': this.props.labelInline })
        );
      }
      ...
      key: 'labelClasses',
      get: function get() {
        return (/*istanbul ignore next*/(0, _classnames2.default)('common-input__label', {
      ...
      get: function get() {
        return (/*istanbul ignore next*/(0, _classnames2.default)( /*istanbul ignore next*/_get(Object.getPrototypeOf(Component.prototype), 'fieldHelpClasses', this), 'common-input__help-text', {
      ...
      get: function get() {
        ...
        var labelText = this.props.label || /*istanbul ignore next*/(0, _lodash.startCase)(this.props.name);
        ...
        if ( /*istanbul ignore next*/(0, _lodash.find)(this.props.validations, function (v) {
          return v.asterisk;
        })) {
          labelText += "*";
        }
        ...
        var labelStyle = this.props.labelWidth ? { width: /*istanbul ignore next*/this.props.labelWidth + '%' } : null;
      ...
      get: function get() {
        if (this.props.fieldHelp) {
          ...
          if (this.props.labelInline) {
            style.marginLeft = /*istanbul ignore next*/this.props.labelWidth + '%';
          }

          return (/*istanbul ignore next*/_react2.default.createElement(
              /*istanbul ignore next*/'span',
              /*istanbul ignore next*/{ className: this.fieldHelpClasses, style: style },
      ...
      get: function get() {
        ...
        /*istanbul ignore next*/var labelWidth = _props.labelWidth;
        /*istanbul ignore next*/var inputWidth = _props.inputWidth;
        ...
        if (inputWidth) {
          ...
          fieldProps.style.width = /*istanbul ignore next*/inputWidth + '%';
        }
...
/*istanbul ignore next*/exports.default = InputLabel;