 ...
 */
var InputIcon = function InputIcon(ComposedComponent) /*istanbul ignore next*/{
  return function (_ComposedComponent) {
    ...
    function /*istanbul ignore next*/Component() {
      ...
      _this.inputIconHTML = function (icon) {
        if ( /*istanbul ignore next*/_this.props && ( /*istanbul ignore next*/_this.props.readOnly || /*istanbul ignore next*/_this.props.disabled)) {
          return null;
        }

        return (/*istanbul ignore next*/_react2.default.createElement(
            /*istanbul ignore next*/'label',
            /*istanbul ignore next*/{ htmlFor: /*istanbul ignore next*/_this.inputProps.id, key: 'label-icon' },
            /*istanbul ignore next*/_react2.default.createElement( /*istanbul ignore next*/_icon2.default, /*istanbul ignore next*/{ type: icon, className: 'carbon-input-icon' })
          )
        );
      };
    ...
    _createClass(Component, [{
       ...
       */
      get: function get() {
        return (/*istanbul ignore next*/(0, _classnames2.default)( /*istanbul ignore next*/_get(Object.getPrototypeOf(Component.prototype), 'mainClasses', this), 'common-input--with-icon')
        );
      }
    }]);
...
/*istanbul ignore next*/exports.default = InputIcon;