    ...
    function Component() {
      ...
      this.warning = function () {
        ...
        for (var i = 0; i < _this.props.warnings.length; i++) {
          ...
          // run this validation
          shouldWarn = warning.warning(value, _this.props, _this.updateWarning);

          _this.updateWarning(shouldWarn, value, warning);
      ...
      this.updateWarning = function (shouldWarn, value, warning) {
        // if validation fails
        if (shouldWarn) {
