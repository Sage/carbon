...
var InputValidation = function InputValidation(ComposedComponent) {
  return (function (_ComposedComponent) {
    ...
    _createClass(Component, [{
      ...
      key: 'mainClasses',
      get: function get() {
        return (0, _classnames2['default'])(_get(Object.getPrototypeOf(Component.prototype), 'mainClasses', this), { 'common-input--error': !this.state.valid });
      }
      ...
      key: 'inputClasses',
      get: function get() {
        return (0, _classnames2['default'])(_get(Object.getPrototypeOf(Component.prototype), 'inputClasses', this), { 'common-input__input--error': !this.state.valid });
      }
