  ...
  return (function (_ComposedComponent) {
    ...
    _createClass(Component, [{
      ...
      get: function get() {
        ...
        return (0, _classnames2['default'])(classes, this.props.className, 'common-input', (_classNames = {
          'common-input--readonly': this.props.readOnly
        }, _defineProperty(_classNames, 'common-input--align-' + this.props.align, this.props.align), _defineProperty(_classNames, 'common-input--with-prefix', this.props.prefix), _defineProperty(_classNames, 'common-input--disabled', this.props.disabled), _classNames));
      }
