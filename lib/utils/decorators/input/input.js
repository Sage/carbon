  ...
  return (function (_ComposedComponent) {
    ...
    _createClass(Component, [{
      ...
      get: function get() {
        ...
        }, _defineProperty(_classNames, 'common-input--align-' + this.props.align, this.props.align), _defineProperty(_classNames, 'common-input--with-prefix', this.props.prefix), _classNames));
      }
