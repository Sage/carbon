 ...
 * @param {Object} params
 */
function /*istanbul ignore next*/LengthValidator() {
  ...
  var validationToCall = /*istanbul ignore next*/void 0,
      lengthFunctions = /*istanbul ignore next*/void 0,
...
/*istanbul ignore next*/exports.default = LengthValidator;
...
function getType(params) {
  var type = /*istanbul ignore next*/_validations2.default.comparisonType(params);
...
function validateLength() {
  return {
    ...
    message: function /*istanbul ignore next*/message() {
      return (/*istanbul ignore next*/_validations2.default.validationMessage(this.customMessage, 'errors.messages.wrong_length', { count: this.is })
      );
    }
  };
}
...
function validateLess() {
  return {
     ...
     */
    message: function /*istanbul ignore next*/message() {
      return (/*istanbul ignore next*/_validations2.default.validationMessage(this.customMessage, 'errors.messages.too_long', { count: this.max })
      );
    }
  };
}
...
function validateGreater() {
  return {
     ...
     */
    message: function /*istanbul ignore next*/message() {
      return (/*istanbul ignore next*/_validations2.default.validationMessage(this.customMessage, 'errors.messages.too_short', { count: this.min })
      );
    }
  };
}
...
function validateRange() {
  return {
    ...
    message: function /*istanbul ignore next*/message(value) {
      ...
      return (/*istanbul ignore next*/_validations2.default.validationMessage(this.customMessage, /*istanbul ignore next*/'errors.messages.too_' + error, { count: count })
      );
    }
  };
}