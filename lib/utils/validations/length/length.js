...
function validateLength(params) {
  return {
    ...
    message: function message() {
      return _helpersValidations2['default'].validationMessage(params.message, 'validations.length.' + params.type, { is: params.is });
    }
  };
}
...
function validateLess(params) {
  return {
     ...
     */
    message: function message() {
      return _helpersValidations2['default'].validationMessage(params.message, 'validations.length_less_than_or_equal.' + params.type, { max: params.max });
    }
  };
}
...
function validateGreater(params) {
  return {
     ...
     */
    message: function message() {
      return _helpersValidations2['default'].validationMessage(params.message, 'validations.length_greater_than_or_equal.' + params.type, { min: params.min });
    }
  };
}
...
function validateRange(params) {
  return {
     ...
     */
    message: function message() {
      return _helpersValidations2['default'].validationMessage(params.message, 'validations.length_range.' + params.type, { min: params.min, max: params.max });
    }
  };
}
