...
function validateLength() {
  return {
    ...
    message: function message() {
      return _helpersValidations2['default'].validationMessage(this.customMessage, 'errors.messages.wrong_length', { count: this.is });
    }
  };
}
...
function validateLess() {
  return {
     ...
     */
    message: function message() {
      return _helpersValidations2['default'].validationMessage(this.customMessage, 'errors.messages.too_long', { count: this.max });
    }
  };
}
...
function validateGreater() {
  return {
     ...
     */
    message: function message() {
      return _helpersValidations2['default'].validationMessage(this.customMessage, 'errors.messages.too_short', { count: this.min });
    }
  };
}
...
function validateRange() {
  return {
    ...
    message: function message(value) {
      ...
      return _helpersValidations2['default'].validationMessage(this.customMessage, 'errors.messages.too_' + error, { count: count });
    }
  };
}
