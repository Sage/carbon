...
function getType(params) {
  var type = _helpersValidations2['default'].comparisonType(params);
...
function validateLength() {
  return {
    ...
    message: function message() {
      return _helpersValidations2['default'].validationMessage(this.customMessage, 'validations.length.' + this.type, { is: this.is });
    }
  };
}
...
function validateLess() {
  return {
     ...
     */
    message: function message() {
      return _helpersValidations2['default'].validationMessage(this.customMessage, 'validations.length_less_than_or_equal.' + this.type, { max: this.max });
    }
  };
}
...
function validateGreater() {
  return {
     ...
     */
    message: function message() {
      return _helpersValidations2['default'].validationMessage(this.customMessage, 'validations.length_greater_than_or_equal.' + this.type, { min: this.min });
    }
  };
}
...
function validateRange() {
  return {
     ...
     */
    message: function message() {
      return _helpersValidations2['default'].validationMessage(this.customMessage, 'validations.length_range.' + this.type, { min: this.min, max: this.max });
    }
  };
}
