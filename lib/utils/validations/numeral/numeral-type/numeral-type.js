...
function validateDecimal() {
  return {
    ...
    message: function message() {
      return _helpersValidations2['default'].validationMessage(this.customMessage, "errors.messages.not_a_number");
    }
  };
}
...
function validateInteger() {
  return {
     ...
     */
    message: function message() {
      return _helpersValidations2['default'].validationMessage(this.customMessage, "errors.messages.not_an_integer");
    }
  };
}
