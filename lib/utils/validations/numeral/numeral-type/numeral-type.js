...
var NumeralTypeValidator = function /*istanbul ignore next*/NumeralTypeValidator() {
  ...
  var validationToCall = /*istanbul ignore next*/void 0,
      ...
      numeralType = /*istanbul ignore next*/void 0;
...
/*istanbul ignore next*/exports.default = NumeralTypeValidator;
...
function validateDecimal() {
  return {
    ...
    message: function /*istanbul ignore next*/message() {
      return (/*istanbul ignore next*/_validations2.default.validationMessage(this.customMessage, "errors.messages.not_a_number")
      );
    }
  };
}
...
function validateInteger() {
  return {
     ...
     */
    message: function /*istanbul ignore next*/message() {
      return (/*istanbul ignore next*/_validations2.default.validationMessage(this.customMessage, "errors.messages.not_an_integer")
      );
    }
  };
}