...
function validateDecimal() {
  return {
    ...
    message: function message() {
      return _helpersValidations2['default'].validationMessage(this.customMessage, "validations.decimal");
    }
  };
}
...
function validateInteger() {
  return {
     ...
     */
    message: function message() {
      return _helpersValidations2['default'].validationMessage(this.customMessage, "validations.integer");
    }
  };
}
