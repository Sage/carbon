...
var _helpersI18n = require('./../../helpers/i18n');

var _helpersI18n2 = _interopRequireDefault(_helpersI18n);
...
function getDescriptiveMessage(params, value, i18nString, i18nOptions) {
  ...
  if (!typeValidator.validate(value)) {
    ...
    i18nOptions.count = _helpersI18n2['default'].formatDecimal(i18nOptions.count, precision);
...
function validateValue() {
  return {
    ...
    validate: function validate(value) {
      ...
      var stringValue = new _bignumberJs2['default'](value),
          stringIs = new _bignumberJs2['default'](this.is);
...
function validateLess() {
  return {
    ...
    validate: function validate(value) {
      ...
      var stringValue = new _bignumberJs2['default'](value),
          stringMax = new _bignumberJs2['default'](this.max);
...
function validateGreater() {
  return {
    ...
    validate: function validate(value) {
      ...
      var stringValue = new _bignumberJs2['default'](value),
          stringMin = new _bignumberJs2['default'](this.min);
...
function validateRange() {
  return {
    ...
    message: function message(value) {
      var error = 'greater',
          count = this.min,
          stringValue = new _bignumberJs2['default'](value),
          stringMin = new _bignumberJs2['default'](count);
