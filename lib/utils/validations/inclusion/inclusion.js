 ...
 * @param {Object} params
 */
function /*istanbul ignore next*/InclusionValidator() {
  /*istanbul ignore next*/
  var _this = this;
  ...
  this.validate = function (value) {
    return (/*istanbul ignore next*/_this.allowedValues.indexOf(value) !== -1
    );
  };

  /*istanbul ignore next*/
  this.message = function () {
    return (/*istanbul ignore next*/_validations2.default.validationMessage( /*istanbul ignore next*/_this.customMessage, 'errors.messages.inclusion')
    );
  };
...
/*istanbul ignore next*/exports.default = InclusionValidator;