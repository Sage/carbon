 ...
 * @param {Object} params
 */
function /*istanbul ignore next*/ExclusionValidator() {
  /*istanbul ignore next*/
  var _this = this;
  ...
  this.validate = function (value) {
    return (/*istanbul ignore next*/_this.disallowedValues.indexOf(value) === -1
    );
  };

  /*istanbul ignore next*/
  this.message = function () {
    return (/*istanbul ignore next*/_validations2.default.validationMessage( /*istanbul ignore next*/_this.customMessage, 'errors.messages.exclusion')
    );
  };
...
/*istanbul ignore next*/exports.default = ExclusionValidator;