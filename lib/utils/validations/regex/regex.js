 ...
 * @param {Object} params
 */
function /*istanbul ignore next*/RegexValidator() {
  /*istanbul ignore next*/
  var _this = this;
  ...
  this.validate = function (value) {
    return !value || /*istanbul ignore next*/_this.format.test(value);
  };

  /*istanbul ignore next*/
  this.message = function () {
    return (/*istanbul ignore next*/_validations2.default.validationMessage( /*istanbul ignore next*/_this.customMessage, 'errors.messages.wrong_format')
    );
  };
...
/*istanbul ignore next*/exports.default = RegexValidator;