...
var BaseRegistry = function BaseRegistry() {
  ...
  this.defaultHandler = {
    call: function /*istanbul ignore next*/call(data) {
      return data;
    }
  };
  this.handlers = {};
  ...
  this.register = function (key, handler) {
    /*istanbul ignore next*/_this.handlers[key] = handler;
    return handler;
  };

  this.unregister = function (key) {
    delete /*istanbul ignore next*/_this.handlers[key];
  };
  ...
  this.obtain = function () {
    ...
    Object.keys( /*istanbul ignore next*/_this.handlers).forEach(function (key) {
      var handler = /*istanbul ignore next*/_this.handlers[key];

      if ( /*istanbul ignore next*/handler.check. /*istanbul ignore next*/apply(handler, params)) {
        handlers.push(handler);
      }
    });

    if (!handlers.length) {
      handlers.push( /*istanbul ignore next*/_this.defaultHandler);
    }
...
/*istanbul ignore next*/exports.default = BaseRegistry;