...
var Service = function () {
  ...
  _createClass(Service, [{
    ...
    key: 'get',
    value: function get(id, options, _onError) {
      var request = void 0;

      if (typeof options === 'function') {
        _logger2.default.deprecate('Passing onSuccess and onError as separate arguments is deprecated. Please use `get(1, { onSuccess: function, onError: function, params: { k: "v" } })`'); // eslint-disable-line max-len

        request = this.client.get(String(id));

        request.then(this.handleResponse.bind(this, options), this.handleResponse.bind(this, _onError));
      } else {
    ...
    key: 'post',
    value: function post(data, options, _onError) {
      var request = void 0;

      if (typeof options === 'function') {
        _logger2.default.deprecate("Passing onSuccess and onError as separate arguments is deprecated. Please use `post('', { data_key: 'data_val' }, { onSuccess: function, onError: function, params: { k: 'v' } })`"); // eslint-disable-line max-len
    ...
    key: 'put',
    value: function put(id, data, options, _onError) {
      var request = void 0;

      if (typeof options === 'function') {
        _logger2.default.deprecate("Passing onSuccess and onError as separate arguments is deprecated. Please use `put(1, { data_key: 'data_val' }, { onSuccess: function, onError: function, params: { k: 'v' } })`"); // eslint-disable-line max-len
    ...
    key: 'delete',
    value: function _delete(id, options, _onError) {
      var request = void 0;

      if (typeof options === 'function') {
        _logger2.default.deprecate("Passing onSuccess and onError as separate arguments is deprecated. Please use `delete(1, { onSuccess: function, onError: function, params: { k: 'v' } })`"); // eslint-disable-line max-len
