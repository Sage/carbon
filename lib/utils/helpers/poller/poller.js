...
/*istanbul ignore next*/require('./../../promises');
...
exports.default = function (queryOptions, functions, options) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    (function poll() {
      ...
      /*istanbul ignore next*/_superagent2.default.get(queryOptions.url).query(queryOptions.data).set(queryOptions.headers).end(function (err, response) {
        if (err) {
