...
var Events = {
  ...
  **/
  isEventType: function /*istanbul ignore next*/isEventType(ev, type) {
    return ev.type == type;
  },
  ...
  **/
  isNavigationKeyup: function /*istanbul ignore next*/isNavigationKeyup(ev) {
  ...
  **/
  isEnterKeyup: function /*istanbul ignore next*/isEnterKeyup(ev) {
    if (!Events.isEventType(ev, "keyup")) {
      return false;
    }
  ...
  **/
  isValidKeypress: function /*istanbul ignore next*/isValidKeypress(ev) {
    if (!Events.isEventType(ev, "keyup")) {
      return false;
    }
  ...
  **/
  isNumberKey: function /*istanbul ignore next*/isNumberKey(ev) {
  ...
  **/
  isNumpadKey: function /*istanbul ignore next*/isNumpadKey(ev) {
  ...
  **/
  isAlphabetKey: function /*istanbul ignore next*/isAlphabetKey(ev) {
  ...
  **/
  isSymbolKey: function /*istanbul ignore next*/isSymbolKey(ev) {
  ...
  **/
  isNavigationKey: function /*istanbul ignore next*/isNavigationKey(ev) {
  ...
  **/
  isLeftKey: function /*istanbul ignore next*/isLeftKey(ev) {
    return ev.which === 37;
  },
  ...
  **/
  isUpKey: function /*istanbul ignore next*/isUpKey(ev) {
    return ev.which === 38;
  },
  ...
  **/
  isRightKey: function /*istanbul ignore next*/isRightKey(ev) {
    return ev.which === 39;
  },
  ...
  **/
  isDownKey: function /*istanbul ignore next*/isDownKey(ev) {
    return ev.which === 40;
  },
  ...
  **/
  isMetaKey: function /*istanbul ignore next*/isMetaKey(ev) {
    return ev.metaKey;
  },
  ...
  **/
  isEscKey: function /*istanbul ignore next*/isEscKey(ev) {
    return ev.which === 27;
  },
  ...
  **/
  isEnterKey: function /*istanbul ignore next*/isEnterKey(ev) {
    return ev.which === 13;
  },
  ...
  **/
  isTabKey: function /*istanbul ignore next*/isTabKey(ev) {
    return ev.which === 9;
  },
  ...
  **/
  isBackspaceKey: function /*istanbul ignore next*/isBackspaceKey(ev) {
    return ev.which === 8;
  },
  ...
  **/
  isDeleteKey: function /*istanbul ignore next*/isDeleteKey(ev) {
    return ev.which === 46;
  },
  ...
  **/
  isDeletingKey: function /*istanbul ignore next*/isDeletingKey(ev) {
  ...
  **/
  isShiftKey: function /*istanbul ignore next*/isShiftKey(ev) {
  ...
  **/
  isSpaceKey: function /*istanbul ignore next*/isSpaceKey(ev) {
    return ev.which === 32;
  },
  ...
  **/
  isPeriodKey: function /*istanbul ignore next*/isPeriodKey(ev) {
    return ev.which === 190;
  },
  ...
  **/
  isCommaKey: function /*istanbul ignore next*/isCommaKey(ev) {
    return ev.which === 188;
  },
  ...
  **/
  isMinusKey: function /*istanbul ignore next*/isMinusKey(ev) {
    return ev.which === 189;
  }
};

/*istanbul ignore next*/exports.default = Events;