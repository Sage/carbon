...
var ImmutableHelper = {
  ...
  * @param {String} value
  */
  updateLineItem: function updateLineItem(keys, value) {
    var data = keys[0],
  ...
  * @param {Array} keys
  */
  deleteLineItem: function deleteLineItem(keys) {
    var data = keys[0],
        line_item_key = keys[1],
        _row_id = keys[2],
        line_items = data.get(line_item_key);
  ...
  */
  getLineItemIndex: function getLineItemIndex(line_items, _row_id) {
    return line_items.findIndex(function (item) {
