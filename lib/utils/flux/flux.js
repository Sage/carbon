...
function connect(ComposedView, stores) {
  ...
  var View = function (_ComposedView) {
    ...
    function /*istanbul ignore next*/View() {
      /*istanbul ignore next*/
      ...
      _this._onChange = function (key) {
        ...
        /*istanbul ignore next*/_this.setState( /*istanbul ignore next*/_defineProperty({}, key, _stores[key].getState()));
      };
      ...
      /*istanbul ignore next*/_this.state = /*istanbul ignore next*/(0, _lodash.assign)({}, /*istanbul ignore next*/_this.state, /*istanbul ignore next*/_this._getStoreStates());
    ...
    _createClass(View, [{
      ...
      value: function componentDidMount() {
        ...
        if ( /*istanbul ignore next*/_get(Object.getPrototypeOf(View.prototype), 'componentDidMount', this)) {
          /*istanbul ignore next*/_get(Object.getPrototypeOf(View.prototype), 'componentDidMount', this).call(this);
        }
      ...
      value: function componentWillUnmount() {
        ...
        if ( /*istanbul ignore next*/_get(Object.getPrototypeOf(View.prototype), 'componentWillUnmount', this)) {
          /*istanbul ignore next*/_get(Object.getPrototypeOf(View.prototype), 'componentWillUnmount', this).call(this);
        }
