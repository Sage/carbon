...
| variant | "typical" \| "legacy" \| undefined | No |  |  |  | Specify the variant of the DateInput to use. 'legacy' (default) uses the original implementation. 'typical' uses the new implementation. |  |
