...
(args) => (
    <>
      ...
      <ControlledCheckboxGroup legend="Checkbox Group with Legend" {...args} />
      <ControlledCheckboxGroup
        legend="Checkbox Group with Legend and Legend Hint"
        legendHint="Legend Hint"
        {...args}
      />
      <ControlledCheckboxGroup
        legend="Checkbox Group Inline"
        legendHint="Legend Hint"
        inline
        {...args}
      />
      <ControlledCheckboxGroup
        legend="Checkbox Group Small"
        legendHint="Legend Hint"
        size="small"
        required
        {...args}
      ...
      />
      <ControlledCheckboxGroup
        legend="Checkbox Group Small Inline"
        legendHint="Legend Hint"
        inline
        size="small"
        {...args}
      />
      <ControlledCheckboxGroup
        legend="Checkbox Group Medium Inline"
        legendHint="Legend Hint"
        inline
        size="medium"
        {...args}
      />
      <ControlledCheckboxGroup
        legend="Checkbox Group Large Inline"
        legendHint="Legend Hint"
        inline
        size="large"
        {...args}
      />
      <ControlledCheckboxGroup
        legend="Checkbox Group Disabled"
        legendHint="Legend Hint"
        required
        disabled
        {...args}
