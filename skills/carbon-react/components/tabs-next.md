---
name: carbon-component-tabs-next
description: Carbon TabsNext component props and usage examples.
---

# TabsNext

## Import
`import { Tabs } from "carbon-react/lib/components/tabs/__next__";`
...
| size | "large" \| "medium" \| undefined | No |  | The size of the tabs to use | "medium" |
