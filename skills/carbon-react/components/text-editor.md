...
When storing HTML for later use as `initialValue`, preserve the `data-carbon-base-weight` attribute. Removing it can change the base weight of bold or custom 700-weight text when it is imported again.
