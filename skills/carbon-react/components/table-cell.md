...
| scope | "auto" \| "col" \| "colgroup" \| "row" \| "rowgroup" \| undefined | No |  | The scope attribute specifies the set of data cells for which the header cell provides header information. |  |
