---
name: carbon-component-date-input-field-typical-next
description: Carbon DateInputTypicalNext component props and usage examples.
---

# DateInputTypicalNext

## Import
`import { DateInputTypical } from "carbon-react/lib/components/date/__next__";`

## Source
- Export: `./components/date/__next__`
- Props interface: `DateInputLegacyProps`
...
| inputMode | "email" \| "none" \| "search" \| "tel" \| "text" \| "url" \| "numeric" \| "decimal" \| undefined | No |  |  |  | Hints at the type of data that might be entered by the user while editing the element or its contents |  |
...
| aria-current | boolean \| "location" \| "page" \| "step" \| "true" \| "false" \| "date" \| "time" \| undefined | No |  |  |  | Indicates the element that represents the current item within a container or set of related elements. |  |
...
| aria-haspopup | boolean \| "grid" \| "true" \| "false" \| "dialog" \| "listbox" \| "menu" \| "tree" \| undefined | No |  |  |  | Indicates the availability and type of interactive popup element, such as menu or dialog, that can be triggered by an element. |  |
...
| labelAlign | "right" \| "left" \| undefined | No |  | Yes | `labelAlign` has been deprecated, the functionality will no longer work. |  |  |
...
| tooltipPosition | "right" \| "left" \| "top" \| "bottom" \| undefined | No |  | Yes | `tooltipPosition` has been deprecated, the functionality will no longer work. |  |  |
