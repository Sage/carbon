...
| outline | boolean \| undefined | No |  |  |  | Adds an outline to the tile to increase its visual prominence |  |
...
| roundness | Roundness \| LegacyRoundness \| undefined | No |  |  |  | Sets the level of roundness of the corners. Values can be "curved" or "moderate". Legacy values "default", "large", and "small" are also supported but deprecated and should not be used. | "curved" |
...
() => {
  return (
    <>
      <Tile roundness="moderate" outline mb={3}>
        <Box width="30%">Test Body One</Box>
        <Box width="40%">Test Body Two</Box>
        <Box width="30%">Test Body Three</Box>
      </Tile>
      <Tile roundness="curved" outline>
        <Box width="30%">Test Body One</Box>
        <Box width="40%">Test Body Two</Box>
        <Box width="30%">Test Body Three</Box>
      </Tile>
...
() => {
  return (
    <Box>
      <Tile variant="tile" width="75%" outline roundness="moderate">
        <Box>Test Body</Box>
      </Tile>
      <Box my={3} />
      <Tile variant="tile" width={1 / 4} outline roundness="moderate">
        <Box>Test Body</Box>
      </Tile>
      <Box my={3} />
      <Tile variant="tile" width={150} outline roundness="moderate">
        <Box>Test Body</Box>
      </Tile>
      <Box my={3} />
      <Tile variant="tile" outline roundness="moderate">
        <Box width="30%">Test Body One</Box>
...
() => {
  return (
    <>
      ...
      <Tile variant="standard" mb={3} outline roundness="moderate">
        <Box width="30%">Test Body One</Box>
        <Box width="40%">Test Body Two</Box>
        <Box width="30%">Test Body Three</Box>
      </Tile>
...
() => {
  return (
    <Box backgroundColor="#2e2e2e" p={2}>
      ...
      <Tile variant="standard" outline roundness="moderate" inverse>
        <Box width="30%">Test Body One</Box>
        <Box width="40%">Test Body Two</Box>
        <Box width="30%">Test Body Three</Box>
      </Tile>
...
() => {
  return (
    <>
      <Tile variant="alt" mb={3} outline roundness="moderate">
        <Box width="30%">Test Body One</Box>
        <Box width="40%">Test Body Two</Box>
        <Box width="30%">Test Body Three</Box>
      </Tile>
...
() => {
  return (
    <Box backgroundColor="#2e2e2e" p={2}>
      <Tile variant="alt" outline inverse roundness="moderate" mb={2}>
        <Box width="30%">Test Body One</Box>
        <Box width="40%">Test Body Two</Box>
        <Box width="30%">Test Body Three</Box>
      </Tile>
      <Tile variant="alt" inverse roundness="moderate">
        <Box width="30%">Test Body One</Box>
        <Box width="40%">Test Body Two</Box>
        <Box width="30%">Test Body Three</Box>
      </Tile>
...
() => {
  return (
    <Tile m={0} py={0} outline roundness="moderate">
      <FlexTileContainer>
        <FlexTileCell py={2}>
          <FlexTileDivider />
          Test Body One
...
() => {
  return (
    <>
      <Tile my={1} py={0} outline roundness="moderate">
        <FlexTileContainer>
...
() => {
  return (
    <Tile m={0} p={0} outline roundness="moderate">
...
() => {
  return (
    <>
      <Tile statusKeyline="blue" roundness="moderate" outline>
        <Box>blue</Box>
      </Tile>
      <br />
      <Tile statusKeyline="green" outline roundness="moderate">
        <Box>green</Box>
      </Tile>
      <br />
      <Tile statusKeyline="orange" outline roundness="moderate">
        <Box>orange</Box>
      </Tile>
      <br />
      <Tile statusKeyline="red" roundness="small" outline>
        <Box>red</Box>
      </Tile>
      <br />
      <Tile statusKeyline="neutral" outline roundness="moderate">
        <Box>neutral</Box>
      </Tile>
      <br />
      <Tile statusKeyline="purple" outline roundness="moderate">
        <Box>purple</Box>
      </Tile>
      <br />
      <Tile statusKeyline="ai" outline roundness="moderate">
        <Box>ai</Box>
      </Tile>
    </>
  );
