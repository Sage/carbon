...
| maxHeight | string \| number \| undefined | No |  | A custom max height to be applied to the component. |  |
...
| variant | VariantType \| undefined | No |  | Set the variant of the ScrollableBlock | "default" |
