...
Some components such as [Typography](../?path=/docs/foundations-typography--docs) have a `color`, `bg`/`backgroundColor` and `opacity` props, this functionality is provided by [styled-system/color](https://github.com/styled-system/styled-system/blob/master/docs/api.md#color).
