...
<table style={{width: '100%', maxWidth: '400px'}} role="table" aria-label="Component translation keys">
  ...
  <tbody>
    <tr><td headers="component-header">[actionPopover](../../components/action-popover/index.md)</td></tr>
    <tr><td headers="component-header">[advancedColorPicker](../../components/advanced-color-picker/index.md)</td></tr>
    <tr><td headers="component-header">[batchSelection](../../components/batch-selection/index.md)</td></tr>
    <tr><td headers="component-header">[breadcrumbs](../../components/breadcrumbs/index.md)</td></tr>
    <tr><td headers="component-header">confirm</td></tr>
    <tr><td headers="component-header">date</td></tr>
    <tr><td headers="component-header">[dateRange](../../components/date-range/index.md)</td></tr>
    <tr><td headers="component-header">decimal</td></tr>
    <tr><td headers="component-header">[dialog](../../components/dialog/index.md)</td></tr>
    <tr><td headers="component-header">dismissibleBox</td></tr>
    <tr><td headers="component-header">[fileInput](../../components/file-input/index.md)</td></tr>
    <tr><td headers="component-header">filterableSelect</td></tr>
    <tr><td headers="component-header">[flatTable](../../components/flat-table/index.md)</td></tr>
    <tr><td headers="component-header">[form](../../components/form/index.md)</td></tr>
    <tr><td headers="component-header">groupedCharacter</td></tr>
    <tr><td headers="component-header">heading</td></tr>
    <tr><td headers="component-header">[link](../../components/link/index.md)</td></tr>
    <tr><td headers="component-header">loader</td></tr>
    <tr><td headers="component-header">[loaderBar](../../components/loader-bar/index.md)</td></tr>
    <tr><td headers="component-header">[loaderSpinner](../../components/loader-spinner/index.md)</td></tr>
    <tr><td headers="component-header">[loaderStar](../../components/loader-star/index.md)</td></tr>
    <tr><td headers="component-header">[menu](../../components/menu/index.md)</td></tr>
    <tr><td headers="component-header">[message](../../components/message/index.md)</td></tr>
    <tr><td headers="component-header">multiSelect</td></tr>
    <tr><td headers="component-header">number</td></tr>
    <tr><td headers="component-header">[numeralDate](../../components/numeral-date/index.md)</td></tr>
    <tr><td headers="component-header">[pager](../../components/pager/index.md)</td></tr>
    <tr><td headers="component-header">[password](../../components/password/index.md)</td></tr>
    <tr><td headers="component-header">[pill](../../components/pill/index.md)</td></tr>
    <tr><td headers="component-header">pod</td></tr>
    <tr><td headers="component-header">[progressTracker](../../components/progress-tracker/index.md)</td></tr>
    <tr><td headers="component-header">responsiveVerticalMenu</td></tr>
    <tr><td headers="component-header">[search](../../components/search/index.md)</td></tr>
    <tr><td headers="component-header">[sidebar](../../components/sidebar/index.md)</td></tr>
    <tr><td headers="component-header">simpleSelect</td></tr>
    <tr><td headers="component-header">[splitButton](../../components/split-button/index.md)</td></tr>
    <tr><td headers="component-header">[stepFlow](../../components/step-flow/index.md)</td></tr>
    <tr><td headers="component-header">[switch](../../components/switch/index.md)</td></tr>
    <tr><td headers="component-header">[textEditor](../../components/text-editor/index.md)</td></tr>
    <tr><td headers="component-header">[textarea](../../components/textarea/index.md)</td></tr>
    <tr><td headers="component-header">[textbox](../../components/textbox/index.md)</td></tr>
    <tr><td headers="component-header">[tileSelect](../../components/tile-select/index.md)</td></tr>
    <tr><td headers="component-header">[time](../../components/time/index.md)</td></tr>
    <tr><td headers="component-header">toast</td></tr>
    <tr><td headers="component-header">[verticalMenu](../../components/vertical-menu/index.md)</td></tr>
    <tr><td headers="component-header">[verticalMenuFullScreen](../../components/vertical-menu/index.md)</td></tr>
  </tbody>
</table>
