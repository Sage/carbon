...
The `<I18nProvider />` component can be configured in three ways, the first is by using the default translations provided by Carbon (`en-GB`). Carbon also offers `en-CA`, `en-US`, `de-DE`, `es-ES`, `fr-CA`, `fr-FR` or
...
<table style={{width: '100%', maxWidth: '400px'}} role="table" aria-label="Component translation keys">
  ...
  <tbody>
    <tr><td headers="component-header">[actionPopover](?path=/docs/components-action-popover--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[advancedColorPicker](?path=/docs/components-advanced-color-picker--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[batchSelection](?path=/docs/patterns-batch-selection--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[breadcrumbs](?path=/docs/components-breadcrumbs--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[confirm](?path=/docs/deprecated-confirm--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[date](?path=/docs/components-date-input--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[dateRange](?path=/docs/components-date-range--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[decimal](?path=/docs/components-decimal-input--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[dialog](?path=/docs/components-dialog--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[dismissibleBox](?path=/docs/deprecated-dismissible-box--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[fileInput](?path=/docs/components-file-input--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[filterableSelect](?path=/docs/components-select-filterable--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[flatTable](?path=/docs/components-flat-table--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[form](?path=/docs/patterns-form--docs#translation-keys)</td></tr>
    ...
    <tr><td headers="component-header">[link](?path=/docs/components-link--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[loader](?path=/docs/deprecated-loader--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[loaderBar](?path=/docs/deprecated-loader-bar--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[loaderSpinner](?path=/docs/deprecated-loader-spinner--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[loaderStar](?path=/docs/deprecated-loader-star--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[menu](?path=/docs/components-menu--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[message](?path=/docs/components-message--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[multiSelect](?path=/docs/components-select-multiselect--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[number](?path=/docs/deprecated-number-input--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[numeralDate](?path=/docs/components-numeral-date--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[pager](?path=/docs/components-pager--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[password](?path=/docs/components-password--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[pill](?path=/docs/components-pill--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[pod](?path=/docs/deprecated-pod--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[progressTracker](?path=/docs/components-progress-tracker--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[responsiveVerticalMenu](?path=/docs/patterns-vertical-menu-responsive--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[search](?path=/docs/components-search--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[sidebar](?path=/docs/components-sidebar--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[simpleSelect](?path=/docs/components-select--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[splitButton](?path=/docs/components-split-button--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[stepFlow](?path=/docs/patterns-step-flow--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[switch](?path=/docs/components-switch--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[textEditor](?path=/docs/components-text-editor--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[textarea](?path=/docs/components-textarea--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[textbox](?path=/docs/components-textbox--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[tileSelect](?path=/docs/components-tile-select--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[time](?path=/docs/components-time--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[toast](?path=/docs/deprecated-toast--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[verticalMenu](?path=/docs/patterns-vertical-menu--docs#translation-keys)</td></tr>
    <tr><td headers="component-header">[verticalMenuFullScreen](?path=/docs/patterns-vertical-menu--docs#translation-keys)</td></tr>
  </tbody>
</table>
