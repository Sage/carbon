...
5. Playwright tests are configured to run in Chromium. To explicitly select the Chromium project, run `npm run test:ct -- --project=chromium`. When using the UI runner, select Chromium in the Playwright Test Runner UI.
