...
describe('InputPresentation', () => {
  ...
  it('renders the focus class when component has focus', () => {
    ...
    expect(wrapper
      ...
      .hasClass('carbon-input-presentation--has-focus')
    ).toBeTruthy()
  });
  ...
  describe('InputPresentationContext', () => {
    ...
    const getContext = wrapper => (
      wrapper.update().find('.carbon-input-presentation')
    ...
    it('provides hasFocus state and callbacks to toggle focus and blur', () => {
