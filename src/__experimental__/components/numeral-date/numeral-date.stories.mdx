...
#### Error
<Preview>
  <Story name="Date Component has Error" parameters={{ chromatic: { disable: true }}}>
    <>
      <NumeralDate
...
#### Warning
<Preview>
  <Story name="Date Component has Warning" parameters={{ chromatic: { disable: true }}}>
    <>
      <NumeralDate
        dateFormat={['dd','mm','yyyy']}
...
#### Info
<Preview>
  <Story name="Date Component has Info" parameters={{ chromatic: { disable: true }}}>
    <>
      <NumeralDate 
        dateFormat={['dd','mm','yyyy']} 
