...
import Decimal from ".";
import { OriginalTextbox } from "../../../components/textbox";
import Button from "../../../components/button";
import Box from "../../../components/box";

<Meta
  title="Experimental/Decimal Input"
...
<Preview>
  <Story name="with custom precision">
    <Decimal label="Decimal" value="0.0001" precision={4} />
  </Story>
</Preview>
...
<Preview>
  <Story name="with labelInline" parameters={{ chromatic: { disable: true } }}>
    <Decimal label="Decimal" value="0.01" labelInline />
  </Story>
</Preview>
...
<Preview>
  <Story name="with fieldHelp">
    <Decimal label="Decimal" value="0.01" fieldHelp="Help" />
  </Story>
</Preview>
...
<Preview>
  <Story name="with labelHelp">
    <Decimal label="Decimal" value="0.01" labelHelp="Help" />
  </Story>
</Preview>
...
<Preview>
  <Story name="required">
    <Decimal label="Decimal" value="0.01" required />
  </Story>
</Preview>
...
<Preview>
  <Story name="left aligned">
    <Decimal label="Decimal" value="0.01" align="left" />
  </Story>
</Preview>
