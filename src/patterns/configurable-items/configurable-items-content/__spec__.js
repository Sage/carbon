...
describe("ConfigurableItemsContent", () => {
  ...
  describe("onDrag", () => {
    ...
    it("passes the onDrag prop through to the ConfigurableItems component", () => {
      const configurableItemsWrapper = wrapper.find(ConfigurableItems);
      expect(
        configurableItemsWrapper.find(ConfigurableItems).props().onDrag
      ).toEqual(onDrag);
    });
  });
  ...
  describe("onReset", () => {
    ...
    it("passes the onReset prop through to the ConfigurableItems component", () => {
      const configurableItemsWrapper = wrapper.find(ConfigurableItems);
      expect(
        configurableItemsWrapper.find(ConfigurableItems).props().onReset
      ).toEqual(onReset);
    });
  });
  ...
  describe("onSave", () => {
    ...
    it("passes the onSave prop through to the ConfigurableItems component", () => {
      const configurableItemsWrapper = wrapper.find(ConfigurableItems);
      expect(
        configurableItemsWrapper.find(ConfigurableItems).props().onSave
      ).toEqual(onSave);
    });
  });
  ...
  describe("title", () => {
    ...
    it("passes the title prop through to the ConfigurableItems component", () => {
      const configurableItemsWrapper = wrapper.find(ConfigurableItems);
      expect(
        configurableItemsWrapper.find(ConfigurableItems).props().title
      ).toEqual("Foo");
    });
  });
