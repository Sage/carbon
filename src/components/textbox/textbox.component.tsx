      ...
      <>
        ...
        {fieldHelp && (
          <span
            ...
            style={{
              display: "block",
              // if fieldSpacing is set it applies same negative margin top minus 8px,
              // if not it sets it to 8px
              marginTop: "calc(8px - var(--fieldSpacing, 0px))",
              whiteSpace: "pre-wrap",
              width: `${inputWidth ? inputWidth - 1 + "%" : "100%"}`,
              float: "right",
            }}
