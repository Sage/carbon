...
Use this interactive example to explore Textbox props with Storybook controls.

<Canvas of={TextboxStories.Playground} />

<Controls
  of={TextboxStories.Playground}
  include={["label", "placeholder", "disabled", "readOnly", "required", "size"]}
/>
