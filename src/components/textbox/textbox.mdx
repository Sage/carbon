...
<DeprecationWarning>
This version of `Textbox` is deprecated and has been replaced by a new version named `TextInput` located in the `__next__` directory.

Please see the <a style={{color: "white"}} href="../?path=/docs/text-input--docs">new documentation page</a> for more information.
</DeprecationWarning>
