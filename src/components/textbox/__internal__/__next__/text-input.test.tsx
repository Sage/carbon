...
test("should apply `containerWidth` prop as percentage when provided as number", () => {
  ...
  const locator = screen.getByTestId("input-wrapper");
  expect(locator).toHaveStyleRule("max-width", "50%");
});
...
test.each([
  ...
  "should apply correct gap when there is an `error`, `labelInline` prop is true and `size` prop is %s",
  (size, expectedGap) => {
    render(
      <TextInput
        data-role="text-input"
...
test.each([
  ...
  "should apply correct gap when there is an `warning`, `labelInline` prop is true and `size` prop is %s",
  (size, expectedGap) => {
    render(
      <TextInput
        data-role="text-input"
...
test("should apply padding-top for LabelSet when `labelInline` prop is true and `size` prop is small", () => {
  render(
    <TextInput
      label="Test"
      value="foo"
  ...
  const locator = screen.getByTestId("label-wrapper");
  expect(locator).toHaveStyleRule("padding-top", "var(--global-space-comp-s)");
});

test("should apply padding-top for LabelSet when `labelInline` prop is true and `size` prop is medium", () => {
  render(
    <TextInput
      label="Test"
      value="foo"
  ...
  const locator = screen.getByTestId("label-wrapper");
  expect(locator).toHaveStyleRule("padding-top", "var(--global-space-comp-m)");
});

test("should apply padding-top for LabelSet when `labelInline` prop is true and `size` prop is large", () => {
  render(
    <TextInput
      label="Test"
      value="foo"
  ...
  const locator = screen.getByTestId("label-wrapper");
  expect(locator).toHaveStyleRule("padding-top", "var(--global-space-comp-l)");
});
...
test("should calculate labelSetWidth as 100 minus `inputWidth` prop when `labelInline` prop is true", () => {
  ...
  const locator = screen.getByTestId("label-wrapper");
  expect(locator).toHaveStyleRule("width", "var(--label-spacing,auto)");
});
