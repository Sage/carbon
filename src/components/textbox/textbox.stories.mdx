...
<Meta title="Design System/Textbox" parameters={{ info: { disable: true } }} />
...
<Preview>
  <Story name="paddings">
    {() => {
      ...
      return (
        <Textbox label="Textbox" value={state} onChange={setValue} p={4} />
      );
    }}
  </Story>
</Preview>
...
<<<<<<< HEAD:src/**experimental**/components/textbox/textbox.stories.mdx
...
<StyledSystemProps
  ...
  defaults={{ mt: "3", mb: "3" }}
/>
>>>>>>> major/move-experimental-components:src/components/textbox/textbox.stories.mdx
