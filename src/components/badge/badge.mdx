...
export const copilotSkill = {
  description:
    "A badge is a small numerical indicator positioned next to interactive elements. It shows when something needs action or review. For example, for notifications within navigation or to show that filters have been applied.",
};
