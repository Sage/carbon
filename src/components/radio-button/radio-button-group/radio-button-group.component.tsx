...
/**
 * @deprecated This version of RadioButtonGroup is deprecated. Please use the RadioButtonGroup component in the `__next__` folder instead. See the Carbon documentation for more details.
 */
