...
/**
 * @deprecated This version of RadioButton is deprecated. Please use the RadioButton component in the `__next__` folder instead. See the Carbon documentation for more details.
 */
