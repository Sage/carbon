...
<Canvas>
  <Story name="major/primary/destructive">
    <>
...
<Canvas>
  <Story name="major/primary/disabled">
    <>
...
<Canvas>
  <Story name="major/primary/full-width">
    <>
...
<Canvas>
  <Story name="major/primary/noWrap">
...
<Canvas>
  <Story name="major/secondary/destructive">
    <>
...
<Canvas>
  <Story name="major/secondary/disabled">
    <>
...
<Canvas>
  <Story name="major/secondary/icon">
    <>
...
<Canvas>
  <Story name="major/secondary/full-width">
    <>
...
<Canvas>
  <Story name="major/secondary/noWrap" parameters={{ chromatic: { disable: true } }}>
...
<Canvas>
  <Story name="major/tertiary/destructive">
    <>
...
<Canvas>
  <Story name="major/tertiary/disabled">
    <>
...
<Canvas>
  <Story name="major/tertiary/icon">
    <>
...
<Canvas>
  <Story name="major/tertiary/full-width">
    <>
...
<Canvas>
  <Story name="major/tertiary/noWrap" parameters={{ chromatic: { disable: true } }}>
...
<Canvas>
  <Story name="major/icon only button">
    <>
      <Button
        mt={2}
        buttonType="primary"
...
<Canvas>
  <Story
    name="major/icon only button with tooltip"
