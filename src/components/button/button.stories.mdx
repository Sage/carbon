...
<Canvas>
  <Story name="secondary">
    <>
      <Button mt={2} size="small">Small</Button>
      <Button mt={2} ml={2}>Medium</Button>
...
<Canvas>
  <Story name="secondary/icon">
    <>
      <Button mt={2} iconType="print">Medium</Button>
...
<Canvas>
  <Story name="dashed/icon">
    <>
      ...
      <Button mt={2} buttonType="dashed" iconType="add" iconPosition="after" ml={2}>
        Medium
      </Button>
      <Button mt={2} buttonType="dashed" disabled iconType="add" size="small" ml={2}>
        Small
      </Button>
      <Button
        mt={2}
