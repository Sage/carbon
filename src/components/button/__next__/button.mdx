...
implement [Icons](../?path=/story/foundations-icon--docs) into buttons. If you have multiple
...
Loading state can be applied to buttons by passing the [Loader component](?path=/docs/components-loader--docs)
