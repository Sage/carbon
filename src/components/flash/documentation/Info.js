...
const Info = (
  <div>
    ...
    <p>
      Flash is rendered in two sections: a ventral message &apos;flash&apos;,
      and a dorsal coloured &apos;slider&apos;.
    </p>
    ...
    <p>
      By default, the flash renders with a clickable close icon that hooks up
      with the onDismiss function.
    </p>

    <p>
      To instead have the flash disappear after a given time period, pass a prop
      of timeout in milliseconds.
    </p>
    ...
    <ul>
      ...
      <li>
        ...
        <StoryCode>{'{ description: "My description" }'}</StoryCode>
      </li>
      <li>
    ...
    <p>
      If a message is too long, it can be proxied to a dialog by adding
      &apos;more&apos; in your description.
    </p>

    <StoryCode padded>
      let message = &quot;This is too long ::more:: This sentence is proxied to
      a dialog.&quot;
    </StoryCode>
  </div>
);
