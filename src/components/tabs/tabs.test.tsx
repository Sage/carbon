...
test("renders relevant validation status indicators on Tabs when `validationStatusOverride` prop is set", () => {
  ...
  const tab1 = screen.getByRole("tab", { name: "Tab 1 contains errors" });
  const tab2 = screen.getByRole("tab", { name: "Tab 2 contains warnings" });
  const tab3 = screen.getByRole("tab", { name: "Tab 3 contains information" });
