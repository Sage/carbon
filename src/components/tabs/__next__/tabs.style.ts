...
export const Spacer = styled.div`
  align-self: flex-end;
  background: var(--tab-border-active-alt, #8099a6ff);
  flex-grow: 1;
  height: 2px;
`;
...
export const StyledScrollButton = styled.button<{
  ...
  border-color: var(--tab-border-active-alt, #8099a6ff);
  background: white;
  border: none;
  border-bottom: 2px solid var(--tab-border-active-alt, #8099a6ff);
  top: 6px;
  position: relative;
`;
...
export const StyledTab = styled.button<StyledTabProps>`
  ...
  :hover {
    background-color: var(--tab-bg-hover, #00324c1a);
    cursor: pointer;
  }
  ...
  ${({ activeTab, error, info, orientation, size, warning }) =>
    ...
    css`
      ...
      border: 2px solid var(--tab-border-active-alt, #8099a6ff);
      border-bottom: none;
  ...
  ${({ activeTab, error, info, orientation, size, warning }) =>
    orientation === "vertical"
      ? css`
          border: none;
          border-right: 2px solid var(--tab-border-active-alt, #8099a6ff);
