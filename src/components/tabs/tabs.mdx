...
<DeprecationWarning>
  This version of the Tabs and Tab components are deprecated and will be removed
  in a future release. The legacy interface has been adapted to use the new
  implementation, but some features could not be maintained and have been
  removed. Please migrate to the{" "}
