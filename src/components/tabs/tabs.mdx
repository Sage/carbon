...
<DeprecationWarning>
  This version of the Tabs and Tab components are deprecated and will be removed in a future release. 
  ...
  <a style={{ color: "white" }} href="../?path=/docs/components-tabs--docs">
    {" "}
