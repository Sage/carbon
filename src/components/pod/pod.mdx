...
- Editing a number of closely related inputs? [Try Fieldset](../?path=/docs/components-fieldset--docs).
- Filling in a broad series of inputs? [Try Form](../?path=/docs/patterns-form--docs).
