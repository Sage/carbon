...
<Canvas>
  ...
  >
    {({ label, ...args }) => {
      ...
      return (
        <InlineInputs label={label} labelId="inline-inputs-default" {...args}>
          <Textbox aria-labelledby="inline-inputs-default" {...validationProps} />
          <Decimal aria-labelledby="inline-inputs-default" value={decimalValue} onChange={handleDecimalChange} />
