  ...
  translationData={[
    {
      ...
      description: "The visible label for the button that hides the password.",
      type: "func",
      returnType: "string",
    },
    {
      name: "password.buttonLabelShow",
      description: "The visible label for the button that shows the password.",
      type: "func",
      returnType: "string",
    },
    {
      name: "password.ariaLabelHide",
      description: "The aria-label for the button that hides the password.",
      type: "func",
      returnType: "string",
    },
    {
      name: "password.ariaLabelShow",
      description: "The aria-label for the button that shows the password.",
      type: "func",
      returnType: "string",
    },
    {
