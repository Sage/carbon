...
<Canvas>
  <Story name="custom label values">
    ...
    >
      <ProgressTracker
        progress={50}
        currentProgressLabel={<Typography display="inline"><Typography variant="b">$50 </Typography>of <Typography variant="b">$200</Typography></Typography>}
      />
      <ProgressTracker
        mt={2}
        progress={70}
        currentProgressLabel={<Typography display="inline"><Typography variant="b">Step 3 </Typography>of <Typography variant="b">5</Typography></Typography>}
...
<Canvas>
  <Story name="default and custom label values">
    ...
    >
      ...
      <ProgressTracker mt={2} progress={50} currentProgressLabel={<p><strong>Step 3 </strong>of <strong>5</strong></p>} />
      <ProgressTracker
        mt={2}
        progress={50}
        showDefaultLabels
      ...
      <ProgressTracker
        ...
        progress={50}
        showDefaultLabels
        currentProgressLabel={<p><strong>Step 3 </strong>of <strong>5</strong></p>}
        description="Adding VAT"
      />
    </div>
  </Story>
