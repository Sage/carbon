...
describe("Content", () => {
  ...
  beforeEach(() => {
    instance = TestUtils.renderIntoDocument(
      <Content title="foo" className="foobar">
        bar
      </Content>
    );
  });
  ...
  describe("render", () => {
    ...
    it("renders custom classes", () => {
      ...
      expect(div.className).toEqual(
        "carbon-content foobar carbon-content--primary carbon-content--align-left"
      );
    });
  });
  ...
  describe("over-ride body width", () => {
    it("will set body width to 100% if over-ride set", () => {
      instance = TestUtils.renderIntoDocument(
        <Content titleWidth="40" bodyFullWidth={true}>
          {null}
        </Content>
      );
  ...
  describe("tags", () => {
    ...
    describe("on internal elements", () => {
      ...
      elementsTagTest(wrapper, ["body", "title"]);
    });
  });
});
