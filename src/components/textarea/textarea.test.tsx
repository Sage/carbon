...
test("should render component with correct colors when it is disabled", () => {
  render(<MockComponent hideBorders label="Textarea" required disabled />);
  expect(screen.getByText("Textarea")).toHaveStyleRule(
    "color",
