...
<Canvas>
  <Story name="submenu direction left" story={stories.SubmenuDirectionLeftStory} />
</Canvas>
...
<Canvas>
  <Story name="no submenu dropdown arrow" story={stories.NoDropdwonArrowOnSubmenuStory} />
</Canvas>
...
<Canvas>
  <Story name="submenu separate component" story={stories.SplitSubmenuIntoSeparateComponentStory} />
</Canvas>
...
<Canvas>
  <Story name="scrollable submenu with parent item" story={stories.ScrollableSubmenuWithParent} />
</Canvas>
...
<Canvas>
  <Story name="responsive composition" story={stories.ResponsiveCompositionStory} />
</Canvas>
