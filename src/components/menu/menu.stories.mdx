...
<Preview>
  <Story name="full navbar alignment example">
    {() => {
      const isBelowBreakpoint = (value) => useMediaQuery(`(max-width: ${value})`);
      return (
        <div style={{ minHeight: "250px" }}>
          <NavigationBar>
            ...
            <Menu display="flex" flex="1">
              <MenuItem flex="1" onClick={() => {}} maxWidth={isBelowBreakpoint("850px") ? "130px" : undefined} submenu="Menu Item One">
                <MenuItem href="#">Item Submenu One</MenuItem>
                <MenuItem href="#">Item Submenu Two</MenuItem>
                <MenuDivider />
                <MenuItem icon="settings" href="#">
              ...
              <MenuItem flex="0 0 auto" href="#" maxWidth={isBelowBreakpoint("800px") ? "120px" : undefined}>
                Menu Item Two
              </MenuItem>
              <MenuItem flex="0 0 auto" maxWidth={isBelowBreakpoint("770px") ? "130px" : undefined} submenu="Menu Item Three">
                <MenuItem href="#">Item Submenu One</MenuItem>
                <MenuItem href="#">Item Submenu Two</MenuItem>
                <MenuDivider />
                <MenuItem icon="settings" href="#">
              ...
              <MenuItem flex="0 0 auto" maxWidth={isBelowBreakpoint("750px") ? "130px" : undefined} submenu="Menu Item Four">
                <MenuItem onClick={() => {}}>Item Submenu One</MenuItem>
                <MenuItem href="#">Item Submenu Two</MenuItem>
              </MenuItem>
            </Menu>
...
<Preview>
  <Story name="responsive composition" parameters={{ chromatic: { disable: true } }}>
    {() => {
    ...
    {() => {
      ...
      const responsiveMenuItems = (startPosition, menu) => {
        if (fullscreenViewBreakPoint) {
          return [
            <MenuItem onClick={menu === "1" ? () => setMenuOpen1(true) : () => setMenuOpen2(true)}>
              Menu
            </MenuItem>,
            <MenuFullscreen
              startPosition={startPosition}
              isOpen={menu === "1" ? menuOpen1 : menuOpen2}
              onClose={menu === "1" ? () => setMenuOpen1(false) : () => setMenuOpen2(false)}
            >
              <MenuItem href="#">
                Menu Item One
              </MenuItem>
      ...
      return (
        ...
        <div style={{ minHeight: "150px" }}>
          <Menu>
            {React.Children.map(responsiveMenuItems("left", "1"), items => items)}
          </Menu>
        </div>
         <div style={{ minHeight: "150px" }}>
          <Menu menuType="dark">
            {React.Children.map(responsiveMenuItems("right", "2"), items => items)}
          </Menu>
        </div>
        </>
      );
