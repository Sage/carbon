...
test.describe("Prop tests for Menu component", () => {
  ...
  ).forEach(([type, minHeight, height, pixels]) => {
  ...
  ).forEach(([type, maxHeight, height, pixels]) => {
  ...
  (
    ["auto", "clip", "hidden", "scroll", "visible"] as MenuProps["overflowY"][]
  ).forEach((overflow) => {
