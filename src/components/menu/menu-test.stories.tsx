...
import { Menu, MenuDivider, MenuSegmentTitle, ScrollableBlock } from ".";
import { MenuType } from "./menu.context";
import MenuItem, { MenuWithChildren } from "./menu-item";
...
import { MenuDividerProps } from "./menu-divider";
...
export const MenuComponent = (props: Partial<MenuProps> & MenuDividerProps) => {
  const menuTypes = ["white", "light", "dark", "black"] as const;
  return (
    <Box mb={150}>
...
export const MenuSegmentTitleComponent = ({ ...args }) => {
  const menuTypes = ["white", "light", "dark", "black"] as const;
  return (
    <Box mb={150}>
      {menuTypes.map((menuType) => (
        <div key={menuType}>
          ...
          <Menu menuType={menuType} display="flex">
            ...
            <MenuItem submenu="Menu Item Four" onClick={() => {}}>
              <MenuItem onClick={() => {}}>Item Submenu One</MenuItem>
              <MenuSegmentTitle {...args}>segment title</MenuSegmentTitle>
              <MenuItem href="#">Item Submenu Two</MenuItem>
            </MenuItem>
          </Menu>
        </div>
