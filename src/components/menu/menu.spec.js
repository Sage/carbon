  ...
  describe('Keyboard Navigation', () => {
    ...
    describe('With provided onKeyDown', () => {
      ...
      beforeEach(() => {
        ...
        wrapper = mount(
          <Menu>
            ...
            <MenuItem onKeyDown={ onSubmenuKeyDownFn } submenu='B Menu Item Three'>
      ...
      it('should run onKeyDown if provided', () => {
        menuItemSecond.getDOMNode().focus();
        expect(menuItemSecond).toBeFocused();
        styledMenuItemSecond.props().onKeyDown({ preventDefault: () => {}, which: KEYS.arrowRight });
      ...
      it('should run onKeyDown if provided on menu item with submenu', () => {
        ...
        act(() => {
          wrapper.find(StyledMenuItemWrapper).at(3).props()
      ...
      it('should stop keyboard navigation if defaultPrevented is provided', () => {
        ...
        act(() => {
          wrapper.find(StyledMenuItemWrapper).at(3).props()
            .onKeyDown({ defaultPrevented: () => {}, preventDefault: () => {}, which: KEYS.arrowDown });
        });
    ...
    describe('With Submenu', () => {
      ...
      it('should set focus to only one matching item', () => {
        ...
        act(() => {
          wrapper.find(StyledSubmenu).find(StyledMenuItemWrapper).at(0).props()
            .onKeyDown({
              key: 'a', stopPropagation: () => {}, preventDefault: () => {}, which: KEYS.a
            });
        });
        wrapper.update();
        expect(submenuItemFirst).toBeFocused();
      ...
      it('should not move focus if there is no matching elements and it is not alphabetical key', () => {
        ...
        act(() => {
          wrapper.find(StyledSubmenu).find(StyledMenuItemWrapper).at(0).props()
            .onKeyDown({
              key: 'd', stopPropagation: () => {}, preventDefault: () => {}, which: KEYS.ctrl
            });
        });
        wrapper.update();
        expect(submenuItemFirst).toBeFocused();
      ...
      it('should open menu onMouseOver and close menu onMouseLeave', () => {
        ...
        expect(wrapper.find(MenuItem).at(2).props().isOpen)
          .toBe(false);
      ...
      it('should not close submenu if clicked inside of the element', () => {
        ...
        act(() => {
          document.dispatchEvent(new CustomEvent('click', {
            detail: {
              enzymeTestingTarget: wrapper.find(MenuItem).at(4).find('a').getDOMNode()
            }
          }));
        });
      ...
      it('should open menu on mouse click and set focus to first item if arrow down is pressed', () => {
        const MenuItem2 = wrapper.find(MenuItem).at(2).find(StyledMenuItemWrapper).at(1)
          .find('a');
        ...
        act(() => {
          wrapper.find(MenuItem).at(2).find(StyledMenuItemWrapper).at(1)
            .props()
            .onKeyDown({ preventDefault: () => {}, which: KEYS.arrowDown });
        });
      ...
      it('should focused next menu item', () => {
        act(() => {
          wrapper.find(MenuItem).at(2).find('a').at(0)
            .props()
            .onKeyDown({ preventDefault: () => {}, which: KEYS.arrowDown });
        });
        ...
        act(() => {
          wrapper.find(MenuItem).at(3).find('a')
            .props()
      ...
      it('should run synthetic click', () => {
        ...
        act(() => {
          wrapper.find(MenuItem).at(1).find('a').at(0)
            .props()
    ...
    describe('more than one submenu', () => {
      ...
      it('should open previous submenu if arrow left pressed', () => {
        ...
        act(() => {
          wrapper.find(MenuItem).at(2).find('a')
            .props()
            .onKeyDown({ preventDefault: () => {}, which: KEYS.arrowRight });
        });
        ...
        act(() => {
          wrapper.find(MenuItem).at(4).find('a').at(0)
            .props()
            .onKeyDown({ preventDefault: () => {}, which: KEYS.arrowLeft });
        });
      });
      ...
      it('should open next submenu if arrow left pressed', () => {
        ...
        act(() => {
          wrapper.find(MenuItem).at(5).find('a')
            .props()
            .onKeyDown({ preventDefault: () => {}, which: KEYS.arrowLeft });
        });
