...
>`
  ...
  ${({ $showOuterBorder, $variant }) =>
    ...
    $variant === "prominent" &&
    css`
      border: var(--global-borderwidth-xs) solid var(--table-row-border-default);
    `}
...
const StyledTable = styled.table<StyledTableProps>`
  --table-sticky-header-height: 0px;
  --table-sticky-footer-height: 0px;
  ...
  &[data-has-sticky-header="true"] {
    ...
    tbody :focus {
      scroll-margin-block-start: calc(
        var(--table-sticky-header-height) + var(--global-space-comp-xs)
      );
    }
  }
  ...
  &[data-has-sticky-footer="true"] {
    ...
    tbody :focus {
      scroll-margin-block-end: calc(
        var(--table-sticky-footer-height) + var(--global-space-comp-xs)
      );
    }
  }
  ...
  & tbody {
    ...
    tr[data-component="table-sub-row"] {
      td,
      th {
        background-color: var(--table-row-bg-alt2);
      }
    }
