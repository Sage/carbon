...
class Notification extends React.Component {
    ...
    return (
      <div className={ this.mainClasses }>
        <div className="ui-notification__content">
          <div className='ui-notification__icon' dangerouslySetInnerHTML={ this.icon }>
          </div>
    ...
    return {
      __html:
        ...
        '<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">' +
          '<g class="ui-notification__new-icon__g" fill="#FFFFFF">' +
  ...
  get warningIcon() {
    return {
      __html:
        '<svg class="ui-notification__warning-icon" width="50px" height="40px" viewBox="0 0 50 40" version="1.1" xmlns="http://www.w3.org/2000/svg">' +
  ...
  get infoIcon() {
    return {
      __html:
        '<svg class="ui-notification__info-icon "width="50px" height="40px" viewBox="0 0 50 40">' +
          '<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">' +
