...
test("hides the sidebar when the `hidden` prop is set to `true` and below the scren breakpoint", async () => {
  ...
  // Sidebar is open in a portal, so we need to query for it directly
  // eslint-disable-next-line testing-library/no-node-access
  let sidebar = document.querySelector(
    "[data-element='sidebar']",
  ) as HTMLElement;

  expect(sidebar).toHaveStyleRule("display", "block");
  ...
  // The old reference to the sidebar is no longer in the DOM, so we need to query it again
  // eslint-disable-next-line testing-library/no-node-access
  sidebar = document.querySelector("[data-element='sidebar']") as HTMLElement;
  ...
  // Same again, we need to re-query for the sidebar
  // eslint-disable-next-line testing-library/no-node-access
  sidebar = document.querySelector("[data-element='sidebar']") as HTMLElement;
