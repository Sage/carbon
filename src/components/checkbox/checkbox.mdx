...
<Canvas of={ValidationStories.Required} />

<Canvas of={ValidationStories.CheckboxGroupRequired} />
...
<Canvas of={ValidationStories.IsOptional} />

<Canvas of={ValidationStories.CheckboxGroupIsOptional} />
