...
**Note:** The `legendHelp` tooltip will be rendered as "Hint text", and the `labelHelp` and/or `fieldHelp` props will not be supported if a `Checkbox` is within a group.
