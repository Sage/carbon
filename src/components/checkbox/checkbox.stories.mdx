...
<Canvas>
  <Story name="reverse" story={stories.Reverse} />
</Canvas>
...
<Canvas>
  <Story name="checkbox group" story={stories.WithCheckboxGroup} />
</Canvas>
...
<Canvas>
  <Story name="checkbox group with inline legend" story={stories.WithCheckboxGroupInlineLegend} />
</Canvas>
