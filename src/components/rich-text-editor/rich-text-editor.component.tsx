...
// Custom CSS classes for the Lexical theme. See https://lexical.dev/docs/getting-started/theming
const theme = {
  text: {
    bold: "font-bold",
    italic: "italic",
...
export const RichTextEditor = React.forwardRef(
  (
    ...
    const initialConfig = {
      // Required: The namespace of the editor
      namespace: "Carbon Rich Text Editor",
      // Required: The theme to use for the editor
      theme,
      // Required: The error handler for the editor
      onError,
      // Optional: the mardown nodes supported by the editor
      nodes: [
        CodeNode,
        LinkNode,
        ListNode,
