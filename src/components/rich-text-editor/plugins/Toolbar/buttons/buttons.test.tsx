...
describe("Toolbar buttons", () => {
  describe("Bold button", () => {
    test("should render the bold button correctly if inactive", () => {
      render(
        <LexicalComposer
          initialConfig={{
            nodes: [],
    ...
    test("should render the bold button correctly if active", () => {
      render(
        <LexicalComposer
          initialConfig={{
            nodes: [],
  ...
  describe("Italic button", () => {
    test("should render the italic button correctly if inactive", () => {
      render(
        <LexicalComposer
          initialConfig={{
            nodes: [],
  ...
  describe("List controls", () => {
    test("should render the ordered list control correctly", async () => {
    ...
    test("should render the unordered list control correctly", async () => {
      const user = userEvent.setup();
      render(
        <LexicalComposer
          initialConfig={{
...
describe("Command buttons", () => {
  describe("Save button", () => {
    test("invokes the onSave callback with the serialized editor value", () => {
