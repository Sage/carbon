...
export const ChromaticSnapshotDropdownClosed = () => {
  return (
    ...
    >
      ...
      <Select
        name="snapshot-error-above"
        id="snapshot-error-above"
        label="Error above — medium"
        error="Tests validation above the input"
  ...
  return (
    <Box height={800} p={4}>
      ...
      >
        ...
        <OptionGroupHeader>
          <Icon type="individual" /> <span>Composed options</span>
        </OptionGroupHeader>
        ...
        <Option text="Custom child content" value="8" divider>
          ...
          >
            ...
            <Typography color="secondary" variant="small" mr={1}>
              Status: active
            </Typography>
          </Box>
        </Option>
