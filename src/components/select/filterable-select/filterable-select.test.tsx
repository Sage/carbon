...
describe("the placement of the list element", () => {
  it("should set the expected attribute on the list when `listPlacement` is is not passed", async () => {
    const user = userEvent.setup();
    render(
      <FilterableSelect label="filterable-select" onChange={() => {}} value="">
        <Option value="opt1" text="red" />
...
describe("when the user types in the input", () => {
  it("should update the input value when the user presses 'Delete' and the text is hightlighted", async () => {
    const user = userEvent.setup();
    render(
      <FilterableSelect
        label="filterable-select"
