...
<Meta title="Design System/Select/MultiSelect" />
...
<Preview>
  <Story name="controlled" parameters={{ info: { disable: true }, chromatic: { disable: true }}} >
    {() => {
...
<Preview>
  <Story name="openOnFocus" parameters={{ info: { disable: true }, chromatic: { disable: true }}} >
