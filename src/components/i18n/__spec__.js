...
describe("I18n", () => {
  describe("render", () => {
    ...
    describe("without markdown", () => {
      ...
      it("when component is rendered with only a key", () => {
        shallowRenderer.render(<I18n scope="foo" />);
      ...
      it("when component is rendered with inline set to false", () => {
        shallowRenderer.render(<I18n scope="foo" inline={false} />);
    ...
    describe("with markdown", () => {
      it("when component is rendered inline", () => {
        ...
        shallowRenderer.render(<I18n scope="foo" markdown={true} />);
  ...
  describe("tags on component", () => {
    it("include correct component, element and role data tags", () => {
      let wrapper = shallow(
        <I18n scope="foo" data-element="bar" data-role="baz" />
      );
