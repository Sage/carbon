...
<Canvas>
  <Story name="with SearchButton as string" story={stories.WithSearchButtonPropTextOverride} />
</Canvas>

You can also use the locale provider to override the button's text via the `searchButtonText` translation key.

<Canvas>
  <Story name="with SearchButton and locale override" story={stories.WithSearchButtonLocaleOverride} />
</Canvas>
