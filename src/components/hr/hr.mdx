...
### With inverse variant

The `variant` prop can be set to `"inverse"` for darker backgrounds, it applies a white background color to the horizontal rule at 30% opacity.

<Canvas of={HrStories.InverseVariant} />
