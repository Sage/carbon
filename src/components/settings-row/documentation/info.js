...
const info = (
  <div>
    ...
    <p>
        It accepts a <StoryCode padded>title</StoryCode> string to be displayed at the top left of the row.
        The <StoryCode padded>description</StoryCode> property accepts a string or JSX object to support flexible layout of elements (e.g. Links, bolded text, paragraphs) in the header column under the title. The default divider line at the bottom
        of the row may be disabled by setting <StoryCode padded>{'divider={ false }'}.</StoryCode>
