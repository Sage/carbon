...
test("getPortraitIconFontSize returns correct font size for each size", () => {
  expect(getPortraitIconFontSize("XS")).toBe("var(--global-size-3-xs)");
  expect(getPortraitIconFontSize("S")).toBe("var(--global-size-2-xs)");
  expect(getPortraitIconFontSize("M")).toBe("var(--global-size-xs)");
  expect(getPortraitIconFontSize("ML")).toBe("var(--global-size-s)");
  expect(getPortraitIconFontSize("L")).toBe("var(--global-size-m)");
  expect(getPortraitIconFontSize("XL")).toBe("var(--global-size-xl)");
  expect(getPortraitIconFontSize("XXL")).toBe("var(--global-size-2-xl)");
});
