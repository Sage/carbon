...
<Canvas of={MultiActionButtonStories.MenuWidth} />
...
The `width` prop has been deprecated and will be removed in a future version.
...
The `buttonType` prop has been deprecated and it will be removed in a future version. Only the primary variant is available for the Multi Action Button.
