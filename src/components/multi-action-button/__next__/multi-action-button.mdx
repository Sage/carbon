...
The `menuWidth` prop can be used to convert numbers from 0-1 to percentage widths. Numbers greater than 1 are converted to pixel values.
...
The `buttonType` prop has been deprecated and will soon be removed.
...
### Button text alignment (Deprecated)
The `align` prop has been deprecated and will soon be removed.
...
### Subtext (Deprecated)
The `subtext` prop has been deprecated and will soon be removed.
