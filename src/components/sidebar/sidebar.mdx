...
When a `Sidebar` has text-only content that exceeds the viewport height, it will scroll. To maintain accessibility, wrap this content in a focusable element. 
...
<Canvas of={SidebarStories.FocusableOverflowContentStory} />
