...
// Deprecated prop retained for visual regression coverage only.
export const DeprecatedLeftPosition: StoryObj<typeof Sidebar> = {
  render: (args) => (
    <InteractiveSidebar {...args} header="Legacy left Sidebar" position="left">
      Main content
    </InteractiveSidebar>
  ),
};
