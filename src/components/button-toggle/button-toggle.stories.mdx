...
<Canvas>
  <Story name="default with wrapped text minor" story={stories.DefaultWrappedTextMinor} />
</Canvas>
...
<Canvas>
  <Story name="controlled minor" story={groupStories.ControlledMinor} />
</Canvas>
...
<Canvas>
  <Story name="fullWidth minor" story={groupStories.FullWidthMinor} />
</Canvas>
...
<Canvas>
  <Story name="fieldhelp inline minor" story={groupStories.FieldHelpMinor} />
</Canvas>
...
<Canvas>
  <Story name="label inline minor" story={groupStories.LabelInlineMinor} />
</Canvas>
...
<Canvas>
  <Story name="allowDeselect minor" story={groupStories.AllowDeselectionMinor} />
</Canvas>
...
<Canvas>
  <Story name="with small icon minor" story={stories.DefaultSmallIconMinor} />
</Canvas>
...
<Canvas>
  <Story name="with large icon minor" story={stories.DefaultLargeIconMinor} />
</Canvas>
...
<Canvas>
  <Story name="icon only" story={stories.iconOnlyMinor} />
</Canvas>
...
<Canvas>
  <Story name="small with small icon minor" story={stories.smallSmallIconMinor} />
</Canvas>
...
<Canvas>
  <Story name="small with large icon minor" story={stories.smallLargeIconMinor} />
</Canvas>
...
<Canvas>
  <Story name="large minor" story={stories.largeMinor} />
</Canvas>
...
<Canvas>
  <Story name="large with small icon minor" story={stories.largeSmallIconMinor} />
</Canvas>
...
<Canvas>
  <Story name="large with large icon minor" story={stories.largeLargeIconMinor} />
</Canvas>
...
<Canvas>
  <Story name="disabled minor" story={stories.disabledMinor} />
</Canvas>
...
<Canvas>
  <Story name="grouped minor" story={stories.groupedMinor} />
</Canvas>
