...
Press one of the buttons to make a selection. This component can be used when the user has to make a choice between a small number of options. Use `ButtonToggleGroup` to manage selection state across a set of `ButtonToggle` items.
