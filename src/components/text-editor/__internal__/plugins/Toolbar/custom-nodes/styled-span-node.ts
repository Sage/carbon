...
import { TypographyKey } from "../buttons/typography-options-dropdown.component";
    ...
    return {
      span: (domNode: HTMLElement) => ({
        conversion: () => {
          ...
          const fontSize = domNode.style.fontSize || "21px";
          const lineHeight = domNode.style.lineHeight || "14px";
          return {
