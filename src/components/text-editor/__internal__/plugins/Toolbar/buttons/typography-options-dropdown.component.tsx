...
import { StyledSpanNode } from "../custom-nodes/styled-span-node";
...
export type TypographyOptionsDropdownProps = {
...
const TypographyOptionsDropdown = ({
  namespace,
}: TypographyOptionsDropdownProps) => {
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    const key = event.target.value as TypographyKey;
...
export default TypographyOptionsDropdown;
