...
describe("StyledSpanNode", () => {
  ...
  describe("DOM export and import", () => {
    ...
    test("should not leak effective bold/italic styles onto the inner span when formats are combined", () => {
      editor?.update(() => {
        const node = new StyledSpanNode(
          "Formatted Export",
          "400",
        ...
        // Base typography is preserved on the span; formatting is carried
        // exclusively by the surrounding <strong>/<em> wrappers.
        // eslint-disable-next-line jest-dom/prefer-to-have-style
  ...
  describe("HTML export/import: typography vs. formatting separation", () => {
    ...
    test("bold paragraph keeps its base paragraph weight on the span and is wrapped in strong", () => {
      editor?.update(() => {
        const node = StyledSpanNode.createFromOption(
          "paragraph",
          "Bold paragraph",
    ...
    test("explicitly bold title exports as strong > span, with the span still reporting the title's own 700 weight", () => {
      editor?.update(() => {
        const node = StyledSpanNode.createFromOption(
          "title",
    ...
    test.each([
      ...
      "bold %s keeps its non-700 base weight (%s) on the span instead of being overwritten with 700",
