...
class Banner extends React.Component {
    ...
    return (
      <div className={ this.mainClasses }>
        <div className="ui-banner__content">
          <div className='ui-banner__icon' dangerouslySetInnerHTML={ this.icon }>
          </div>
  ...
  get newIcon() {
    return {
      __html:
        '<svg class="ui-banner__new-icon" width="50px" height="40px" viewBox="0 0 50 40">' +
        '<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">' +
          '<g class="ui-banner__new-icon__g" fill="#FFFFFF">' +
  ...
  get warningIcon() {
    return {
      __html:
        '<svg class="ui-banner__warning-icon" width="50px" height="40px" viewBox="0 0 50 40" version="1.1" xmlns="http://www.w3.org/2000/svg">' +
            '<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">' +
                '<g class="ui-banner__warning-icon__g" fill="#FFFFFF">' +
  ...
  get infoIcon() {
    return {
      __html:
        '<svg class="ui-banner__info-icon "width="50px" height="40px" viewBox="0 0 50 40">' +
          '<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">' +
            '<g class="ui-banner__info-icon__g" fill="#FFFFFF">' +
