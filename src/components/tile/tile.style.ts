...
const getBorderRadius = (roundness: TileProps["roundness"]) => {
  switch (roundness) {
    ...
    default:
      return "var(--global-radius-container-xl)";
  }
};
...
const getStatusKeylineVariant = ({
  ...
  switch (variant) {
    ...
    default:
      // ai is default
      return `linear-gradient(to bottom, var(--mode-color-ai-alt-stop-1) 0%, var(--mode-color-ai-alt-stop-2) 40%, var(--mode-color-ai-alt-stop-3) 90%)`;
  }
};
