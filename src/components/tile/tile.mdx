...
- Tiles should be reserved for static content. If you require a container with controls or interactive content, use the [Card component](../?path=/docs/components-card--docs) instead.
...
<Canvas of={TileStories.HighlightVariants} />
