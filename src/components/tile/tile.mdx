...
The old values for `roundness` prop: 'default', 'small' and 'large' have been deprecated and will be removed in a future version. Please use 'curved' or 'moderate' values instead.

<Canvas of={TileStories.RoundnessStory} />
