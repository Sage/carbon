...
let definition = new Definition('dropdown-filter', DropdownFilter, {
  description: `I can choose one option from a very long list, I can filter the list to aid my selection, and I can create a new item within the list.`,
  designerNotes: `
...
* __Don’t need to filter or add new items?__ Try Dropdown.
