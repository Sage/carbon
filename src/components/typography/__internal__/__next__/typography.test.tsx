...
describe("p", () => {
  ...
  it("should apply fluid font token when `fluid` is true", () => {
    render(
      <Typography variant="p" fluid weight="medium" size="L">
        Text
      </Typography>,
    );
...
describe("strong", () => {
  it("should render with medium weight font token", () => {
  ...
  it("should apply fluid font token when `fluid` is true", () => {
    ...
    expect(element).toHaveStyle("font: var(--global-font-fluid-body-medium-m)");
  });

  it("should respect size prop with large", () => {
    render(
    ...
    expect(element).toHaveStyle(
      "font: var(--global-font-static-body-medium-l)",
    );
  });
});
...
describe("sup", () => {
  it("should render with font-size 0.75em and vertical-align super", () => {
    render(
      <Typography>
        Hello<Typography variant="sup">Superscript text</Typography>World
      </Typography>,
    );

    const element = screen.getByText("Superscript text");

    expect(element).toHaveStyle("font-size: 0.75em");
    expect(element).toHaveStyle("vertical-align: super");
    expect(element).toHaveStyle(
      "font: var(--global-font-static-body-regular-m)",
    );
  });
  ...
  it("should apply fluid font token when `fluid` is true", () => {
    ...
    expect(element).toHaveStyle(
      "font: var(--global-font-fluid-body-regular-m)",
    );
  });

  it("should respect weight prop", () => {
    render(
      <Typography>
        Hello{" "}
...
describe("sub", () => {
  it("should render with font-size 0.75em and vertical-align sub", () => {
    render(
      <Typography>
        Hello <Typography variant="sub">Subscript text</Typography> World
      </Typography>,
    );

    const element = screen.getByText("Subscript text");

    expect(element).toHaveStyle("font-size: 0.75em");
    expect(element).toHaveStyle("vertical-align: sub");
    expect(element).toHaveStyle(
      "font: var(--global-font-static-body-regular-m)",
    );
  });
