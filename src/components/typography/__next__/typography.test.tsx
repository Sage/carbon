...
describe("section-header", () => {
  it("should render as h2 with correct font/color tokens", () => {
    render(<Typography variant="section-header">Section text</Typography>);
  ...
  it("should apply fluid font token when `fluid` is true", () => {
    render(
      <Typography variant="section-header" fluid>
        Section text
      </Typography>,
    );
  ...
  it("should apply inverse color token when `inverse` is true", () => {
    render(
      <Typography variant="section-header" inverse>
        Section text
      </Typography>,
    );
  ...
  it("should override element with `as` prop", () => {
    render(
      <Typography variant="section-header" as="h3">
        Section text
      </Typography>,
    );
...
describe("section-subheader", () => {
  it("should render as h3 with correct font/color tokens", () => {
    render(<Typography variant="section-subheader">Section text</Typography>);
  ...
  it("should apply fluid font token when `fluid` is true", () => {
    render(
      <Typography variant="section-subheader" fluid>
        Section text
      </Typography>,
    );
  ...
  it("should apply inverse color token when `inverse` is true", () => {
    render(
      <Typography variant="section-subheader" inverse>
        Section text
      </Typography>,
    );
  ...
  it("should override element with `as` prop", () => {
    render(
      <Typography variant="section-subheader" as="h4">
        Section text
      </Typography>,
    );
