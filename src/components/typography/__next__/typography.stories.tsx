...
export const VariantsStory: Story = () => (
  <Box display="flex" flexDirection="column" gap={2}>
    ...
    <Typography variant="section-header">Segment Header</Typography>
    <Typography variant="section-subheader">Segment Subheader</Typography>
...
export const FluidStory: Story = () => (
  <Box display="flex" flexDirection="column" gap={2}>
    ...
    <Typography fluid variant="section-header">
      Segment Header
    </Typography>
    <Typography fluid variant="section-subheader">
      Segment Subheader
    </Typography>
