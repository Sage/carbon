...
const Typography = styled.span.attrs(({
  variant, as, fontSize, fontWeight, textTransform, lineHeight, textDecoration
}) => {
  return {
    as: as || getAs(variant),
...
font-family: 'Lato';
${({
    size, weight, textTransform, lineHeight, defaultMargin, textDecoration, display, variant, listStyleType
  }) => css`
font-style: normal;
font-size: ${size};
font-weight: ${weight};
