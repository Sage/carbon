...
import type { TypographyProps as NextTypographyProps } from "../typography/__next__/typography.component";
...
export const Typography = ({
  ...
  // Renders a styled version of the next Typography component, ensures legacy styling is still available to reduce visual changes for consumers
  return (
    <StyledTypography
      variant={nextVariant}
