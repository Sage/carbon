...
export const DefaultExample: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect((decimalInput as HTMLInputElement).value).toBe("357.00");
  },
};
...
export const frFRLocaleExample: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect((decimalInput as HTMLInputElement).value).toBe("442,00");
  },
};
...
export const WithPrecisionExample: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect((decimalInput as HTMLInputElement).value).toBe("90,210.00000");
  },
};
...
export const DecimalInputClearedExample: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect((decimalInput as HTMLInputElement).value).toBe("0.00");
  },
};
...
export const FocusedExample: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(document.activeElement).toBe(decimalInput);
  },
};
