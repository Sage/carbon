...
import { GlobalNavV2 } from ".";
import { IconType } from "../../icon";

const defaultOpenState = isChromatic();

const meta: Meta<typeof GlobalNavV2> = {
  title: "Vertical Menu/Global Nav V2",
  component: GlobalNavV2,
  parameters: {
...
export default meta;
type Story = StoryObj<typeof GlobalNavV2>;
    ...
    () => [
      {
        ...
        children: [
          { href: "#", id: "child_menu_item_1", label: "Menu Item 1" },
          { id: "divider_1", divider: true },
          {
            href: "#",
            icon: "stacked_boxes" as IconType,
            id: "child_menu_item_2",
            label: "Menu Item 2",
          },
          {
            id: "child_menu_item_3",
            label: "Menu Item With Children",
            children: [
              { href: "#", id: "child_menu_item_5", label: "Menu Item 5" },
              { id: "divider_2", divider: true },
              { href: "#", id: "child_menu_item_6", label: "Menu Item 6" },
              {
                customIcon: () => <CustomSVG />,
                href: "#",
                id: "child_menu_item_12",
                label: "Menu Item 12",
              },
            ],
          },
          { href: "#", id: "child_menu_item_4", label: "Menu Item 4" },
          {
            customIcon: () => <CustomSVG />,
            href: "#",
            id: "child_menu_item_13",
            label: "Menu Item 13",
          },
          {
            icon: "submitted" as IconType,
            id: "child_menu_item_7",
            label: "Menu Item With Children",
            children: [
              { href: "#", id: "child_menu_item_8", label: "Menu Item 8" },
              {
                href: "#",
                icon: "accessibility_web" as IconType,
                id: "child_menu_item_9",
                label: "Menu Item 9",
              },
            ],
          },
