...
A vertical menu that is responsive to the screen size. It can be used a menu in one of two modes: a dual-column layout (default) or a single-column layout (responsive mode).
