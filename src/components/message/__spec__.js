...
describe('Message', () => {
  ...
  describe('class names', () => {
    ...
    it("adds a className ui-message--warning when type is warning, ui-message--transparent when transparent propery is true and ui-message--dismisssable if onDismiss is true", () => {
      expect(warningDOM.className).toEqual('ui-message ui-message--warning ui-message--transparent ui-message--dismissable');
    });
