...
test("renders with close button if `onDismiss` is provided and calls onDismiss when clicked", async () => {
...
testStyledSystemMargin((props) => <Message {...props}>Message</Message>);
