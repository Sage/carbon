...
export const CustomWidth: Story = () => {
  return (
    <Accordion title="Width" width="100px">
      Content
    </Accordion>
  );
};
...
export const Grouped: Story = () => {
  return (
    <AccordionGroup>
      <Accordion title="Grouped Accordion 1">Content</Accordion>
      <Accordion title="Grouped Accordion 2">Content</Accordion>
      <Accordion title="Grouped Accordion 3">Content</Accordion>
    </AccordionGroup>
  );
};
Grouped.storyName = "Grouped";

export const GroupedName: Story = () => {
  return (
    <>
...
GroupedName.storyName = "Grouped Name";
