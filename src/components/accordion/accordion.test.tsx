...
it("displays a deprecation warning if an Accordion is rendered with the 'standard' variant", () => {
  assertDeprecationWarning({
    component: <Accordion title="test-1" />,
    deprecationMessage:
...
it("displays a deprecation warning if an Accordion is rendered with an error", () => {
  assertDeprecationWarning({
    component: <Accordion title="test-1" error="error" />,
    deprecationMessage:
      "The `error` prop in `Accordion` is deprecated and will soon be removed.",
  });
});

it("displays a deprecation warning if an Accordion is rendered with a warning", () => {
  assertDeprecationWarning({
    component: <Accordion title="test-1" warning="warning" />,
    deprecationMessage:
      "The `warning` prop in `Accordion` is deprecated and will soon be removed.",
  });
});

it("displays a deprecation warning if an Accordion is rendered with the 'subtle' variant", () => {
  assertDeprecationWarning({
    component: <Accordion title="test-1" variant="subtle" />,
    deprecationMessage:
