...
<Canvas>
  <Story name="sub title" story={Subtitle} />
</Canvas>
...
<Canvas>
  <Story name="full border" story={Fullborder} />
</Canvas>
...
<Canvas>
  <Story name="icon left" story={LeftAlignedIcon} />
</Canvas>
...
<Canvas>
  <Story name="different width" story={DifferentWidth} />
</Canvas>
...
<Canvas>
  <Story name="opening button" story={OpeningButton} />
</Canvas>
...
<Canvas>
  <Story name="grouped" story={Grouped} />
</Canvas>
...
<Canvas>
  <Story name="validation icon" story={WithValidationIcon} />
</Canvas>
...
<Canvas>
  <Story name="with dynamic content" story={WithDynamicContent} />
</Canvas>
