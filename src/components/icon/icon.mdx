...
Use the `color` prop to apply one of the supported semantic icon colors: `neutral`, `subtle`, `caution`, `info`, `negative`, or `positive`.

<Canvas of={IconStories.ColorPresets} />
