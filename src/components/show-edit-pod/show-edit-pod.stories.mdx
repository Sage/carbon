...
<DeprecationWarning>
  We've deprecated ShowEditPod. It's no longer available in the Design System
  and we recommend that you do not use it in new products. See Related
  Components section for alternatives.
</DeprecationWarning>
