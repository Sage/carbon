    ...
    [
      {
        ...
        description: "The text displayed in the tooltip if the day validation fails",
        type: "func",
        returnType: "string"
      },
       {
        name: "numeralDate.validation.month",
        description: "The text displayed in the tooltip if the month validation fails",
        type: "func",
        returnType: "string"
      },
      {
        name: "numeralDate.validation.year",
        description: "The text displayed in the tooltip if the year validation fails",
        type: "func",
        returnType: "string"
      },
    ]
