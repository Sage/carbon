...
<DeprecationWarning>
  This version of the FlatTable component is no longer supported and will be
  removed in a future release. Please consider moving to the{" "}
  For new implementations, use `Table`. Existing consumers should follow the
...
<Canvas of={FlatTableStories.WithDisabledCheckboxes} />
  ...
  translationData={[
    {
      ...
      description:
        "The accessible name that is announced on interaction with the component." +
