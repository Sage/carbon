...
import { FlatTableSortableStory } from "./flat-table.stories";
...
export const getYear = (i: number) => 2020 - i;

export const rowData = (i: number) => ({
  employee: (
    <>
...
export function getRowWithInputs(onClickFn: OnClick, hasHeaderRow?: boolean) {
...
export function renderBody(rowCount: number) {
...
export const SortableStory = FlatTableSortableStory.bind({});
