...
export const ExpandableWithLinkAndActionPopover = () => {
  ...
  return (
    <FlatTable data-role="default-table">
      <FlatTableHead>
        <FlatTableRow>
          <FlatTableRowHeader>Name</FlatTableRowHeader>
          <FlatTableHeader>Location</FlatTableHeader>
          <FlatTableHeader>Relationship Status</FlatTableHeader>
          <FlatTableHeader>Other</FlatTableHeader>
        </FlatTableRow>
      </FlatTableHead>
      <FlatTableBody>
      ...
      <Box mb={4}>
        <FlatTable title="Table for Header with Row and Column spans">
          ...
          <FlatTableBody>
            ...
            <FlatTableRow>
              <FlatTableCell>Jane Doe</FlatTableCell>
              <FlatTableRowHeader>000002</FlatTableRowHeader>
              <FlatTableCell>London</FlatTableCell>
              <FlatTableCell>Single</FlatTableCell>
              <FlatTableCell>0</FlatTableCell>
              <FlatTableCell>0</FlatTableCell>
...
export const FlatTableRoundedCorners = () => {
  const [recordsRange] = useState({ start: 0, end: 10 });
  const borderRows = [
    <FlatTableRow key="0">
      <FlatTableCell>John Doe</FlatTableCell>
      <FlatTableCell>London</FlatTableCell>
  ...
  const renderBorderRows = () => {
    const { start, end } = recordsRange;
    if (start < 0) return borderRows;
    if (end > borderRows.length)
      return borderRows.slice(start, borderRows.length);
    return borderRows.slice(start, end);
  };

  return (
    <Box>
      <Box mb={2}>
        <h2> Bottom border radius 000</h2>
        <Box mb={4}>
          <FlatTable
            bottomBorderRadius="borderRadius000"
            title="Table for Bottom Border Radius 000"
          >
            <FlatTableHead>
              <FlatTableRow>
                <FlatTableHeader>Name</FlatTableHeader>
            ...
            <FlatTableBody>{renderBorderRows()}</FlatTableBody>
          </FlatTable>
        </Box>
      </Box>
      <Box mb={2}>
        <h2> Bottom border radius 100</h2>
        <Box mb={4}>
          <FlatTable
            bottomBorderRadius="borderRadius100"
            title="Table for Bottom Border Radius 100"
          >
            <FlatTableHead>
              <FlatTableRow>
                <FlatTableHeader>Name</FlatTableHeader>
      ...
      <Box mb={2}>
        <h2> Bottom border radius 200</h2>
        <Box mb={4}>
          <FlatTable
            bottomBorderRadius="borderRadius200"
            title="Table for Bottom Border Radius 200"
          >
            <FlatTableHead>
              <FlatTableRow>
                <FlatTableHeader>Name</FlatTableHeader>
      ...
      <Box mb={2}>
        <h2> Bottom border radius 400</h2>
        <Box mb={4}>
          <FlatTable
            bottomBorderRadius="borderRadius400"
            title="Table for Bottom Border Radius 400"
          >
            <FlatTableHead>
              <FlatTableRow>
                <FlatTableHeader>Name</FlatTableHeader>
      ...
      <Box mb={2}>
        <h2> Bottom border radius 000 with horizontal scrolling</h2>
        <Box mb={4}>
          <FlatTable
            title="Table for Bottom Border Radius 200"
            width="200px"
...
FlatTableRoundedCorners.parameters = {
  themeProvider: { chromatic: { theme: "sage" } },
};
FlatTableRoundedCorners.storyName = "Rounded Corners";
