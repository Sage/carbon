...
export const WithSortingHeadersAndCustomAccessibleName: ComponentStory<
  typeof FlatTable
> = (args) => {
  const headDataItems: HeadDataItems = [
    { name: "client", isActive: true },
...
WithSortingHeadersAndCustomAccessibleName.storyName =
  "with sorting headers and custom accessible name";
WithSortingHeadersAndCustomAccessibleName.parameters = {
  docs: {
    source: {
      type: "code",
    },
