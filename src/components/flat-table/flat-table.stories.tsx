...
export const Default: ComponentStory<typeof FlatTable> = () => (
  <FlatTable>
    <FlatTableHead>
      <FlatTableRow>
        <FlatTableHeader>
...
WithStickyFooterInsideOfLargerDiv.parameters = {
...
export const WithZebraStripes: ComponentStory<typeof FlatTable> = () => (
  <FlatTable isZebra>
    <FlatTableHead>
      <FlatTableRow>
        <FlatTableHeader>Name</FlatTableHeader>
...
WithZebraStripes.storyName = "zebra";

export const FlatTableSortableStory: ComponentStory<typeof FlatTable> = (
  args
) => {
...
FlatTableSortableStory.storyName = "with sorting headers";
FlatTableSortableStory.parameters = {
  docs: {
    source: {
      type: "code",
    },
...
export const WithPagination: ComponentStory<typeof FlatTable> = () => {
  const [recordsRange, setRecordsRange] = useState({ start: 0, end: 5 });
  const [currentPage, setCurrentPage] = useState(1);
  const rows = [
    <FlatTableRow key="0">
...
WithPagination.storyName = "paginated";
...
PaginatedWithStickyHeader.parameters = { chromatic: { disableSnapshot: true } };
