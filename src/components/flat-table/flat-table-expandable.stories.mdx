...
<Canvas>
  <Story name="default" story={stories.FlatTableExpandableDefault} />
</Canvas>
...
<Canvas>
  <Story name="row headers with custom paddings" story={stories.RowHeadersWithCustomPadding} />
</Canvas>
...
<Canvas>
  <Story name="sub rows as component" story={stories.Foo} />
</Canvas>
