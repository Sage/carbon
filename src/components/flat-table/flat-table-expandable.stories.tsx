...
export const FlatTableExpandableDefault = (args: { pl: string | number }) => {
  const SubRows = [
...
FlatTableExpandableDefault.storyName = "default";
FlatTableExpandableDefault.args = {
  pl: {
...
FlatTableExpandableDefault.parameters = {
  docs: {
    source: {
      type: "code",
    },
...
export const RowHeadersWithCustomPadding = () => {
  const SubRows = [
    <FlatTableRow key="sub-row-1">
...
RowHeadersWithCustomPadding.storyName = "row headers with custom paddings";
