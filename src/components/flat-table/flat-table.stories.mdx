...
<Canvas>
  <Story name="with sorting headers and custom accessible name" story={stories.WithSortingHeadersAndCustomAccessibleName} />
</Canvas>
  ...
  translationData={[
    {
      ...
      description: "The accessible name which is announced on interaction with the component.",
      type: "func",
      returnType: "string",
    }
  ]}
