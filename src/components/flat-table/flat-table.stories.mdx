...
<Canvas>
  <Story name="with multiple row headers">
    <FlatTable width="680px" overflowX="auto">
      <FlatTableHead>
        <FlatTableRow>
          ...
          <FlatTableHeader>Scrollable Column</FlatTableHeader>
          <FlatTableHeader>Scrollable Column</FlatTableHeader>
          <FlatTableRowHeader stickyAlignment="right">Sticky Column</FlatTableRowHeader>
          <FlatTableHeader>Sticky Column</FlatTableHeader>
        </FlatTableRow>
      </FlatTableHead>
      <FlatTableBody>
        <FlatTableRow>
          ...
          <FlatTableCell>Scrollable Content</FlatTableCell>
          <FlatTableCell>Scrollable Content</FlatTableCell>
          <FlatTableRowHeader stickyAlignment="right">Sticky Content</FlatTableRowHeader>
          <FlatTableCell>Sticky Content</FlatTableCell>
        </FlatTableRow>
        <FlatTableRow>
          <FlatTableCell>Sticky Content</FlatTableCell>
...
In this example of FlatTable with `stickyFooter`, FlatTable has been placed inside of a `Box` with a height
of `220px` and a column contains a long piece of text that causes the table to overflow horizontally. 
