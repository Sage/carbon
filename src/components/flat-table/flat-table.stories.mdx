...
<Canvas>
  <Story name="zebra" story={stories.WithZebraStripes} />
</Canvas>

### With sorting headers

<Canvas>
  <Story name="with sorting headers" story={stories.FlatTableSortableStory} />
</Canvas>
...
<Canvas>
  <Story name="paginated" story={stories.WithPagination} />
</Canvas>
