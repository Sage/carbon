...
test.describe("Prop tests", () => {
  ...
  test(`should render with sticky header and scroll through the content correctly`, async ({
    mount,
    page,
  }) => {
    await mount(
  ...
  test(`should render with sticky footer and scroll through the content correctly`, async ({
    mount,
    page,
  }) => {
