...
export const DefaultDateRange: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect((startInput as HTMLInputElement).value).toBe("04/15/2024");
    await expect((endInput as HTMLInputElement).value).toBe("04/30/2024");
  },
};
...
export const InlineLabelsDateRange: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect((startInput as HTMLInputElement).value).toBe("05/01/2025");
    await expect((endInput as HTMLInputElement).value).toBe("05/12/2025");
  },
};
...
export const MinMaxDateRange: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect((startInput as HTMLInputElement).value).toBe("17/07/2025");

    await userEvent.click(endIcon);
    await userEvent.keyboard("{PageDown}{Home}{Enter}");
    await expect((endInput as HTMLInputElement).value).toBe("20/07/2025");
  },
};
...
export const DisabledDaysDateRange: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect((endInput as HTMLInputElement).value).toBe("25/07/2025");
  },
};
...
export const LocaleEnUSDateRange: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect((startInput as HTMLInputElement).value).toBe("08/05/2025");
    await expect((endInput as HTMLInputElement).value).toBe("08/12/2025");
  },
};
...
export const AllowEmptyDateRange: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect((start as HTMLInputElement).value).toBe("");
    await expect((end as HTMLInputElement).value).toBe("");
  },
};
