...
describe("for the deprecated props", () => {
  it("logs deprecation warning when colorVariant is used", () => {
    assertLoggerComponentMessage({
      component: <Pill colorVariant="positive">Test Pill</Pill>,
      message:
        "The `colorVariant` prop in `Pill` is deprecated and will soon be removed. Please use `variant` instead.",
    });
  });

  it("logs deprecation warning when neutralWhite colorVariant is used", () => {
    assertLoggerComponentMessage({
      component: <Pill colorVariant="neutralWhite">Test Pill</Pill>,
      message:
        'The `neutralWhite` colorVariant in `Pill` is deprecated. Use `variant="grey"` with `fill` and `inverse` props instead.',
    });
  });

  it("logs deprecation warning when isDarkBackground is used", () => {
    assertLoggerComponentMessage({
      component: <Pill isDarkBackground>Test Pill</Pill>,
      message:
        "The `isDarkBackground` prop in `Pill` is deprecated and will soon be removed. Please use `inverse` instead.",
    });
  });

  it("logs deprecation warning when XL size is used", () => {
    assertLoggerComponentMessage({
      component: <Pill size="XL">Test Pill</Pill>,
      message:
        "The `XL` size in `Pill` is deprecated and will soon be removed.",
    });
  });

  it("logs deprecation warning when pillRole is used", () => {
    assertLoggerComponentMessage({
      component: <Pill pillRole="status">Test Pill</Pill>,
      message:
