...
<Canvas>
  ...
  >
    {(args) => (
      <Box height="200px" bgColor="#FF0000">
        <Drawer
          {...args}
          sidebar={<Typography>Any sidebar content goes here.</Typography>}
        >
        ...
        <Box>
          ...
          <Box height="200px">
            <Drawer
              ...
              title={
                <Typography variant="h2">Controllage Usage Drawer</Typography>
              }
              showControls
              expandedWidth="62%"
              expanded={true}
        ...
        <Box>
          ...
          <Box height="200px">
            <Drawer
              ...
              title={
                <Typography variant="h2">Controlled Usage Drawer</Typography>
              }
              showControls
              expanded={isExpanded}
              onChange={onChangeHandler}
            ...
            sidebar={
              <Box>
                <NavigationContainer>
                  ...
                  <Button onClick={handleDialogOpen} buttonType="primary">
                    Add User
                  </Button>
                </NavigationContainer>
        ...
        <Box height="200px">
          ...
          >
            <Box>
              ...
              <Box p="4px" display={active === "tab-4" ? "block" : "none"}>
                <Checkbox
                  label="Add error"
                  error={errors.four}
