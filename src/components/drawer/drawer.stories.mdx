...
<Meta title="Design System/Drawer" parameters={{ info: { disable: true } }} />
...
<Preview>
  <Story name="custom height" parameters={{ chromatic: { disable: true } }}>
    <Drawer
      height="230px"
      defaultExpanded
...
<Preview>
  <Story name="background color white">
...
<Preview>
  <Story name="background color transparent">
    <div style={{ height: "200px", backgroundColor: "#FF0000" }}>
      <Drawer
        expandedWidth={text("expandedWidth", "40%")}
        animationDuration={text("animationDuration", "0.5s")}
...
<Preview>
  <Story name="title" parameters={{ chromatic: { disable: true } }}>
    <div style={{ height: "200px" }}>
      <Drawer
        expandedWidth="40%"
        animationDuration="0.5s"
...
<Preview>
  <Story name="custom sidebar" parameters={{ chromatic: { disable: true } }}>
    <div>
      <Drawer
        defaultExpanded
...
<Preview>
  <Story name="custom content" parameters={{ chromatic: { disable: true } }}>
    <div style={{ height: "200px" }}>
      <Drawer
