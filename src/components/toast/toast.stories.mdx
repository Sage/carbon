...
A brief announcement containing critical information related to an action the user has performed, letting the user know if the action was performed or failed to complete.
...
Please note, toggling each switch will open an example toast at the top of the page.
