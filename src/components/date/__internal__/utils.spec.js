...
describe("formatToISO", () => {
  ...
  it.each(
    parseParameters(["ddMMyy", "dd.MM.yy", "dd,MM,yy", "dd-MM-yy", "dd/MM/yy"])
  )(
    "returns the expected ISO formatted string when %s format and %s value passed in",
    (format, value) => {
...
describe("formattedValue", () => {
  ...
  it.each(["ddMMyyyy", "dd.MM.yyyy", "dd,MM,yyyy", "dd-MM-yyyy", "dd/MM/yyyy"])(
    "formats a valid date to the expected %s format",
    (format) => {
