...
<Meta
  title="Design System/Date Input"
    ...
    [
      {
        ...
        description: "The valid formats for the input component, any value matching one of these formats will be parsed to a date",
        type: "func",
        returnType: "string[]"
      },
       {
        name: "date.formats.javascript",
        description: "The valid format for the picker/ calendar component, this the format that the input will display when it is blurred",
        type: "func",
        returnType: "string"
      },
    ]
