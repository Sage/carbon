    ...
    <div style={{
      ...
      {["left", "right"].map((align) => (
        <React.Fragment key={`${align}-negative-variant`}>
          <br />
          <Link icon="settings" isDarkBackground variant="negative" iconAlign={align} href="#foo">
            This is a link
          </Link>
        </React.Fragment>
      ))}
      ...
      {["left", "right"].map((align) => (
        <React.Fragment key={`${align}-neutral-variant`}>
          <br />
          <Link icon="settings" isDarkBackground variant="neutral" iconAlign={align} href="#foo">
            This is a link
          </Link>
        </React.Fragment>
      ))}
