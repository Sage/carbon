...
By default, a small adjustment to spacing is made to the component when the screen size is less than `380px` to ensure the content does not overflow. 
To change this breakpoint value, you can pass a string to the `smallScreenBreakpoint` prop. 
