...
export const LabelHelpAndFieldHelp: Story = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
    {/* labelHelp — used as hint text when inputHint is not provided */}
    <Switch
      label="labelHelp only"
      labelHelp="Help text via labelHelp"
      checked={false}
      onChange={() => {}}
    />
    <Switch
      label="labelHelp only (checked)"
      labelHelp="Help text via labelHelp"
      checked
      onChange={() => {}}
    />

    {/* fieldHelp — renders below the switch row */}
    <Switch
      label="fieldHelp only"
      fieldHelp="Help text via fieldHelp"
      checked={false}
      onChange={() => {}}
    />
    <Switch
      label="fieldHelp only (checked)"
      fieldHelp="Help text via fieldHelp"
      checked
      onChange={() => {}}
    />

    {/* Both labelHelp and fieldHelp */}
    <Switch
      label="labelHelp and fieldHelp"
      labelHelp="Hint via labelHelp"
      fieldHelp="Help text via fieldHelp"
      checked={false}
      onChange={() => {}}
    />

    {/* labelHelp overridden by inputHint */}
    <Switch
      label="inputHint takes precedence over labelHelp"
      inputHint="Hint via inputHint"
      labelHelp="Hint via labelHelp (should not show)"
      checked={false}
      onChange={() => {}}
    />

    {/* Large size with labelHelp and fieldHelp */}
    <Switch
      label="Large, labelHelp and fieldHelp"
      labelHelp="Hint via labelHelp"
      fieldHelp="Help text via fieldHelp"
      size="large"
      checked={false}
...
LabelHelpAndFieldHelp.storyName = "Label help and field help";
LabelHelpAndFieldHelp.parameters = { chromatic: { disableSnapshot: false } };
