...
#### With error and options

<Canvas
  of={SwitchStories.NewValidationInlineErrorAndOptions}
  name="single switch - inline validation with error and options"
/>

#### With warning

<Canvas
  of={SwitchStories.NewValidationInlineWarning}
  name="single switch - inline validation with warning"
/>
...
#### With overflowing field help

<Canvas
  of={SwitchStories.NewValidationInlineWithOverflowFieldHelp}
  name="single switch - inline validation with overflowing field help"
/>
