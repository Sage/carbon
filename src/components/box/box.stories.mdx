...
<Canvas>
  ...
  >
    <Box
      bg="var(--colorsUtilityMajor050)"
      overflowWrap="break-word"
      width="100px"
    >
      <Typography>WithOverflowWrap</Typography>
    </Box>
  </Story>
</Canvas>
...
<Canvas>
  ...
  >
    ...
    <Box bg="var(--colorsUtilityMajor800)" display="inline-block">
      <Box
        display="inline-block"
        size="150px"
        overflow="auto"
...
<ArgsTable of={Box} exclude={["as", "ref", "forwardedAs", "theme"]} />
