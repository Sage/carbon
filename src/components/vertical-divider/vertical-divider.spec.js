...
describe('VerticalDivider', () => {
  describe('styles', () => {
    testStyledSystemSpacing(props => <VerticalDivider { ...props } />, { p: 3 });
    ...
    describe('with prop values set', () => {
      ...
      it.each([20, 75, 80, 90])('matches expected when color prop is passed %s', (tint) => {
  ...
  describe('tags', () => {
    it('root has the expected data-component', () => {
      expect(render().find(StyledVerticalWrapper).prop('data-component')).toEqual('vertical-divider');
    });
  });
});
