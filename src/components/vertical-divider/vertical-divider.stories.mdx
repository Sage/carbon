...
import { Menu, MenuItem, MenuDivider, MenuVerticalDivider } from "../menu";
import {
  FlatTable,
  FlatTableHead,
  FlatTableBody,
...
<Canvas>
  <Story name="default">
    {() => {
      const Square = () => (
        <Box height="56px" width="56px" backgroundColor="var(--colorsYin090)" />
      );
      return (
...
<Canvas>
  ...
  >
    <Box display="inline-block" width="620px" height="auto" margin="0px 180px">
      <Icon type="home" />
...
<Canvas>
  <Story name="in a tile">
    {() => {
      const Square = () => (
        <Box height="40px" width="40px" backgroundColor="var(--colorsYin090)" />
      );
      return (
