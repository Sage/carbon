...
import { Menu, MenuItem, SubmenuBlock, MenuDivider, MenuVerticalDivider } from '../menu';
import { FlatTable, FlatTableHead, FlatTableBody, FlatTableHeader, FlatTableRow, FlatTableCell } from '../flat-table';
import StyledSystemProps from '../../../.storybook/utils/styled-system-props';

<Meta
  title='Design System/VerticalDivider'
...
<Preview>
  <Story name='in a non-flex container' parameters={{ chromatic: { disable: true }}}>
    <div style={{display: 'inline-block', width: '620px', height: 'auto', margin: '0px 180px' }}> 
      <Icon type='home' />
