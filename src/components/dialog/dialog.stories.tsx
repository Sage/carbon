...
Fullscreen.storyName = "Fullscreen: Default";
...
WithComplexExample.storyName = "Fullscreen: With Complex Example";
...
WithDisableContentPadding.storyName =
  "Fullscreen: With Disable Content Padding";
...
WithHeaderChildren.storyName = "Fullscreen: With Header Children";
...
WithHideableHeaderChildren.storyName =
  "Fullscreen: With Hideable Header Children";
...
FullScreenTopModalOverride.storyName = "Fullscreen: Top Modal Override";
FullScreenTopModalOverride.parameters = {
  chromatic: { disableSnapshot: true },
};
...
export const FullScreenRestoreFocusOnCloseStory: Story = () => {
  const [isOpen, setIsOpen] = useState(false);
  const [showMessage, setShowMessage] = useState(false);
  const messageRef = useRef<HTMLDivElement>(null);
...
FullScreenRestoreFocusOnCloseStory.storyName =
  "FullScreen: With Restore Focus On Close";
FullScreenRestoreFocusOnCloseStory.parameters = {
  chromatic: { disableSnapshot: true },
};

export const FullScreenWithComplexExample: Story = () => {
  const [isOpen, setIsOpen] = useState(defaultOpenState);
  const [activeTab1, setActiveTab1] = useState("tab-1");
  const [activeTab2, setActiveTab2] = useState("tab-contact-4");
  const padding40 = useMediaQuery("(min-width: 1260px)");
...
FullScreenWithComplexExample.storyName = "FullScreen: With Complex Example";

export const FullScreenWithDisableContentPadding: Story = () => {
  const [isOpen, setIsOpen] = useState(false);
...
FullScreenWithDisableContentPadding.storyName =
  "FullScreen: With Disable Content Padding";
FullScreenWithDisableContentPadding.parameters = {
  chromatic: { disableSnapshot: true },
};

export const FullScreenWithHeaderChildren: Story = () => {
  const [isOpen, setIsOpen] = useState(defaultOpenState);
  const aboveBreakpoint = useMediaQuery("(min-width: 568px)");
  const verticalMargin = aboveBreakpoint ? "26px" : 0;
  const HeaderChildren = (
...
FullScreenWithHeaderChildren.storyName = "FullScreen: With Header Children";
FullScreenWithHeaderChildren.parameters = { viewports: [500, 1400] };

export const FullScreenWithHelp: Story = () => {
  const [isOpen, setIsOpen] = useState(defaultOpenState);
  return (
    <>
      <Button onClick={() => setIsOpen(true)}>Open Dialog</Button>
...
FullScreenWithHelp.storyName = "FullScreen: With Help";

export const FullScreenWithHideableHeaderChildren: Story = () => {
  const [isOpen, setIsOpen] = useState(false);
  const aboveBreakpoint = useMediaQuery("(min-width: 568px)");
  const verticalMargin = aboveBreakpoint ? "26px" : 0;
  const HeaderChildrenAboveBreakpoint = (
...
FullScreenWithHideableHeaderChildren.storyName =
  "FullScreen: With Hideable Header Children";
FullScreenWithHideableHeaderChildren.parameters = {
  chromatic: { disableSnapshot: true },
};

export const FullScreenFocusingADifferentFirstElement: Story = () => {
  const [isOpenOne, setIsOpenOne] = useState(false);
  const [isOpenTwo, setIsOpenTwo] = useState(false);
...
FullScreenFocusingADifferentFirstElement.storyName =
  "FullScreen: Focusing a Different First Element";
FullScreenFocusingADifferentFirstElement.parameters = {
  chromatic: { disableSnapshot: true },
};

export const FullScreenOtherFocusableContainers: Story = () => {
  const [isDialogOpen, setIsDialogOpen] = useState(false);
  const [isToast1Open, setIsToast1Open] = useState(false);
  const [isToast2Open, setIsToast2Open] = useState(false);
...
FullScreenOtherFocusableContainers.storyName =
  "FullScreen: Other Focusable Containers";
FullScreenOtherFocusableContainers.parameters = {
  chromatic: { disableSnapshot: true },
};
