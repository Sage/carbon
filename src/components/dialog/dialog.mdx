...
The call-to-action element should always be focused when the full-screen `Dialog` is closed. However, in some instances it may not receive focus
due to specific browser design choices. The below example shows how to programmatically focus the call-to-action element when the full-screen `Dialog` is closed
to ensure behaviour is consistent across all browsers.

<Canvas of={DialogStories.FullScreenDefault} />

### Preventing focus from being restored when a full-screen `Dialog` closes

When the `restoreFocusOnClose` prop is `false`, focus will not be restored to the element that was focused before the full-screen `Dialog` was opened.
Focus can instead be programmatically applied to another element if appropriate.

<Canvas of={DialogStories.FullScreenRestoreFocusOnCloseStory} />
...
<Canvas of={DialogStories.FullScreenWithComplexExample} />

### With disableContentPadding

<Canvas of={DialogStories.FullScreenWithDisableContentPadding} />

### With header children

<Canvas of={DialogStories.FullScreenWithHeaderChildren} />

### With help

<Canvas of={DialogStories.FullScreenWithHelp} />

### With hideable header children

<Canvas of={DialogStories.FullScreenWithHideableHeaderChildren} />
...
<Canvas of={DialogStories.FullScreenFocusingADifferentFirstElement} />
...
<Canvas of={DialogStories.FullScreenOtherFocusableContainers} />
...
<Canvas of={DialogStories.FullScreenTopModalOverride} />
