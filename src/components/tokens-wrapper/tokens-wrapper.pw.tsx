...
test.describe("TokensWrapper component", () => {
  ...
  test("should provide token overrides in scope of Portals", async ({
    ...
    await expect(portalChild).toHaveCSS("--focusRing", "green");
    await expect(portalChild).toHaveCSS("--focusContrast", "blue");
  ...
  test("should provide scoped token overrides to portals when multiple TokensWrappers are rendered", async ({
    ...
    await expect(portalChild1).toHaveCSS("--focusRing", "green");
    await expect(portalChild1).toHaveCSS("--focusContrast", "blue");
    ...
    await expect(portalChild2).toHaveCSS("--focusRing", "cyan");
    await expect(portalChild2).toHaveCSS("--focusContrast", "brown");
  ...
  test("should provide token overrides in scope of PopoverContainers", async ({
    ...
    await expect(popoverChild).toHaveCSS("--focusRing", "green");
    await expect(popoverChild).toHaveCSS("--focusContrast", "blue");
  ...
  test("should provide scoped token overrides to popovers when multiple TokensWrappers are rendered", async ({
    ...
    await expect(popoverChild1).toHaveCSS("--focusRing", "green");
    await expect(popoverChild1).toHaveCSS("--focusContrast", "blue");
    ...
    await expect(popoverChild2).toHaveCSS("--focusRing", "cyan");
    await expect(popoverChild2).toHaveCSS("--focusContrast", "brown");
