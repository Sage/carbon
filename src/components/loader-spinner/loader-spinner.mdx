...
<Meta title="Loader Spinner" of={LoaderSpinnerStories} />

# Loader Spinner

<DeprecationWarning>
  Loader Spinner has been deprecated, if this pattern is still needed please see{" "}
  <a
    style={{ color: "white" }}
  ...
  translationData={[
    {
      ...
      description:
        "The spinner label which is shown next to the spinner, or applied to the visually hidden label if rendered.",
      type: "func",
      returnType: "string",
    },
  ]}
