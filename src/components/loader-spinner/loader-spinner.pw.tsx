...
test.describe("Prop checks for Loader Spinner component", () => {
  sizes.forEach((spinnerSizes) => {
    test(`when the 'size' prop is passed as '${spinnerSizes}' the wrapper has the correct dimensions`, async ({
      mount,
      page,
    }) => {
  ...
  sizes.forEach((spinnerSizes) => {
    test(`when the 'size' prop is passed as '${spinnerSizes}' the wrapper has the correct minimum dimensions`, async ({
      mount,
      page,
    }) => {
      await mount(<LoaderSpinnerComponent size={spinnerSizes} />);
