...
- The file name is displayed as a Link. Users can open it and check if it is correct.
  When more than one file is uploaded, text will be displayed with the number of files selected. Canvas in this case is not possible.
...
Use `allowMultiple` prop if you want to be able to add and upload more than one file. Canvas of selected files will not be possible.
