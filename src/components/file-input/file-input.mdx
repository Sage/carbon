...
animated [LoaderBar component](../?path=/docs/deprecated-loader-bar--docs), rather
than a [ProgressTracker](../?path=/docs/components-progress-tracker--docs) as it does when `progress` is provided.
...
the [Link component](../?path=/docs/components-link--docs), to override the props of the link to the uploaded file. There is one exception here however,
