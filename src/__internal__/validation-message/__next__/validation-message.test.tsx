...
test("should apply small font by default for error", () => {
  render(<ValidationMessage size="small" error="Error message" />);
  const validationMessage = screen.getByText("Error message");
  expect(validationMessage).toHaveStyleRule(
    "font",
...
test("should apply medium font by default for error", () => {
  render(<ValidationMessage size="medium" error="Error message" />);
  const validationMessage = screen.getByText("Error message");
  expect(validationMessage).toHaveStyleRule(
    "font",
...
test("should apply large font when size is large for error", () => {
  render(<ValidationMessage error="Error message" size="large" />);
  const validationMessage = screen.getByText("Error message");
  expect(validationMessage).toHaveStyleRule(
    "font",
...
test("should apply small font by default for warning", () => {
  render(<ValidationMessage size="small" warning="Warning message" />);
  const validationMessage = screen.getByText("Warning message");
  expect(validationMessage).toHaveStyleRule(
    "font",
...
test("should apply medium font by default for warning", () => {
  render(<ValidationMessage size="medium" warning="Warning message" />);
  const validationMessage = screen.getByText("Warning message");
  expect(validationMessage).toHaveStyleRule(
    "font",
...
test("should apply large font when size is large for warning", () => {
  render(<ValidationMessage warning="Warning message" size="large" />);
  const validationMessage = screen.getByText("Warning message");
  expect(validationMessage).toHaveStyleRule(
    "font",
