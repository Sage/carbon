...
describe("Dynamic item management", () => {
  it("handles the procedural adding of new items", () => {
    const { rerender } = render(
      <DraggableContainer>
        <DraggableItem id="apple" itemProps={itemDataRole}>
          Apple
  ...
  it("handles the procedural deletion of items", () => {
    const { rerender } = render(
      <DraggableContainer>
        <DraggableItem id="apple" itemProps={itemDataRole}>
          Apple
    ...
    // Rerender with deleted items (removing the last two)
    rerender(
      <DraggableContainer>
        <DraggableItem id="apple" itemProps={itemDataRole}>
          Apple
  ...
  it("handles procedural re-ordering of items when length is the same", () => {
    const { rerender } = render(
      <DraggableContainer>
