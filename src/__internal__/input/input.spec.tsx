...
describe("Input", () => {
  ...
  describe("select text on focus", () => {
    ...
    const focusWith = (value: string, leftPos: number, rightPos: number) => {
      ...
      ((inputElement as unknown) as HTMLInputElement).selectionStart = leftPos;
      ((inputElement as unknown) as HTMLInputElement).selectionEnd = rightPos;
    ...
    it("selects all of the text if focus is applied to the left of the value", () => {
      ...
      expect(
        ((inputElement as unknown) as HTMLInputElement).setSelectionRange
