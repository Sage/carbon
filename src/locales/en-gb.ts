...
const enGB: Locale = {
  ...
  textEditor: {
    ...
    hyperlink: {
      ...
      formKey: () => "Indicates required information",
      linkFieldLabel: () => "Link address",
      linkFieldErrorMessage: () => "Enter link address",
      saveButton: () => "Save",
      saveButtonAria: () => "Save",
      textFieldLabel: () => "Link text",
      textFieldErrorMessage: () => "Enter link text",
    },
    typography: {
