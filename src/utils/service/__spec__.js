...
describe("Service", () => {
  ...
  describe("constructor", () => {
    ...
    it("sets the interceptors of the axios client", () => {
      expect(
        service.client.interceptors.response.handlers[0].fulfilled
      ).toEqual(service.handleSuccess);
      expect(service.client.interceptors.response.handlers[0].rejected).toEqual(
        service.handleError
      );
    });
