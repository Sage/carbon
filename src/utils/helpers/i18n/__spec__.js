...
describe("I18n Helper", () => {
    ...
    describe("when a value is provided", () => {
      ...
      describe("and a precision is provided, ", () => {
        it("returns the formated value using provided precision", () => {
          ...
          expect(Helper.formatDecimal("1234567.894", 3)).toEqual(
            "1,234,567.894"
          );
          expect(Helper.formatDecimal("123.555555555555555", 15)).toEqual(
            "123.555555555555555"
          );
          expect(
            Helper.formatDecimal("-987654321987654321.5555555", 7)
          ).toEqual("-987,654,321,987,654,321.5555555");
          expect(
            Helper.formatDecimal("-987654321987654321.5555555", 8)
          ).toEqual("-987,654,321,987,654,321.55555550");
          expect(
            Helper.formatDecimal("-987654321987654321.5555555", 6)
          ).toEqual("-987,654,321,987,654,321.555556");
          expect(Helper.formatDecimal("90071992547.40992", 5)).toEqual(
            "90,071,992,547.40992"
          );
          expect(Helper.formatDecimal("90071992547.40992", 6)).toEqual(
            "90,071,992,547.409920"
          );
          expect(Helper.formatDecimal("90071992547.40992", 4)).toEqual(
            "90,071,992,547.4099"
          );
          expect(Helper.formatDecimal("90071992547.406", 5)).toEqual(
            "90,071,992,547.40600"
          );
          expect(Helper.formatDecimal("90071992547.406", 15)).toEqual(
  ...
  describe("abbreviateCurrency", () => {
    it("creates the correct abbreviation", () => {
      ...
      expect(Helper.abbreviateCurrency("345")).toEqual("£345.00");
      expect(
        Helper.abbreviateCurrency("678", { locale: "fr", unit: "€" })
      ).toEqual("678.00 €");
      expect(
        Helper.abbreviateCurrency("123456", { locale: "en", unit: "£" })
      ).toEqual("£123.5k");
      expect(
        Helper.abbreviateCurrency("567890", { locale: "fr", unit: "€" })
      ).toEqual("567.9k €");
      expect(
        Helper.abbreviateCurrency("987654321", { locale: "en", unit: "£" })
      ).toEqual("£987.7m");
      expect(
        Helper.abbreviateCurrency("234567890", { locale: "fr", unit: "€" })
      ).toEqual("234.6m €");
    });
  ...
  describe("formatCurrency", () => {
    ...
    describe("when a value is provided with a set locale", () => {
      it("returns a formatted value based on locale", () => {
        expect(Helper.formatCurrency(1337, { locale: "fr" })).toEqual(
          "1,337.00 €"
        );
      });
    });
    ...
    describe("when a value is provided with a set precision", () => {
      it("returns a formatted value based on precision", () => {
        expect(Helper.formatCurrency(1337, { precision: "3" })).toEqual(
          "£1,337.000"
        );
      });
    });
    ...
    describe("when 0 is provided as precision", () => {
      it("returns an integer with no decimal", () => {
        ...
        expect(Helper.formatCurrency(1337, { precision: "0" })).toEqual(
          "£1,337"
        );
      });
    });
    ...
    describe("when a value is provided with a set format", () => {
      it("returns a formatted value based on defaults and set unit", () => {
        expect(Helper.formatCurrency(1337, { format: "%u %n" })).toEqual(
          "£ 1,337.00"
        );
      });
    });
