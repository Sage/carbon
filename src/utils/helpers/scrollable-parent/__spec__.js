  ...
  describe("searchForScrollableParent", () => {
    ...
    it("returns the element provided if the element is itself scrollable", () => {
      ...
      const scrollableElement = (
        <div style={scrollableElementStyle}>Scolly</div>
      );
      expect(
        ScrollableParent.searchForScrollableParent(scrollableElement)
      ).toEqual(scrollableElement);
    });
    ...
    it("returns the first scrollable parent of the element provided if the element itself is not scrollable", () => {
      ...
      expect(ScrollableParent.searchForScrollableParent(elementsStub)).toEqual(
        "Scrollando"
      );
    });
  });
