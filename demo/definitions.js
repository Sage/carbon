export default {
  ...
  'checkbox':             require('__deprecated__/components/checkbox/__definition__').default,
  ...
  'date-input':           require('__deprecated__/components/date/__definition__').default,
  'date-range':           require('__deprecated__/components/date-range/__definition__').default,
  ...
  'dropdown':             require('__deprecated__/components/dropdown/__definition__').default,
  'dropdown-filter':      require('__deprecated__/components/dropdown-filter/__definition__').default,
  'dropdown-filter-ajax': require('__deprecated__/components/dropdown-filter-ajax/__definition__').default,
  ...
  'form':                 require('__deprecated__/components/form/__definition__').default,
  ...
  'radio-button':         require('__deprecated__/components/radio-button/__definition__').default,
  ...
  'simple-color-picker':  require('__deprecated__/components/simple-color-picker/__definition__').default,
  'spinner':              require('__deprecated__/components/spinner/__definition__').default,
  'split-button':         require('components/split-button/__definition__').default,
  'step-sequence':        require('components/step-sequence/__definition__').default,
  'step-sequence-item':   require('components/step-sequence/step-sequence-item/__definition__').default,
  'switch':               require('__deprecated__/components/switch/__definition__').default,
  ...
  'textarea':             require('__deprecated__/components/textarea/__definition__').default,
