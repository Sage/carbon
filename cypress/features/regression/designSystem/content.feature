Feature: Content component
  ...
  Scenario Outline: Change children in Content dialog to <children>
    When I open default "Design System Content Test" component with "content" json from "designSystem" using "<nameOfObject>" object name
  ...
  Scenario: BodyFullWidth disabled
    When I open default "Design System Content Test" component with "content" json from "designSystem" using "bodyFullWidthFalse" object name
