Feature: Decimal input component
  ...
  Scenario Outline: Change Decimal component fieldHelp to <fieldHelp>
    When I open default "Design System Decimal Input Test" component in noIFrame with "decimal" json from "designSystem" using "<nameOfObject>" object name
  ...
  Scenario Outline: Change Decimal component label help to <label>
    Given I open default "Design System Decimal Input Test" component in noIFrame with "decimal" json from "designSystem" using "<nameOfObject>" object name
  ...
  Scenario Outline: Check Decimal component input field will accept characters to <input>
    Given I open "Design System Decimal Input Test" component page "default" in no iframe
