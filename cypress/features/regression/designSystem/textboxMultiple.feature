Feature: Design System Textbox multiple component
  I want to check Design System Textbox multiple component properties

  @positive
  Scenario Outline: Set placeholder to <placeholder>
    When I open multiple "Design System Textbox Test" component with "textbox" json from "designSystem" using "<nameOfObject>" object name
  ...
  Scenario Outline: Set labelHelp to <labelHelp>
    Given I open multiple "Design System Textbox Test" component with "textbox" json from "designSystem" using "<nameOfObject>" object name
