Feature: Design System Action Popover component
  ...
  Scenario: Invoking Action Popover component in a hidden container
    Given I open "Design System Action Popover" component page "in overflow hidden container"
  ...
  Scenario: Check that actionPopoverInnerItem has download prop
    Given I open "Design System Action Popover" component page "with download button"
    When I click the menu button element
