Feature: Design System Textarea component
  ...
  Scenario Outline: Enable expandable checkbox for a Textarea component
    Given I open default "Design System-Textarea Test" component in noIFrame with "textarea" json from "designSystem" using "expandable" object name
  ...
  Scenario Outline: Enable and disable expandable checkbox for a Textarea component
    Given I open default "Design System-Textarea Test" component in noIFrame with "textarea" json from "designSystem" using "expandableFalse" object name
    When I input <text> into Textarea
  ...
  Scenario Outline: Enable warnOverLimit checkbox for a Textarea component and check the warning
    Given I open default "Design System-Textarea Test" component in noIFrame with "textarea" json from "designSystem" using "<nameOfObject>" object name
    When I input <text> into Textarea
