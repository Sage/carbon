Feature: Design System Checkbox component
  ...
  Scenario Outline: Change Checkbox component label to <label>
    When I open Default "Design System Checkbox Test" component with "checkbox" json from "designSystem" using "<nameOfObject>" object name
  ...
  Scenario: Change Checkbox tick color
    Given I open Default "Design System Checkbox Test" component with "checkbox" json from "designSystem" using "default" object name
