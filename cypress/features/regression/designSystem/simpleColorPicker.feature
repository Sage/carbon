Feature: Simple Color Picker component
  ...
  Scenario Outline: Set legend to <legend>
    When I open default "Simple Color Picker Test" component with "simpleColorSelect" json from "designSystem" using "<nameOfObject>" object name
  ...
  Scenario: Color Picker renders all the provided colors and their respective labels
    When I open default "Simple Color Picker Test" component with "simpleColorSelect" json from "designSystem" using "availableColors" object name
