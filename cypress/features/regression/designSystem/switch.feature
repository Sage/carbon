Feature: Switch component
  ...
  Scenario Outline: Change Switch component fieldHelp to <fieldHelp>
    When I open Default "Design System Switch Test" component with "switch" json from "designSystem" using "<nameOfObject>" object name
  ...
  Scenario: Enable loading property
    When I open Default "Design System Switch Test" component with "switch" json from "designSystem" using "loading" object name
    Then Switch component is loading

  @positive
  Scenario: Disable loading property
    When I open Default "Design System Switch Test" component with "switch" json from "designSystem" using "loadingFalse" object name
