Feature: Pill component
  ...
  Scenario Outline: Change Pill children to <children>
    When I open default "Pill Test" component with "pill" json from "designSystem" using "<nameOfObject>" object name
  ...
  Scenario: Verify border outline color on focus
    Given I open default "Pill Test" component with "pill" json from "designSystem" using "onDelete" object name
