Feature: Design System Date Input component
  ...
  Scenario: Change Date Input component minDate
    Given I open default "Design System Date Input Test" component with "dateInput" json from "designSystem" using "minDate" object name
  ...
  Scenario: Change Date Input component maxDate
    Given I open default "Design System Date Input Test" component with "dateInput" json from "designSystem" using "maxDate" object name
      And I set dateInput to today
  ...
  Scenario: Open dayPickerDay via click on input
    Given I open default "Design System Date Input Test" component with "dateInput" json from "designSystem" using "default" object name
  ...
  Scenario Outline: Show Date input at the <position> position
    Given I open default "Design System Date Input Test" component with "dateInput" json from "designSystem" using "<nameOfObject>" object name
    When I click dateInput
