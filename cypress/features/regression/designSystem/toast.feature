Feature: Toast Design System component
  ...
  Scenario: CloseIcon has the border outline
    Given I open "Design System Toast" component page "dismissible"
  ...
  Scenario: Confirm that when isCenter property is false Toast is left aligned
    Given I open "Design System Toast" component page "left aligned"
  ...
  Scenario: Confirm that Toast is centered by default
    Given I open "Design System Toast" component page "default story"
