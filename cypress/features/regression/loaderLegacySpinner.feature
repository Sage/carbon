Feature: Loader Legacy Spinner component
  I want to change Loader Legacy Spinner component properties
  ...
  Scenario Outline: I set Loader component size to <size>
    ...
    Then Loader Legacy Spinner width and height is set to "<px>"
    Examples:
      | size         | px |
      | extra-small  | 8  |
      | small        | 12 |
