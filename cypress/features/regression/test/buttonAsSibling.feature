Feature: Button as a sibling component
  ...
  Scenario Outline: Set Button as a sibling size to <size>
    When I open Test as-a-sibling "Button" component with "buttonAsSibling" json from "test" using "<nameOfObject>" object name
  ...
  Scenario: Disable Button as a sibling
    When I open Test as-a-sibling "Button" component with "buttonAsSibling" json from "test" using "disabled" object name
    Then Button as a sibling is disabled

  @positive
  Scenario: Enable Button as a sibling
    When I open Test as-a-sibling "Button" component with "buttonAsSibling" json from "test" using "disabledFalse" object name
  ...
  Scenario: Set Button icon to alert
    Given I open Test as-a-sibling "Button" component with "buttonAsSibling" json from "test" using "iconTypeAlert" object name
