Feature: Batch selection component
  ...
  Scenario: Hide Batch selection component
    When I open Test default "Batch Selection" component with "batchSelection" json from "test" using "hidden" object name
    Then Batch selection component is hidden

  @positive
  Scenario Outline: Set selectedCount Batch selection component to <selectedCount>
    When I open Test default "Batch Selection" component with "batchSelection" json from "test" using "<nameOfObject>" object name
