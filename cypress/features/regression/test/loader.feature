Feature: Loader default component
  ...
  Scenario Outline: I set Loader component size to <size>
    When I open Test test_basic "Loader" component in noIFrame with "loader" json from "commonComponents" using "<nameOfObject>" object name
  ...
  Scenario: Loader isInsideButton
    When I open Test test_basic "Loader" component in noIFrame with "loader" json from "commonComponents" using "isInsideButton" object name
    Then Loader isInsideButton and backgroundColor is "rgb(0, 129, 93)"

  @positive
  Scenario: Disabled loader button
    When I open Test test_basic "Loader" component in noIFrame with "loader" json from "commonComponents" using "isActiveFalse" object name
    Then Loader button is disabled

  @positive
  Scenario: Enabled loader button
    When I open Test test_basic "Loader" component in noIFrame with "loader" json from "commonComponents" using "isActive" object name
    Then Loader button is enabled

  @positive
  Scenario: Verify border outline color on focus
    Given I open Test test_basic "Loader" component in noIFrame with "loader" json from "commonComponents" using "default" object name
