Feature: Badge component
  ...
  Scenario Outline: Set Badge component to <counter>
    When I open Test default "Badge" component with "badge" json from "test" using "<nameOfObject>" object name
  ...
  Scenario: Hover Badge component and verify that cross icon appears
    Given I open Test default "Badge" component with "badge" json from "test" using "counter1" object name
