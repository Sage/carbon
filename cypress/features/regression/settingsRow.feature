Feature: Settings Row component
  ...
  Scenario Outline: Change Settings Row children to <children>
    When I open default "Setting Row Test" component with "settingsRow" json from "commonComponents" using "<nameOfObject>" object name
  ...
  Scenario: Disable divider for a Settings Row component
    When I open default "Setting Row Test" component with "settingsRow" json from "commonComponents" using "dividerFalse" object name
