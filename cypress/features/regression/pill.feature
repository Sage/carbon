Feature: Pill component
  ...
  Scenario Outline: Disable fill checkbox for a Pill component
    When I open default "Design System Pill Test" component in noIFrame with "pill" json from "commonComponents" using "fillFalse" object name
  ...
  Scenario: Enable fill checkbox for a Pill component
    When I open default "Design System Pill Test" component in noIFrame with "pill" json from "commonComponents" using "fill" object name
    Then Pill component has "rgb(0, 129, 93)" fill color

  @positive
  Scenario: Disable onDelete checkbox for a Pill component
    When I open default "Design System Pill Test" component in noIFrame with "pill" json from "commonComponents" using "onDeleteFalse" object name
    Then Pill component has no onDelete property

  @positive
  Scenario: Enable onDelete checkbox for a Pill component
    When I open default "Design System Pill Test" component in noIFrame with "pill" json from "commonComponents" using "onDelete" object name
