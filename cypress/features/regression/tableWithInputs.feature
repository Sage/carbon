Feature: Table With Inputs component
  ...
  Scenario: I enable selectable
    When I open default-with-inputs "Table Test" component in noIFrame with "table" json from "commonComponents" using "selectable" object name
    Then rows are selectable

  @positive
  Scenario: I disable selectable
    When I open default-with-inputs "Table Test" component in noIFrame with "table" json from "commonComponents" using "selectableFalse" object name
    Then rows are not selectable

  @positive
  Scenario Outline: Row <rowNumber> is highlighted
    Given I open default-with-inputs "Table Test" component in noIFrame with "table" json from "commonComponents" using "highlightable" object name
  ...
  Scenario Outline: Row <rowNumber> is not highlighted
    Given I open default-with-inputs "Table Test" component in noIFrame with "table" json from "commonComponents" using "highlightableFalse" object name
    When I click row by number <rowNumber>
  ...
  Scenario Outline: Sort Table <headerName> Column by <sortedColumn>
    Given I open default-with-inputs "Table Test" component in noIFrame with "table" json from "commonComponents" using "<nameOfObject>" object name
  ...
  Scenario Outline: Set caption to <caption>
    When I open default-with-inputs "Table Test" component in noIFrame with "table" json from "commonComponents" using "<nameOfObject>" object name
  ...
  Scenario: TotalRecords is set to 1 item
    When I open default-with-inputs "Table Test" component in noIFrame with "table" json from "commonComponents" using "totalRecords1" object name
  ...
  Scenario Outline: I enable zebra striping for <position> row in Table
    When I open default-with-inputs "Table Test" component in noIFrame with "table" json from "commonComponents" using "zebraStriping" object name
