Feature: Heading component
  ...
  Scenario Outline: Change heading title to <title>
    When I open default "Heading Test" component in noIFrame with "heading" json from "commonComponents" using "<nameOfObject>" object name
  ...
  Scenario Outline: Change help to <help>
    Given I open default "Heading Test" component in noIFrame with "heading" json from "commonComponents" using "<nameOfObject>" object name
