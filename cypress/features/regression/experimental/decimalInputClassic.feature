Feature: Decimal classic component
  I want to change Decimal classic component properties

  Background: Open Decimal component classic page
    Given I open "Experimental-Decimal-Input" component page classic
