Feature: Experimental Form component classic page
  I want to change Experimental Form classic page component properties

  Background: Open Experimental Form component classic page
    Given I open "Experimental Form" component page classic
