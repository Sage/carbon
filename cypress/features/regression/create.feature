Feature: Create component
  ...
  Scenario: Verify inner content and colors of Create component
    ...
    Then Create component has proper inner color "rgb(0, 128, 93)" and background-color "rgb(242, 244, 245)" and border color "rgb(0, 51, 73)"
  ...
  Scenario: Verify inner content and colors of Create component on hover state
    ...
    Then Create component has proper inner color "rgb(0, 96, 69)" and background-color "rgb(255, 255, 255)" and border color "rgb(0, 51, 73)"
