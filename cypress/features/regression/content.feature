Feature: Content component
  ...
  Scenario Outline: Change children in Content dialog to <children>
    When I open basic "Content Test" component in noIFrame with "content" json from "commonComponents" using "<nameOfObject>" object name
  ...
  Scenario: BodyFullWidth enabled
    When I open basic "Content Test" component in noIFrame with "content" json from "commonComponents" using "bodyFullWidth" object name
    Then content preview has bodyFullWidth parameter enabled

  @positive
  Scenario: BodyFullWidth disabled
    When I open basic "Content Test" component in noIFrame with "content" json from "commonComponents" using "bodyFullWidthFalse" object name
  ...
  Scenario: Inline disabled
    When I open basic "Content Test" component in noIFrame with "content" json from "commonComponents" using "inlineFalse" object name
