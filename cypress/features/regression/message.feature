Feature: Message component
  ...
  Scenario: CloseIcon has correct border colour
    Given I open default "Message Test" component with "message" json from "commonComponents" using "default" object name
  ...
  Scenario Outline: Change Message title to <title>
    When I open default "Message Test" component with "message" json from "commonComponents" using "<nameOfObject>" object name
  ...
  Scenario: Enable transparent state for a Message component
    When I open default "Message Test" component with "message" json from "commonComponents" using "transparent" object name
  ...
  Scenario: Disable showCloseIcon for a Message component
    When I open default "Message Test" component with "message" json from "commonComponents" using "showCloseIconFalse" object name
    Then Message has no cross icon

  @positive
  Scenario: Verify the click function for a Message component
    Given I open "Message Test" component page "default" in no iframe
