...
export const additionalButtonIFrame = (index) =>
  cy.iFrame(ADDITIONAL_BUTTONS).children().eq(index);
export const splitMainButtonDataComponentIFrame = (index) =>
  cy.iFrame(SPLIT_MAIN_BUTTON).children().eq(index);
