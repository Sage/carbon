import {
  ...
  SHOW_EDIT_POD_EDIT, SHOW_EDIT_POD_FOOTER, SHOW_EDIT_POD, SHOW_EDIT_POD_CONTENT_BOX,
} from './locators';
...
export const showEditPodCollapsibleInnerContent = (element, index) => cy.get(SHOW_EDIT_POD_CONTENT_BOX).find('div').eq(1).find(`[data-element=${element}]`)
  .eq(index);
...
export const showEditPodCancelButtonIFrame = () => cy.iFrame(SHOW_EDIT_CANCEL_BUTTON);
export const showEditPodDeleteButtonIFrame = () => cy.iFrame(SHOW_EDIT_DELETE_BUTTON);
