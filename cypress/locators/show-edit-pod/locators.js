...
export const SHOW_EDIT_POD_COLLAPSIBLE_CONTENT = 'div[class="carbon-pod__collapsible-content"]';
export const SHOW_EDIT_SAVE_BUTTON = 'button[data-element="save"]';
export const SHOW_EDIT_CANCEL_BUTTON = 'button[data-element="cancel"]';
export const SHOW_EDIT_DELETE_BUTTON = 'error > span > span';
export const SHOW_EDIT_POD_EDIT = 'a[data-element="edit"]';
