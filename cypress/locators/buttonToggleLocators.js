import { FORM, STORY_ROOT } from "./commonLocators";
...
export const buttonTogglePreview = () => cy.iFrame(BUTTON_TOGGLE_PREVIEW) //possible wait(100) needed
export const buttonToggleIconPreview = () => cy.iFrame(ICON_PREVIEW) //possible wait(200) needed
export const buttonToggleIconNamePreview = () => cy.iFrame(ICON_NAME_PREVIEW) //possible wait(100) needed
