Feature: Simple Color Picker component
  ...
  Scenario Outline: Change Simple Color Picker availableColors to <availableColors>
    ...
    Examples:
      | availableColors             | rgb                                                                   |
      | #AAAAAA,#255BC719,#ED1C5F   | rgb(170, 170, 170);rgba(37, 91, 199, 0.098);rgb(237, 28, 95)          |
      | #C8DCFC4C,#FFFF00,#92007699 | rgba(200, 220, 252, 0.298);rgb(255, 255, 0);rgba(146, 0, 118, 0.6)    |
  ...
  Scenario Outline: Check the Simple Color Picker <position> element was selected
    When clear all events in Actions Tab
      And I click onto "<position>" element
