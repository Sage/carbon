Feature: Button as a sibling component
  ...
  Scenario Outline: Set Button as a sibling Type as <buttonType>
    ...
    Examples:
      ...
      | primary        | rgb(255, 255, 255) | rgb(0, 126, 69)    | buttonTypePrimary        |
      | secondary      | rgb(0, 126, 69)    | rgba(0, 0, 0, 0)   | buttonTypeSecondary      |
      | tertiary       | rgb(0, 126, 69)    | rgba(0, 0, 0, 0)   | buttonTypeTertiary       |
      | darkBackground | rgb(0, 126, 69)    | rgb(255, 255, 255) | buttonTypeDarkBackground |
