Feature: Button as a sibling component
  ...
  Scenario Outline: Set Button as a sibling Type as <buttonType>
    ...
    Examples:
      ...
      | primary        | rgb(255, 255, 255) | rgb(0, 122, 89)    | buttonTypePrimary        |
      | secondary      | rgb(0, 122, 89)    | rgba(0, 0, 0, 0)   | buttonTypeSecondary      |
      | tertiary       | rgb(0, 122, 89)    | rgba(0, 0, 0, 0)   | buttonTypeTertiary       |
      | darkBackground | rgb(0, 122, 89)    | rgb(255, 255, 255) | buttonTypeDarkBackground |
