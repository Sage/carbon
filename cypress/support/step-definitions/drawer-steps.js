...
Then("Drawer {word} sidebar text is visible", (drawer) => {
  drawerSidebarContentInnerElement(drawer, positionOfElement("second"))
    .should("have.text", "link a")
    .and("be.visible");
  drawerSidebarContentInnerElement(drawer, positionOfElement("third"))
    .should("have.text", "link b")
    .and("be.visible");
  drawerSidebarContentInnerElement(drawer, positionOfElement("fourth"))
...
Then(
  "Drawer {word} animationDuration is set to {string}",
  (drawer, animationDuration) => {
    drawerSidebar(drawer).should(
      "have.css",
      "animation-duration",
      animationDuration
    );
