import {
  draggableRecordByPosition,
  draggableRecordByText,
} from "../../locators/draggable-context";
...
Then(
  "Draggable Context {string} is dragged to {int}",
  (record, destinationId) => {
    draggableRecordByPosition(destinationId)
      .invoke("text")
