...
When('I click on Button Toggle', (element) => {
  buttonTogglePreview(element).eq(FIRST_ELEMENT).click();
  buttonTogglePreview(element).eq(SECOND_ELEMENT).click();
  buttonTogglePreview(element).eq(THIRD_ELEMENT).click();
});
